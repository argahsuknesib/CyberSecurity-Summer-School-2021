    ...
    public Parcelable saveState() {
        ...
        for (int i = 0; i < this.mFragments.size(); i++) {
            ...
            if (fragment != null && fragment.isAdded()) {
                ...
                this.mFragmentManager.putFragment(bundle, "f".concat(String.valueOf(i)), fragment);
            }
        }
        return bundle;
    }
            ...
            for (String str : bundle.keySet()) {
                if (str.startsWith("f")) {
                    ...
                    if (fragment != null) {
                        ...
                        Log.w("FragmentStatePagerAdapter", "Bad fragment at key ".concat(String.valueOf(str)));
                    }
                }
            }
        }
