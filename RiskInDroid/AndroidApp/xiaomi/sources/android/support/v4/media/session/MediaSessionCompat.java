...
public class MediaSessionCompat {
    ...
    interface MediaSessionImpl {
        ...
        gb.O000000o getCurrentControllerInfo();
        ...
        void setCurrentControllerInfo(gb.O000000o o000000o);
        ...
        void setPlaybackToRemote(gf gfVar);
    ...
    private MediaSessionCompat(Context context, String str, ComponentName componentName, PendingIntent pendingIntent, Bundle bundle) {
        ...
        if (context == null) {
            ...
            if (componentName == null && (componentName = MediaButtonReceiver.O000000o(context)) == null) {
    ...
    public void setPlaybackToRemote(gf gfVar) {
        if (gfVar != null) {
            this.mImpl.setPlaybackToRemote(gfVar);
            return;
        }
    ...
    public final gb.O000000o getCurrentControllerInfo() {
    ...
    public static abstract class Callback {
        ...
        public boolean onMediaButtonEvent(Intent intent) {
            ...
            gb.O000000o currentControllerInfo = mediaSessionImpl.getCurrentControllerInfo();
        ...
        /* access modifiers changed from: package-private */
        public void handleMediaPlayPauseKeySingleTapIfPending(gb.O000000o o000000o) {
            long j;
            if (this.mMediaPlayPauseKeyPending) {
                ...
                if (mediaSessionImpl != null) {
                    ...
                    mediaSessionImpl.setCurrentControllerInfo(o000000o);
                    if (z2 && z) {
                        onPause();
                    } else if (!z2 && z3) {
                        onPlay();
        ...
        class CallbackHandler extends Handler {
            ...
            public void handleMessage(Message message) {
                if (message.what == 1) {
                    Callback.this.handleMediaPlayPauseKeySingleTapIfPending((gb.O000000o) message.obj);
                }
            }
        }
        ...
        class StubApi21 implements MediaSessionCompatApi21.Callback {
            ...
            /* JADX WARN: Type inference failed for: r1v1, types: [android.support.v4.media.session.MediaSessionCompat$QueueItem] */
                ...
                try {
                    ...
                    if (str.equals("android.support.v4.media.session.command.GET_EXTRA_BINDER")) {
                        ...
                        if (mediaSessionImplApi21 != null) {
                            ...
                            oOOO0OO0.O000000o(bundle2, "android.support.v4.media.session.EXTRA_BINDER", r1);
                        ...
                        if (mediaSessionImplApi212 != null && mediaSessionImplApi212.mQueue != null) {
                            ...
                            if (i >= 0 && i < mediaSessionImplApi212.mQueue.size()) {
                                r1 = mediaSessionImplApi212.mQueue.get(i);
                            }
                            if (r1 != 0) {
    ...
    public static final class Token implements Parcelable {
        ...
        public final Bundle toBundle() {
            ...
            if (iMediaSession != null) {
                oOOO0OO0.O000000o(bundle, "android.support.v4.media.session.EXTRA_BINDER", iMediaSession.asBinder());
            }
        ...
        public static Token fromBundle(Bundle bundle) {
            ...
            IMediaSession asInterface = IMediaSession.Stub.asInterface(oOOO0OO0.O000000o(bundle, "android.support.v4.media.session.EXTRA_BINDER"));
    ...
    static class MediaSessionImplBase implements MediaSessionImpl {
        ...
        private gb.O000000o mRemoteUserInfo;
        int mRepeatMode;
        ...
        private gf.O000000o mVolumeCallback = new gf.O000000o() {
            /* class android.support.v4.media.session.MediaSessionCompat.MediaSessionImplBase.AnonymousClass1 */

            public void onVolumeChanged(gf gfVar) {
                if (MediaSessionImplBase.this.mVolumeProvider == gfVar) {
                    MediaSessionImplBase.this.sendVolumeInfoChanged(new ParcelableVolumeInfo(MediaSessionImplBase.this.mVolumeType, MediaSessionImplBase.this.mLocalStream, gfVar.f17613O000000o, gfVar.O00000Oo, gfVar.O00000o0));
                }
            }
        };
        gf mVolumeProvider;
        ...
        public void setPlaybackToRemote(gf gfVar) {
            if (gfVar != null) {
                gf gfVar2 = this.mVolumeProvider;
                if (gfVar2 != null) {
                    gfVar2.O00000o = null;
                }
                this.mVolumeType = 2;
                this.mVolumeProvider = gfVar;
                sendVolumeInfoChanged(new ParcelableVolumeInfo(this.mVolumeType, this.mLocalStream, this.mVolumeProvider.f17613O000000o, this.mVolumeProvider.O00000Oo, this.mVolumeProvider.O00000o0));
                gfVar.O00000o = this.mVolumeCallback;
                return;
            }
            throw new IllegalArgumentException("volumeProvider may not be null");
        }
        ...
        public gb.O000000o getCurrentControllerInfo() {
            gb.O000000o o000000o;
            synchronized (this.mLock) {
                o000000o = this.mRemoteUserInfo;
            }
            return o000000o;
        }

        public void setCurrentControllerInfo(gb.O000000o o000000o) {
            synchronized (this.mLock) {
                this.mRemoteUserInfo = o000000o;
            }
        }
        ...
        class MediaSessionStub extends IMediaSession.Stub {
            ...
            public void registerCallbackListener(IMediaControllerCallback iMediaControllerCallback) {
                if (MediaSessionImplBase.this.mDestroyed) {
                    ...
                    MediaSessionImplBase.this.mControllerCallbacks.register(iMediaControllerCallback, new gb.O000000o("android.media.session.MediaController", getCallingPid(), getCallingUid()));
                }
            }
            ...
            public ParcelableVolumeInfo getVolumeAttributes() {
                ...
                synchronized (MediaSessionImplBase.this.mLock) {
                    ...
                    gf gfVar = MediaSessionImplBase.this.mVolumeProvider;
                    if (i == 2) {
                        int i6 = gfVar.f17613O000000o;
                        int i7 = gfVar.O00000Oo;
                        i3 = gfVar.O00000o0;
                        i4 = i7;
                        i5 = i6;
                    } else {
        ...
        class MessageHandler extends Handler {
            ...
            public void handleMessage(Message message) {
                ...
                if (callback != null) {
                    ...
                    MediaSessionImplBase.this.setCurrentControllerInfo(new gb.O000000o(data.getString("data_calling_pkg"), data.getInt("data_calling_pid"), data.getInt("data_calling_uid")));
    ...
    static class MediaSessionImplApi21 implements MediaSessionImpl {
        ...
        public void setPlaybackToRemote(gf gfVar) {
            ...
            if (gfVar.O00000oO == null && Build.VERSION.SDK_INT >= 21) {
                gfVar.O00000oO = new VolumeProvider(gfVar.f17613O000000o, gfVar.O00000Oo, gfVar.O00000o0, new gg.O000000o() {
                    /* class _m_j.gf.AnonymousClass1 */
                }) {
                    /* class _m_j.gg.AnonymousClass1 */

                    /* renamed from: O000000o  reason: collision with root package name */
                    final /* synthetic */ O000000o f17671O000000o;
                    ...
                    {
                        this.f17671O000000o = r4;
                    }
                };
            }
            MediaSessionCompatApi21.setPlaybackToRemote(obj, gfVar.O00000oO);
        }
        ...
        class ExtraSession extends IMediaSession.Stub {
            ...
            public void registerCallbackListener(IMediaControllerCallback iMediaControllerCallback) {
                if (!MediaSessionImplApi21.this.mDestroyed) {
                    ...
                    MediaSessionImplApi21.this.mExtraControllerCallbacks.register(iMediaControllerCallback, new gb.O000000o(callingPackage, getCallingPid(), getCallingUid()));
                }
            }
    ...
    static class MediaSessionImplApi28 extends MediaSessionImplApi21 {
        ...
        public final gb.O000000o getCurrentControllerInfo() {
            return new gb.O000000o(((MediaSession) this.mSessionObj).getCurrentControllerInfo());
        }
    }
}
