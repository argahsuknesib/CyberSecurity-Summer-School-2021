...
public class ListMenuItemView extends LinearLayout implements MenuView.ItemView {
    ...
    public ListMenuItemView(Context context, AttributeSet attributeSet, int i) {
        ...
        TintTypedArray obtainStyledAttributes = TintTypedArray.obtainStyledAttributes(getContext(), attributeSet, new int[]{16842926, 16843052, 16843053, 16843054, 16843055, 16843056, 16843057, R.attr.preserveIconSpacing, R.attr.subMenuArrow}, i, 0);
    ...
    private void insertIconView() {
        this.mIconView = (ImageView) getInflater().inflate((int) R.layout.abc_list_menu_item_icon, (ViewGroup) this, false);
    ...
    private void insertRadioButton() {
        this.mRadioButton = (RadioButton) getInflater().inflate((int) R.layout.abc_list_menu_item_radio, (ViewGroup) this, false);
    ...
    private void insertCheckBox() {
        this.mCheckBox = (CheckBox) getInflater().inflate((int) R.layout.abc_list_menu_item_checkbox, (ViewGroup) this, false);
