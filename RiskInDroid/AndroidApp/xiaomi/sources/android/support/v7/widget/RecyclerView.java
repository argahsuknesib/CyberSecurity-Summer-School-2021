...
public class RecyclerView extends ViewGroup implements NestedScrollingChild, ScrollingView {
    ...
    public RecyclerView(Context context, @Nullable AttributeSet attributeSet, int i) {
        ...
        if (attributeSet != null) {
            TypedArray obtainStyledAttributes2 = context.obtainStyledAttributes(attributeSet, new int[]{16842948, 16842987, 16842993, R.attr.fastScrollEnabled, R.attr.fastScrollHorizontalThumbDrawable, R.attr.fastScrollHorizontalTrackDrawable, R.attr.fastScrollVerticalThumbDrawable, R.attr.fastScrollVerticalTrackDrawable, R.attr.layoutManager, R.attr.reverseLayout, R.attr.spanCount, R.attr.stackFromEnd}, i, 0);
            String string = obtainStyledAttributes2.getString(8);
            if (obtainStyledAttributes2.getInt(2, -1) == -1) {
    ...
    private boolean isPreferredNextFocusAbsolute(View view, View view2, int i) {
        ...
        if (i != 17) {
            if (i != 33) {
                if (i != 66) {
                    if (i != 130) {
                        throw new IllegalArgumentException("direction must be absolute. received:".concat(String.valueOf(i)));
    ...
    public boolean onInterceptTouchEvent(MotionEvent motionEvent) {
        ...
        if (actionMasked == 0) {
            ...
            if (this.mScrollState != 1) {
                ...
                int i5 = -1;
                if (!canScrollHorizontally || Math.abs(i3) <= (i2 = this.mTouchSlop)) {
                    z = false;
                } else {
                    this.mLastTouchX = this.mInitialTouchX + (i2 * (i3 < 0 ? -1 : 1));
                    z = true;
                }
                if (canScrollVertically && Math.abs(i4) > (i = this.mTouchSlop)) {
                    int i6 = this.mInitialTouchY;
                    if (i4 >= 0) {
                        i5 = 1;
                    }
                    this.mLastTouchY = i6 + (i * i5);
                    z = true;
                }
                if (z) {
                    setScrollState(1);
                ...
                if (!(i3 == 0 && i == 0)) {
                    ...
                    if (i3 != currX) {
                        ...
                        if (i != currY) {
                            ...
                            if ((i5 != 0 || i3 == currX || scrollerCompat.getFinalX() == 0) && (currVelocity != 0 || i == currY || scrollerCompat.getFinalY() == 0)) {
    ...
    public final class Recycler {
        ...
        public final ViewHolder tryGetViewHolderForPositionByDeadline(int i, boolean z, long j) {
            ...
            if (i2 < 0 || i2 >= RecyclerView.this.mState.getItemCount()) {
                throw new IndexOutOfBoundsException("Invalid item position " + i2 + "(" + i2 + "). Item count:" + RecyclerView.this.mState.getItemCount());
            }
            boolean z5 = true;
            if (RecyclerView.this.mState.isPreLayout()) {
                ...
                if (viewHolder != null) {
                    ...
                    if (viewHolder == null) {
                        ...
                        if (findPositionOffset < 0 || findPositionOffset >= RecyclerView.this.mAdapter.getItemCount()) {
                            throw new IndexOutOfBoundsException("Inconsistency detected. Invalid item position " + i2 + "(offset:" + findPositionOffset + ").state:" + RecyclerView.this.mState.getItemCount());
                        }
        ...
        public final void recycleViewHolderInternal(ViewHolder viewHolder) {
            ...
            if (viewHolder.isScrap() || viewHolder.itemView.getParent() != null) {
                ...
                throw new IllegalArgumentException("Tmp detached view should be removed from RecyclerView before it can be recycled: ".concat(String.valueOf(viewHolder)));
            } else if (!viewHolder.shouldIgnore()) {
        ...
        /* access modifiers changed from: package-private */
        public final void setAdapterPositionsAsUnknown() {
            int size = this.mCachedViews.size();
            for (int i = 0; i < size; i++) {
    ...
    public static abstract class LayoutManager {
        ...
        public boolean performAccessibilityAction(Recycler recycler, State state, int i, Bundle bundle) {
            ...
            if (i == 4096) {
                i3 = ViewCompat.canScrollVertically(recyclerView, 1) ? (getHeight() - getPaddingTop()) - getPaddingBottom() : 0;
