...
public final class OnSubscribeConcatMap<T, R> implements Observable.OnSubscribe<R> {
    ...
    public final void call(Subscriber<? super R> subscriber) {
        ...
        subscriber.setProducer(new Producer() {
            /* class rx.internal.operators.OnSubscribeConcatMap.AnonymousClass1 */
    ...
    static final class ConcatMapSubscriber<T, R> extends Subscriber<T> {
        ...
        /* access modifiers changed from: package-private */
        public final void innerError(Throwable th, long j) {
            if (!ExceptionsUtils.addThrowable(this.error, th)) {
                pluginError(th);
        ...
        /* access modifiers changed from: package-private */
        public final void innerCompleted(long j) {
            if (j != 0) {
                this.arbiter.produced(j);
            }
            this.active = false;
        ...
        /* access modifiers changed from: package-private */
        public final void drainError(Throwable th) {
            unsubscribe();
            if (ExceptionsUtils.addThrowable(this.error, th)) {
                Throwable terminate = ExceptionsUtils.terminate(this.error);
                if (!ExceptionsUtils.isTerminated(terminate)) {
