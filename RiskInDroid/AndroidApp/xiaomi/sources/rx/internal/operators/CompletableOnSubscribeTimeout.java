...
public final class CompletableOnSubscribeTimeout implements Completable.OnSubscribe {
    ...
    public final void call(final CompletableSubscriber completableSubscriber) {
        ...
        createWorker.schedule(new Action0() {
            /* class rx.internal.operators.CompletableOnSubscribeTimeout.AnonymousClass1 */
                ...
                if (atomicBoolean.compareAndSet(false, true)) {
                    ...
                    if (CompletableOnSubscribeTimeout.this.other == null) {
                        ...
                        CompletableOnSubscribeTimeout.this.other.unsafeSubscribe(new CompletableSubscriber() {
                            /* class rx.internal.operators.CompletableOnSubscribeTimeout.AnonymousClass1.AnonymousClass1 */
        ...
        this.source.unsafeSubscribe(new CompletableSubscriber() {
            /* class rx.internal.operators.CompletableOnSubscribeTimeout.AnonymousClass2 */
