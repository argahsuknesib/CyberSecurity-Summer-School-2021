...
public final class OperatorWindowWithSize<T> implements Observable.Operator<Observable<T>, T> {
    ...
    static final class WindowExact<T> extends Subscriber<T> implements Action0 {
        ...
        public final Producer createProducer() {
            return new Producer() {
                /* class rx.internal.operators.OperatorWindowWithSize.WindowExact.AnonymousClass1 */
    ...
    static final class WindowOverlap<T> extends Subscriber<T> implements Action0 {
        ...
        /* access modifiers changed from: package-private */
        public final boolean checkTerminated(boolean z, boolean z2, Subscriber<? super Subject<T, T>> subscriber, Queue<Subject<T, T>> queue2) {
