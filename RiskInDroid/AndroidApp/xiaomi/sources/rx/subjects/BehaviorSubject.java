...
public final class BehaviorSubject<T> extends Subject<T, T> {
    ...
    /* JADX DEBUG: Failed to find minimal casts for resolve overloaded methods, cast all args instead
     method: rx.subjects.BehaviorSubject.create(java.lang.Object, boolean):rx.subjects.BehaviorSubject<T>
     arg types: [?[OBJECT, ARRAY], int]
     candidates:
      rx.Observable.create(rx.functions.Action1, rx.Emitter$BackpressureMode):rx.Observable<T>
      rx.subjects.BehaviorSubject.create(java.lang.Object, boolean):rx.subjects.BehaviorSubject<T> */
