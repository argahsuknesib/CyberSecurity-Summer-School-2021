...
public class Observable<T> {
    ...
    /* JADX DEBUG: Failed to find minimal casts for resolve overloaded methods, cast all args instead
     method: rx.Observable.combineLatest(java.util.List, rx.functions.FuncN):rx.Observable<R>
     arg types: [java.util.List, rx.functions.FuncN<? extends R>]
     candidates:
      rx.Observable.combineLatest(java.lang.Iterable, rx.functions.FuncN):rx.Observable<R>
      rx.Observable.combineLatest(java.util.List, rx.functions.FuncN):rx.Observable<R> */
    public static <T1, T2, R> Observable<R> combineLatest(Observable<? extends T1> observable, Observable<? extends T2> observable2, Func2<? super T1, ? super T2, ? extends R> func2) {
        return combineLatest(Arrays.asList(observable, observable2), (FuncN) Functions.fromFunc(func2));
    }
    ...
    public static <T1, T2, T3, R> Observable<R> combineLatest(Observable<? extends T1> observable, Observable<? extends T2> observable2, Observable<? extends T3> observable3, Func3<? super T1, ? super T2, ? super T3, ? extends R> func3) {
        return combineLatest(Arrays.asList(observable, observable2, observable3), (FuncN) Functions.fromFunc(func3));
    }
    ...
    public static <T1, T2, T3, T4, R> Observable<R> combineLatest(Observable<? extends T1> observable, Observable<? extends T2> observable2, Observable<? extends T3> observable3, Observable<? extends T4> observable4, Func4<? super T1, ? super T2, ? super T3, ? super T4, ? extends R> func4) {
        return combineLatest(Arrays.asList(observable, observable2, observable3, observable4), (FuncN) Functions.fromFunc(func4));
    }
    ...
    public static <T1, T2, T3, T4, T5, R> Observable<R> combineLatest(Observable<? extends T1> observable, Observable<? extends T2> observable2, Observable<? extends T3> observable3, Observable<? extends T4> observable4, Observable<? extends T5> observable5, Func5<? super T1, ? super T2, ? super T3, ? super T4, ? super T5, ? extends R> func5) {
        return combineLatest(Arrays.asList(observable, observable2, observable3, observable4, observable5), (FuncN) Functions.fromFunc(func5));
    }
    ...
    public static <T1, T2, T3, T4, T5, T6, R> Observable<R> combineLatest(Observable<? extends T1> observable, Observable<? extends T2> observable2, Observable<? extends T3> observable3, Observable<? extends T4> observable4, Observable<? extends T5> observable5, Observable<? extends T6> observable6, Func6<? super T1, ? super T2, ? super T3, ? super T4, ? super T5, ? super T6, ? extends R> func6) {
        return combineLatest(Arrays.asList(observable, observable2, observable3, observable4, observable5, observable6), (FuncN) Functions.fromFunc(func6));
    }
    ...
    public static <T1, T2, T3, T4, T5, T6, T7, R> Observable<R> combineLatest(Observable<? extends T1> observable, Observable<? extends T2> observable2, Observable<? extends T3> observable3, Observable<? extends T4> observable4, Observable<? extends T5> observable5, Observable<? extends T6> observable6, Observable<? extends T7> observable7, Func7<? super T1, ? super T2, ? super T3, ? super T4, ? super T5, ? super T6, ? super T7, ? extends R> func7) {
        return combineLatest(Arrays.asList(observable, observable2, observable3, observable4, observable5, observable6, observable7), (FuncN) Functions.fromFunc(func7));
    }
    ...
    public static <T1, T2, T3, T4, T5, T6, T7, T8, R> Observable<R> combineLatest(Observable<? extends T1> observable, Observable<? extends T2> observable2, Observable<? extends T3> observable3, Observable<? extends T4> observable4, Observable<? extends T5> observable5, Observable<? extends T6> observable6, Observable<? extends T7> observable7, Observable<? extends T8> observable8, Func8<? super T1, ? super T2, ? super T3, ? super T4, ? super T5, ? super T6, ? super T7, ? super T8, ? extends R> func8) {
        return combineLatest(Arrays.asList(observable, observable2, observable3, observable4, observable5, observable6, observable7, observable8), (FuncN) Functions.fromFunc(func8));
    }
    ...
    public static <T1, T2, T3, T4, T5, T6, T7, T8, T9, R> Observable<R> combineLatest(Observable<? extends T1> observable, Observable<? extends T2> observable2, Observable<? extends T3> observable3, Observable<? extends T4> observable4, Observable<? extends T5> observable5, Observable<? extends T6> observable6, Observable<? extends T7> observable7, Observable<? extends T8> observable8, Observable<? extends T9> observable9, Func9<? super T1, ? super T2, ? super T3, ? super T4, ? super T5, ? super T6, ? super T7, ? super T8, ? super T9, ? extends R> func9) {
        return combineLatest(Arrays.asList(observable, observable2, observable3, observable4, observable5, observable6, observable7, observable8, observable9), (FuncN) Functions.fromFunc(func9));
    }
    ...
    /* JADX WARN: Type inference failed for: r1v0, types: [rx.Observable<? extends rx.Observable<? extends T>>, rx.Observable] */
    /*  JADX ERROR: JadxRuntimeException in pass: MethodInvokeVisitor
        ...
        */
    public static <T> rx.Observable<T> concat(rx.Observable<? extends rx.Observable<? extends T>> r1) {
        /*
            rx.functions.Func1 r0 = rx.internal.util.UtilityFunctions.identity()
            rx.Observable r1 = r1.concatMap(r0)
            return r1
        */
        throw new UnsupportedOperationException("Method not decompiled: rx.Observable.concat(rx.Observable):rx.Observable");
    }
    ...
    /*  JADX ERROR: JadxRuntimeException in pass: MethodInvokeVisitor
        jadx.core.utils.exceptions.JadxRuntimeException: Not class type: ?
        	...
        	at jadx.core.dex.visitors.MethodInvokeVisitor.visit(MethodInvokeVisitor.java:65)
        */
    public static <T> rx.Observable<T> concatDelayError(rx.Observable<? extends rx.Observable<? extends T>> r1) {
        /*
            rx.functions.Func1 r0 = rx.internal.util.UtilityFunctions.identity()
            rx.Observable r1 = r1.concatMapDelayError(r0)
            return r1
        */
        throw new UnsupportedOperationException("Method not decompiled: rx.Observable.concatDelayError(rx.Observable):rx.Observable");
    }
    ...
    public static <T> Observable<T> from(Future future) {
    ...
    public static <T> Observable<T> from(Iterable iterable) {
        return unsafeCreate(new OnSubscribeFromIterable(iterable));
    }

    public static <T> Observable<T> from(Object[] objArr) {
        ...
        return unsafeCreate(new OnSubscribeFromArray(objArr));
    }
    ...
    /* JADX WARN: Type inference failed for: r2v0, types: [rx.Observable<? extends rx.Observable<? extends T>>, java.lang.Object, rx.Observable] */
    /*  JADX ERROR: JadxRuntimeException in pass: MethodInvokeVisitor
        jadx.core.utils.exceptions.JadxRuntimeException: Not class type: ?
        	at jadx.core.dex.info.ClassInfo.checkClassType(ClassInfo.java:60)
        	at jadx.core.dex.info.ClassInfo.fromType(ClassInfo.java:31)
        	...
        	at jadx.core.dex.visitors.MethodInvokeVisitor.visit(MethodInvokeVisitor.java:65)
        */
    public static <T> rx.Observable<T> merge(rx.Observable<? extends rx.Observable<? extends T>> r2) {
        /*
            java.lang.Class r0 = r2.getClass()
            java.lang.Class<rx.internal.util.ScalarSynchronousObservable> r1 = rx.internal.util.ScalarSynchronousObservable.class
            if (r0 != r1) goto L_0x0013
            rx.internal.util.ScalarSynchronousObservable r2 = (rx.internal.util.ScalarSynchronousObservable) r2
            rx.functions.Func1 r0 = rx.internal.util.UtilityFunctions.identity()
            rx.Observable r2 = r2.scalarFlatMap(r0)
            return r2
        L_0x0013:
            r0 = 0
            rx.internal.operators.OperatorMerge r0 = rx.internal.operators.OperatorMerge.instance(r0)
            rx.Observable r2 = r2.lift(r0)
            return r2
        */
        throw new UnsupportedOperationException("Method not decompiled: rx.Observable.merge(rx.Observable):rx.Observable");
    }
    ...
    /*  JADX ERROR: JadxRuntimeException in pass: MethodInvokeVisitor
        jadx.core.utils.exceptions.JadxRuntimeException: Not class type: ?
        	...
        	at jadx.core.dex.visitors.MethodInvokeVisitor.visit(MethodInvokeVisitor.java:65)
        */
    public static <T> rx.Observable<T> merge(rx.Observable<? extends rx.Observable<? extends T>> r2, int r3) {
        /*
            java.lang.Class r0 = r2.getClass()
            java.lang.Class<rx.internal.util.ScalarSynchronousObservable> r1 = rx.internal.util.ScalarSynchronousObservable.class
            if (r0 != r1) goto L_0x0013
            rx.internal.util.ScalarSynchronousObservable r2 = (rx.internal.util.ScalarSynchronousObservable) r2
            rx.functions.Func1 r3 = rx.internal.util.UtilityFunctions.identity()
            rx.Observable r2 = r2.scalarFlatMap(r3)
            return r2
        L_0x0013:
            r0 = 0
            rx.internal.operators.OperatorMerge r3 = rx.internal.operators.OperatorMerge.instance(r0, r3)
            rx.Observable r2 = r2.lift(r3)
            return r2
        */
        throw new UnsupportedOperationException("Method not decompiled: rx.Observable.merge(rx.Observable, int):rx.Observable");
    }
    ...
    /*  JADX ERROR: JadxRuntimeException in pass: MethodInvokeVisitor
        jadx.core.utils.exceptions.JadxRuntimeException: Not class type: ?
        	...
        	at jadx.core.dex.visitors.MethodInvokeVisitor.visit(MethodInvokeVisitor.java:65)
        */
    public static <T> rx.Observable<T> mergeDelayError(rx.Observable<? extends rx.Observable<? extends T>> r1) {
        /*
            r0 = 1
            rx.internal.operators.OperatorMerge r0 = rx.internal.operators.OperatorMerge.instance(r0)
            rx.Observable r1 = r1.lift(r0)
            return r1
        */
        throw new UnsupportedOperationException("Method not decompiled: rx.Observable.mergeDelayError(rx.Observable):rx.Observable");
    }
    ...
    /*  JADX ERROR: JadxRuntimeException in pass: MethodInvokeVisitor
        jadx.core.utils.exceptions.JadxRuntimeException: Not class type: ?
        	...
        	at jadx.core.dex.visitors.MethodInvokeVisitor.visit(MethodInvokeVisitor.java:65)
        */
    public static <T> rx.Observable<T> mergeDelayError(rx.Observable<? extends rx.Observable<? extends T>> r1, int r2) {
        /*
            r0 = 1
            rx.internal.operators.OperatorMerge r2 = rx.internal.operators.OperatorMerge.instance(r0, r2)
            rx.Observable r1 = r1.lift(r2)
            return r1
        */
        throw new UnsupportedOperationException("Method not decompiled: rx.Observable.mergeDelayError(rx.Observable, int):rx.Observable");
    }
    ...
    /*  JADX ERROR: JadxRuntimeException in pass: MethodInvokeVisitor
        jadx.core.utils.exceptions.JadxRuntimeException: Not class type: ?
        	...
        	at jadx.core.dex.visitors.MethodInvokeVisitor.visit(MethodInvokeVisitor.java:65)
        */
    public static <T> rx.Observable<T> switchOnNext(rx.Observable<? extends rx.Observable<? extends T>> r1) {
        /*
            r0 = 0
            rx.internal.operators.OperatorSwitch r0 = rx.internal.operators.OperatorSwitch.instance(r0)
            rx.Observable r1 = r1.lift(r0)
            return r1
        */
        throw new UnsupportedOperationException("Method not decompiled: rx.Observable.switchOnNext(rx.Observable):rx.Observable");
    }
    ...
    /*  JADX ERROR: JadxRuntimeException in pass: MethodInvokeVisitor
        jadx.core.utils.exceptions.JadxRuntimeException: Not class type: ?
        	...
        	at jadx.core.dex.visitors.MethodInvokeVisitor.visit(MethodInvokeVisitor.java:65)
        */
    public static <T> rx.Observable<T> switchOnNextDelayError(rx.Observable<? extends rx.Observable<? extends T>> r1) {
        /*
            r0 = 1
            rx.internal.operators.OperatorSwitch r0 = rx.internal.operators.OperatorSwitch.instance(r0)
            rx.Observable r1 = r1.lift(r0)
            return r1
        */
        throw new UnsupportedOperationException("Method not decompiled: rx.Observable.switchOnNextDelayError(rx.Observable):rx.Observable");
    }
    ...
    /* JADX WARN: Type inference failed for: r2v0, types: [rx.functions.Func1, rx.functions.Func1<? super Resource, ? extends rx.Observable<? extends T>>] */
    /* JADX WARN: Type inference failed for: r3v0, types: [rx.functions.Action1, rx.functions.Action1<? super Resource>] */
    /* JADX WARNING: Unknown variable types count: 2 */
    public static <T, Resource> Observable<T> using(Func0<Resource> func0, Func1<? super Resource, ? extends Observable<? extends T>> r2, Action1<? super Resource> r3) {
        return using(func0, r2, r3, false);
    }
    ...
    /* JADX WARN: Type inference failed for: r2v0, types: [rx.Observable<B>, rx.Observable] */
    /* JADX WARNING: Unknown variable types count: 1 */
    public final <B> Observable<List<T>> buffer(Observable<B> r2) {
        return buffer((Observable) r2, 16);
    }
    ...
    /* JADX WARN: Type inference failed for: r2v0, types: [rx.functions.Func0, rx.functions.Func0<? extends rx.Observable<U>>] */
    /* JADX WARNING: Unknown variable types count: 1 */
    public final <U, V> Observable<T> delay(Func0<? extends Observable<U>> r2, Func1<? super T, ? extends Observable<V>> func1) {
        return delaySubscription((Func0) r2).lift(new OperatorDelayWithSelector(this, func1));
    }
    ...
    /* JADX WARN: Type inference failed for: r1v0, types: [java.lang.Iterable<? extends rx.Observable<? extends T>>, java.lang.Iterable] */
    /* JADX WARNING: Unknown variable types count: 1 */
    public static <T> Observable<T> concatEager(Iterable<? extends Observable<? extends T>> r1) {
        return from((Iterable) r1).concatMapEager(UtilityFunctions.identity());
    }

    /* JADX WARN: Type inference failed for: r1v0, types: [java.lang.Iterable<? extends rx.Observable<? extends T>>, java.lang.Iterable] */
    /* JADX WARNING: Unknown variable types count: 1 */
    public static <T> Observable<T> concatEager(Iterable<? extends Observable<? extends T>> r1, int i) {
        return from((Iterable) r1).concatMapEager(UtilityFunctions.identity(), i);
    }
    ...
    /*  JADX ERROR: JadxRuntimeException in pass: MethodInvokeVisitor
        jadx.core.utils.exceptions.JadxRuntimeException: Not class type: ?
        	...
        	at jadx.core.dex.visitors.MethodInvokeVisitor.visit(MethodInvokeVisitor.java:65)
        */
    public static <T> rx.Observable<T> concatEager(rx.Observable<? extends rx.Observable<? extends T>> r1) {
        /*
            rx.functions.Func1 r0 = rx.internal.util.UtilityFunctions.identity()
            rx.Observable r1 = r1.concatMapEager(r0)
            return r1
        */
        throw new UnsupportedOperationException("Method not decompiled: rx.Observable.concatEager(rx.Observable):rx.Observable");
    }
    ...
    /*  JADX ERROR: JadxRuntimeException in pass: MethodInvokeVisitor
        jadx.core.utils.exceptions.JadxRuntimeException: Not class type: ?
        	...
        	at jadx.core.dex.visitors.MethodInvokeVisitor.visit(MethodInvokeVisitor.java:65)
        */
    public static <T> rx.Observable<T> concatEager(rx.Observable<? extends rx.Observable<? extends T>> r1, int r2) {
        /*
            rx.functions.Func1 r0 = rx.internal.util.UtilityFunctions.identity()
            rx.Observable r1 = r1.concatMapEager(r0, r2)
            return r1
        */
        throw new UnsupportedOperationException("Method not decompiled: rx.Observable.concatEager(rx.Observable, int):rx.Observable");
    }
    ...
    /* JADX WARN: Type inference failed for: r2v0, types: [rx.functions.Func2<? super T, ? super U, ? extends R>, rx.functions.Func2] */
    /* JADX WARNING: Unknown variable types count: 1 */
    public final <U, R> Observable<R> flatMapIterable(Func1<? super T, ? extends Iterable<? extends U>> func1, Func2<? super T, ? super U, ? extends R> r2) {
        return flatMap(OperatorMapPair.convertSelector(func1), (Func2) r2);
    }

    /* JADX WARN: Type inference failed for: r2v0, types: [rx.functions.Func2<? super T, ? super U, ? extends R>, rx.functions.Func2] */
    /* JADX WARNING: Unknown variable types count: 1 */
    public final <U, R> Observable<R> flatMapIterable(Func1<? super T, ? extends Iterable<? extends U>> func1, Func2<? super T, ? super U, ? extends R> r2, int i) {
        return flatMap(OperatorMapPair.convertSelector(func1), (Func2) r2, i);
    }
    ...
    /* JADX WARN: Type inference failed for: r1v0, types: [rx.Observable<? extends T>, rx.Observable] */
    /* JADX WARNING: Unknown variable types count: 1 */
    public final Observable<T> onErrorResumeNext(Observable<? extends T> r1) {
        return lift(OperatorOnErrorResumeNextViaFunction.withOther(r1));
    }
    ...
    /* JADX WARN: Type inference failed for: r1v0, types: [rx.Observable<? extends T>, rx.Observable] */
    /* JADX WARNING: Unknown variable types count: 1 */
    public final Observable<T> onExceptionResumeNext(Observable<? extends T> r1) {
        return lift(OperatorOnErrorResumeNextViaFunction.withException(r1));
    }
    ...
    /* JADX DEBUG: Failed to find minimal casts for resolve overloaded methods, cast all args instead
     method: rx.internal.operators.OperatorScan.<init>(java.lang.Object, rx.functions.Func2):void
     arg types: [R, rx.functions.Func2<R, ? super T, R>]
     candidates:
    ...
    /* JADX WARN: Type inference failed for: r3v0, types: [rx.functions.Func1, rx.functions.Func1<? super T, ? extends rx.Observable<V>>] */
    /* JADX WARNING: Unknown variable types count: 1 */
    public final <U, V> Observable<T> timeout(Func0<? extends Observable<U>> func0, Func1<? super T, ? extends Observable<V>> r3) {
        return timeout(func0, (Func1) r3, (Observable) null);
    }
    ...
    /* JADX WARN: Type inference failed for: r2v0, types: [rx.functions.Func2, rx.functions.Func2<? super T, ? super T, java.lang.Integer>] */
    /* JADX WARNING: Unknown variable types count: 1 */
    public final Observable<T> sorted(Func2<? super T, ? super T, Integer> r2) {
        return toSortedList((Func2) r2).flatMapIterable(UtilityFunctions.identity());
    }
    ...
    public final Observable<Observable<T>> window(int i, int i2) {
        if (i <= 0) {
            ...
            throw new IllegalArgumentException("skip > 0 required but it was ".concat(String.valueOf(i2)));
        }
    }
    ...
    /* JADX WARN: Type inference failed for: r2v0, types: [rx.functions.Func2<? super T, ? super T2, ? extends R>, rx.functions.Func2] */
    /* JADX WARNING: Unknown variable types count: 1 */
    public final <T2, R> Observable<R> zipWith(Observable<? extends T2> observable, Func2<? super T, ? super T2, ? extends R> r2) {
        return zip(this, observable, r2);
    }
