...
public final class RxJavaHooks {
    ...
    public static <T> Observable.OnSubscribe<T> onCreate(Observable.OnSubscribe onSubscribe) {
    ...
    public static <T> Single.OnSubscribe<T> onCreate(Single.OnSubscribe onSubscribe) {
