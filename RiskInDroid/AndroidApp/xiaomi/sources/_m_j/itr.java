...
public class itr extends itp {
    static Logger O00000Oo = Logger.getLogger(itr.class.getName());
    ...
    public itr(JmDNSImpl jmDNSImpl) {
        super(jmDNSImpl, itp.O00000oO);
        this.O00000oo = DNSState.ANNOUNCED;
        O000000o(DNSState.ANNOUNCED);
    }
