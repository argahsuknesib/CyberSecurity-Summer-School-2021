...
public final class gml extends gmj implements WriteDescriptorListener {
    public gml(UUID uuid, UUID uuid2) {
        super(null);
        this.O00000o = uuid;
        this.O00000oO = uuid2;
    }
    ...
    private void O00000Oo() {
        if (!setCharacteristicIndication(this.O00000o, this.O00000oO, false)) {
            O00000Oo(-1);
        } else {
            O00000o0();
        }
