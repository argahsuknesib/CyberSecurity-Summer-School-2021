...
public final class jdo {
    ...
    public static final Map<CharSequence, CharSequence> f1780O000000o;
    public static final Map<CharSequence, CharSequence> O00000Oo;
    public static final Map<CharSequence, CharSequence> O00000o;
    public static final Map<CharSequence, CharSequence> O00000o0;
    public static final Map<CharSequence, CharSequence> O00000oO;
    public static final Map<CharSequence, CharSequence> O00000oo;
    public static final Map<CharSequence, CharSequence> O0000O0o;
    public static final Map<CharSequence, CharSequence> O0000OOo;
    public static final Map<CharSequence, CharSequence> O0000Oo;
    public static final Map<CharSequence, CharSequence> O0000Oo0;
    ...
    static {
        ...
        f1780O000000o = unmodifiableMap;
        O00000Oo = Collections.unmodifiableMap(O000000o(unmodifiableMap));
        ...
        O00000o0 = unmodifiableMap2;
        O00000o = Collections.unmodifiableMap(O000000o(unmodifiableMap2));
        HashMap hashMap3 = new HashMap();
        hashMap3.put(jdn.f1779O000000o, "&quot;");
        hashMap3.put("&", "&amp;");
        hashMap3.put("<", "&lt;");
        hashMap3.put(">", "&gt;");
        Map<CharSequence, CharSequence> unmodifiableMap3 = Collections.unmodifiableMap(hashMap3);
        O00000oO = unmodifiableMap3;
        O00000oo = Collections.unmodifiableMap(O000000o(unmodifiableMap3));
        HashMap hashMap4 = new HashMap();
        hashMap4.put("'", "&apos;");
        Map<CharSequence, CharSequence> unmodifiableMap4 = Collections.unmodifiableMap(hashMap4);
        O0000O0o = unmodifiableMap4;
        O0000OOo = Collections.unmodifiableMap(O000000o(unmodifiableMap4));
        ...
        O0000Oo0 = unmodifiableMap5;
        O0000Oo = Collections.unmodifiableMap(O000000o(unmodifiableMap5));
    }

    private static Map<CharSequence, CharSequence> O000000o(Map<CharSequence, CharSequence> map) {
        HashMap hashMap = new HashMap();
        for (Map.Entry next : map.entrySet()) {
            hashMap.put((CharSequence) next.getValue(), (CharSequence) next.getKey());
        }
        return hashMap;
    }
}
