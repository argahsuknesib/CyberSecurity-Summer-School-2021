...
public final class dql extends dpo implements dqj {
    private NativeLayoutImpl O000o00O;
    ...
    public dql(VafContext vafContext, dpg dpg) {
        super(vafContext, dpg);
        this.O000o00O = new NativeLayoutImpl(vafContext.O0000O0o());
    ...
    public final void onComMeasure(int i, int i2) {
        this.O000o00O.measure(i, i2);
    }

    public final void onComLayout(boolean z, int i, int i2, int i3, int i4) {
        this.O000o00O.onLayout(z, i, i2, i3, i4);
    }

    public final void comLayout(int i, int i2, int i3, int i4) {
        this.O0000O0o = i;
        this.O0000OOo = i2;
        this.O000o00O.layout(i, i2, i3, i4);
    }
