...
public final class hin extends hik {
    String O00000o;
    String O00000o0;
    String O00000oO;
    String O00000oo;

    public hin(String str, hig.O000000o o000000o) {
        super(str, o000000o);
        if (!TextUtils.isEmpty(str)) {
            try {
                ...
                this.O00000o = jSONObject.optString("extra_data");
    ...
    public final void O000000o(Tag tag) {
        if (!TextUtils.isEmpty(this.O00000o0) && !TextUtils.isEmpty(this.O00000oO)) {
            ...
            if (!TextUtils.isEmpty(this.O00000o)) {
                hashMap.put((short) 8, this.O00000o.getBytes());
            }
