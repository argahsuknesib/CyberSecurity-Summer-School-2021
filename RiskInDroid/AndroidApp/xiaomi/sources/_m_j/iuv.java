...
public class iuv extends iuu {
    public static final <T> boolean O000000o(Collection collection, Iterable iterable) {
        ixe.O00000o0(collection, "receiver$0");
        ixe.O00000o0(iterable, "elements");
    ...
    public static final <T> boolean O000000o(List list, iwc iwc) {
        int i;
        boolean z = false;
        if (list instanceof RandomAccess) {
            int O000000o2 = iuo.O000000o(list);
            if (O000000o2 >= 0) {
                int i2 = 0;
                i = 0;
                while (true) {
                    Object obj = list.get(i2);
                    if (!((Boolean) iwc.invoke(obj)).booleanValue()) {
                        if (i != i2) {
                            list.set(i, obj);
                        }
                        i++;
            ...
            int O000000o3 = iuo.O000000o(list);
            if (O000000o3 >= i) {
                while (true) {
            ...
            Iterator it = ixi.O000000o(list).iterator();
            while (it.hasNext()) {
                if (((Boolean) iwc.invoke(it.next())).booleanValue()) {
                    it.remove();
                    z = true;
                }
            }
