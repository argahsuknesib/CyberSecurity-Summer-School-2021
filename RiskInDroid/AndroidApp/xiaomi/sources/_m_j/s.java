...
public final class s {
    static float[] O000000o(float[] fArr, int i) {
        if (i >= 0) {
    ...
    public static O00000Oo[] O000000o(O00000Oo[] o00000OoArr) {
        if (o00000OoArr == null) {
            return null;
        }
        O00000Oo[] o00000OoArr2 = new O00000Oo[o00000OoArr.length];
        for (int i = 0; i < o00000OoArr.length; i++) {
            o00000OoArr2[i] = new O00000Oo(o00000OoArr[i]);
        }
        return o00000OoArr2;
    }

    public static boolean O000000o(O00000Oo[] o00000OoArr, O00000Oo[] o00000OoArr2) {
        if (o00000OoArr == null || o00000OoArr2 == null || o00000OoArr.length != o00000OoArr2.length) {
            return false;
        }
        for (int i = 0; i < o00000OoArr.length; i++) {
            if (o00000OoArr[i].f2447O000000o != o00000OoArr2[i].f2447O000000o || o00000OoArr[i].O00000Oo.length != o00000OoArr2[i].O00000Oo.length) {
                return false;
            }
        }
        return true;
    ...
    private static void O000000o(ArrayList<O00000Oo> arrayList, char c, float[] fArr) {
        arrayList.add(new O00000Oo(c, fArr));
    }
                    ...
                    if (charAt != ' ') {
                        if (charAt == 'E' || charAt == 'e') {
                            ...
                            if (!z3) {
                                ...
                                o000000o.f2446O000000o = i4;
                                i = o000000o.f2446O000000o;
                                if (i2 < i) {
    ...
    public static class O00000Oo {
        ...
        /* renamed from: O000000o  reason: collision with root package name */
        public char f2447O000000o;
        public float[] O00000Oo;

        O00000Oo(char c, float[] fArr) {
            this.f2447O000000o = c;
            this.O00000Oo = fArr;
        }

        O00000Oo(O00000Oo o00000Oo) {
            this.f2447O000000o = o00000Oo.f2447O000000o;
            float[] fArr = o00000Oo.O00000Oo;
            this.O00000Oo = s.O000000o(fArr, fArr.length);
        }
        ...
        public static void O000000o(O00000Oo[] o00000OoArr, Path path) {
            ...
            while (i6 < o00000OoArr2.length) {
                char c4 = o00000OoArr2[i6].f2447O000000o;
                ...
                fArr2[5] = f21;
                i6 = i52 + 1;
                c3 = o00000OoArr[i52].f2447O000000o;
                c2 = 0;
                o00000OoArr2 = o00000OoArr;
            }
        }

        public final void O000000o(O00000Oo o00000Oo, O00000Oo o00000Oo2, float f) {
            this.f2447O000000o = o00000Oo.f2447O000000o;
            int i = 0;
            while (true) {
                float[] fArr = o00000Oo.O00000Oo;
                if (i < fArr.length) {
                    this.O00000Oo[i] = (fArr[i] * (1.0f - f)) + (o00000Oo2.O00000Oo[i] * f);
                    i++;
                } else {
                    return;
                }
        ...
        private static void O000000o(Path path, float f, float f2, float f3, float f4, float f5, float f6, float f7, boolean z, boolean z2) {
            ...
            while (true) {
                ...
                if (d25 < 0.0d) {
                    ...
                    Double.isNaN(d12);
                    double d31 = d * d12;
                    O000000o(path, (d30 * cos) - (d31 * sin), (d30 * sin) + (d31 * cos), d29, d12, d28, d11, radians, atan2, atan22);
                    return;
                }
            }
        }
