...
public final class drj {
    ...
    public static Matrix f14872O000000o = new Matrix() {
        /* class _m_j.drj.AnonymousClass1 */
    ...
    private static final Field O00000Oo = drl.O000000o(ImageView.class, "mDrawMatrix");
        ...
        if (drawable != null) {
            if (matrix == null || drawable.getIntrinsicWidth() == -1 || drawable.getIntrinsicHeight() == -1) {
                ...
                if (imageMatrix.isIdentity()) {
                    ...
                    drl.O000000o(imageView, O00000Oo, imageMatrix);
                }
