...
public class itn extends itp {
    static Logger O00000Oo = Logger.getLogger(itn.class.getName());
    ...
    public itn(JmDNSImpl jmDNSImpl) {
        super(jmDNSImpl, itp.O00000oO);
        this.O00000oo = DNSState.ANNOUNCING_1;
        O000000o(DNSState.ANNOUNCING_1);
    }
    ...
    public final void O00000oo() {
        ...
        if (!this.O00000oo.isAnnouncing()) {
            cancel();
            this.f1625O000000o.O0000O0o();
        }
    }
}
