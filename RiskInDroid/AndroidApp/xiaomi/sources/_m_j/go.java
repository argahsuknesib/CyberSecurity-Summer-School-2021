...
public class go extends hd {
    ...
    ArrayList<ArrayList<RecyclerView.O000OOo0>> f18067O000000o = new ArrayList<>();
    ...
    static class O00000Oo {
        ...
        /* renamed from: O000000o  reason: collision with root package name */
        public RecyclerView.O000OOo0 f18077O000000o;
        public int O00000Oo;
        public int O00000o;
        public int O00000o0;
        public int O00000oO;
    ...
    static class O000000o {
        ...
        /* renamed from: O000000o  reason: collision with root package name */
        public RecyclerView.O000OOo0 f18076O000000o;
        ...
        public final String toString() {
            return "ChangeInfo{oldHolder=" + this.f18076O000000o + ", newHolder=" + this.O00000Oo + ", fromX=" + this.O00000o0 + ", fromY=" + this.O00000o + ", toX=" + this.O00000oO + ", toY=" + this.O00000oo + '}';
        }
    }
    ...
    public final void O000000o() {
        ...
        if (z || z2 || z4 || z3) {
            ...
            while (it.hasNext()) {
                ...
                animate.setDuration(this.O0000Oo).alpha(0.0f).setListener(new AnimatorListenerAdapter() {
                    ...
                    public final void onAnimationEnd(Animator animator) {
                        ...
                        view.setAlpha(1.0f);
                        go.this.O00000oo(next);
                        go.this.O00000oo.remove(next);
                        go.this.O00000o0();
                    }
                }).start();
            }
                ...
                AnonymousClass1 r6 = new Runnable() {
                    ...
                    public final void run() {
                        ...
                        while (it.hasNext()) {
                            ...
                            go goVar = go.this;
                            RecyclerView.O000OOo0 o000OOo0 = o00000Oo.f18077O000000o;
                            ...
                            goVar.O00000oO.add(o000OOo0);
                            animate.setDuration(goVar.O0000OoO).setListener(new AnimatorListenerAdapter(o000OOo0, i5, view, i6, animate) {
                                /* class _m_j.go.AnonymousClass6 */

                                /* renamed from: O000000o  reason: collision with root package name */
                                final /* synthetic */ RecyclerView.O000OOo0 f18073O000000o;
                                ...
                                public final void onAnimationEnd(Animator animator) {
                                    ...
                                    go.this.O00000oo(this.f18073O000000o);
                                    go.this.O00000oO.remove(this.f18073O000000o);
                                    go.this.O00000o0();
                                }
                            }).start();
                        }
                        arrayList.clear();
                        go.this.O00000Oo.remove(arrayList);
                    }
                };
                if (z) {
                    cb.O000000o(((O00000Oo) arrayList.get(0)).f18077O000000o.itemView, r6, this.O0000Oo);
                } else {
                    r6.run();
                }
            }
                ...
                AnonymousClass2 r62 = new Runnable() {
                    ...
                    public final void run() {
                        ...
                        while (it.hasNext()) {
                            ...
                            go goVar = go.this;
                            RecyclerView.O000OOo0 o000OOo0 = o000000o.f18076O000000o;
                            View view2 = null;
                            if (o000OOo0 == null) {
                                view = null;
                            } else {
                            ...
                            if (view != null) {
                                ViewPropertyAnimator duration = view.animate().setDuration(goVar.O0000Ooo);
                                goVar.O0000O0o.add(o000000o.f18076O000000o);
                                ...
                                duration.alpha(0.0f).setListener(new AnimatorListenerAdapter(o000000o, duration, view) {
                                    /* class _m_j.go.AnonymousClass7 */

                                    /* renamed from: O000000o  reason: collision with root package name */
                                    final /* synthetic */ O000000o f18074O000000o;
                                    final /* synthetic */ ViewPropertyAnimator O00000Oo;
                                    final /* synthetic */ View O00000o0;
                                    ...
                                    public final void onAnimationEnd(Animator animator) {
                                        ...
                                        this.O00000o0.setTranslationX(0.0f);
                                        this.O00000o0.setTranslationY(0.0f);
                                        go.this.O00000oo(this.f18074O000000o.f18076O000000o);
                                        go.this.O0000O0o.remove(this.f18074O000000o.f18076O000000o);
                                        go.this.O00000o0();
                                    }
                                }).start();
                            }
                            if (view2 != null) {
                                ...
                                goVar.O0000O0o.add(o000000o.O00000Oo);
                                animate.translationX(0.0f).translationY(0.0f).setDuration(goVar.O0000Ooo).alpha(1.0f).setListener(new AnimatorListenerAdapter(o000000o, animate, view2) {
                                    /* class _m_j.go.AnonymousClass8 */

                                    /* renamed from: O000000o  reason: collision with root package name */
                                    final /* synthetic */ O000000o f18075O000000o;
                                    final /* synthetic */ ViewPropertyAnimator O00000Oo;
                                    final /* synthetic */ View O00000o0;
                                    ...
                                    public final void onAnimationEnd(Animator animator) {
                                        ...
                                        this.O00000o0.setTranslationX(0.0f);
                                        this.O00000o0.setTranslationY(0.0f);
                                        go.this.O00000oo(this.f18075O000000o.O00000Oo);
                                        go.this.O0000O0o.remove(this.f18075O000000o.O00000Oo);
                                        go.this.O00000o0();
                                    }
                                }).start();
                            }
                        ...
                        arrayList2.clear();
                        go.this.O00000o0.remove(arrayList2);
                    }
                };
                if (z) {
                    cb.O000000o(((O000000o) arrayList2.get(0)).f18076O000000o.itemView, r62, this.O0000Oo);
                } else {
                    r62.run();
                }
            }
            if (z4) {
                ...
                this.f18067O000000o.add(arrayList3);
                this.O0000o0o.clear();
                AnonymousClass3 r5 = new Runnable() {
                    /* class _m_j.go.AnonymousClass3 */
                    ...
                    public final void run() {
                        ...
                        while (it.hasNext()) {
                            ...
                            View view = o000OOo0.itemView;
                            ViewPropertyAnimator animate = view.animate();
                            goVar.O00000o.add(o000OOo0);
                            animate.alpha(1.0f).setDuration(goVar.O0000Oo0).setListener(new AnimatorListenerAdapter(o000OOo0, view, animate) {
                                /* class _m_j.go.AnonymousClass5 */

                                /* renamed from: O000000o  reason: collision with root package name */
                                final /* synthetic */ RecyclerView.O000OOo0 f18072O000000o;
                                ...
                                public final void onAnimationEnd(Animator animator) {
                                    ...
                                    go.this.O00000oo(this.f18072O000000o);
                                    go.this.O00000o.remove(this.f18072O000000o);
                                    go.this.O00000o0();
                                }
                            }).start();
                        }
                        arrayList3.clear();
                        go.this.f18067O000000o.remove(arrayList3);
                    }
                };
                if (z || z2 || z3) {
                    long j3 = 0;
    ...
    public boolean O000000o(RecyclerView.O000OOo0 o000OOo0, int i, int i2, int i3, int i4) {
        View view = o000OOo0.itemView;
    ...
    private void O000000o(List<O000000o> list, RecyclerView.O000OOo0 o000OOo0) {
        for (int size = list.size() - 1; size >= 0; size--) {
            ...
            if (O000000o(o000000o, o000OOo0) && o000000o.f18076O000000o == null && o000000o.O00000Oo == null) {
    ...
    private void O000000o(O000000o o000000o) {
        if (o000000o.f18076O000000o != null) {
            O000000o(o000000o, o000000o.f18076O000000o);
        }
    ...
    private boolean O000000o(O000000o o000000o, RecyclerView.O000OOo0 o000OOo0) {
        ...
        } else if (o000000o.f18076O000000o != o000OOo0) {
            return false;
        } else {
            o000000o.f18076O000000o = null;
        }
    ...
    public final void O00000o0(RecyclerView.O000OOo0 o000OOo0) {
        ...
        while (true) {
            ...
            if (size < 0) {
                break;
            } else if (this.O0000o.get(size).f18077O000000o == o000OOo0) {
        ...
        for (int size3 = this.O00000Oo.size() - 1; size3 >= 0; size3--) {
            ...
            while (true) {
                if (size4 < 0) {
                    break;
                } else if (((O00000Oo) arrayList2.get(size4)).f18077O000000o == o000OOo0) {
                    view.setTranslationY(0.0f);
                    view.setTranslationX(0.0f);
                    O00000oo(o000OOo0);
        ...
        for (int size5 = this.f18067O000000o.size() - 1; size5 >= 0; size5--) {
            ArrayList arrayList3 = this.f18067O000000o.get(size5);
            if (arrayList3.remove(o000OOo0)) {
                view.setAlpha(1.0f);
                O00000oo(o000OOo0);
                if (arrayList3.isEmpty()) {
                    this.f18067O000000o.remove(size5);
                }
            }
        }
    ...
    public final boolean O00000Oo() {
        return !this.O0000o0o.isEmpty() || !this.O0000oO0.isEmpty() || !this.O0000o.isEmpty() || !this.O0000o0O.isEmpty() || !this.O00000oO.isEmpty() || !this.O00000oo.isEmpty() || !this.O00000o.isEmpty() || !this.O0000O0o.isEmpty() || !this.O00000Oo.isEmpty() || !this.f18067O000000o.isEmpty() || !this.O00000o0.isEmpty();
    }
    ...
    public final void O00000o() {
        ...
        while (true) {
            ...
            View view = o00000Oo.f18077O000000o.itemView;
            view.setTranslationY(0.0f);
            view.setTranslationX(0.0f);
            O00000oo(o00000Oo.f18077O000000o);
            this.O0000o.remove(size);
        }
        ...
        if (O00000Oo()) {
            for (int size5 = this.O00000Oo.size() - 1; size5 >= 0; size5--) {
                ...
                for (int size6 = arrayList.size() - 1; size6 >= 0; size6--) {
                    ...
                    View view2 = o00000Oo2.f18077O000000o.itemView;
                    view2.setTranslationY(0.0f);
                    view2.setTranslationX(0.0f);
                    O00000oo(o00000Oo2.f18077O000000o);
            ...
            for (int size7 = this.f18067O000000o.size() - 1; size7 >= 0; size7--) {
                ArrayList arrayList2 = this.f18067O000000o.get(size7);
                for (int size8 = arrayList2.size() - 1; size8 >= 0; size8--) {
                    ...
                    if (arrayList2.isEmpty()) {
                        this.f18067O000000o.remove(arrayList2);
                    }
                }
            }
