...
final class epg implements epd {
    epg() {
    }
    ...
    public final void O000000o(Context context, epa epa) {
        if (epa != null) {
            ...
            eox.O000000o(context, "service", 1008, "A receive incorrect message");
        }
    }
    ...
    public final void O000000o(Context context, Intent intent, String str) {
        ...
        if (!TextUtils.isEmpty(stringExtra)) {
            ...
            if (!TextUtils.isEmpty(O00000Oo)) {
                eox.O000000o(service.getApplicationContext(), O00000Oo, 1007, "play with service successfully");
            } else {
