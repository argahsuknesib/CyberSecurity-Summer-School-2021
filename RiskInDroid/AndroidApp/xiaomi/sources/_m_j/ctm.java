...
public final class ctm extends AsyncTask<Void, Void, SparseArray<Face>> {

    /* renamed from: O000000o  reason: collision with root package name */
    private String f14346O000000o;
    ...
    public final /* synthetic */ void onPostExecute(Object obj) {
        ...
        for (int i = 0; i < sparseArray.size(); i++) {
            WritableMap O000000o2 = ctk.O000000o((Face) sparseArray.valueAt(i));
        ...
        createMap2.putString("uri", this.f14346O000000o);
        createMap.putMap("image", createMap2);
        this.O0000Oo0.O00000Oo();
        this.O00000o0.resolve(createMap);
    }

    public ctm(Context context, ReadableMap readableMap, Promise promise) {
        this.f14346O000000o = readableMap.getString("uri");
    ...
    public final void onPreExecute() {
        String str = this.f14346O000000o;
        if (str == null) {
        ...
        if (str2 == null) {
            ...
            promise.reject("E_FACE_DETECTION_FAILED", "Invalid URI provided: `" + this.f14346O000000o + "`.");
            cancel(true);
            return;
        }
    ...
    private SparseArray<Face> O000000o() {
        ...
        rNFaceDetector.O0000O0o.setTrackingEnabled(false);
        ...
        try {
            this.O0000OOo = new ExifInterface(this.O00000Oo).getAttributeInt("Orientation", 0);
        } catch (IOException e) {
            Log.e("E_FACE_DETECTION_FAILED", "Reading orientation from file `" + this.O00000Oo + "` failed.", e);
        }
        Frame.Builder builder = new Frame.Builder();
        builder.setBitmap(decodeFile);
        return this.O0000Oo0.O000000o(new ctl(builder.build(), new cts(decodeFile.getWidth(), decodeFile.getHeight())));
    }
}
