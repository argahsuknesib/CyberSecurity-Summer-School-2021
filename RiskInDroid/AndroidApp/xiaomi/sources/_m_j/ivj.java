...
public class ivj extends ivi {
    public static final <T> Set<T> O000000o(Set<? extends T> set, Iterable<? extends T> iterable) {
        ...
        if (iterable instanceof Set) {
            ...
            collection = iuo.O00000Oo(iterable);
        }
        if (collection.isEmpty()) {
            return iuo.O00000oO(iterable2);
        }
