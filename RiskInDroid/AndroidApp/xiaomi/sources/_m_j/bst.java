...
public final class bst implements Closeable {

    /* renamed from: O000000o  reason: collision with root package name */
    final Charset f13250O000000o;
    private final InputStream O00000Oo;
    private int O00000o;
    private byte[] O00000o0;
    private int O00000oO;

    public bst(InputStream inputStream, Charset charset) {
        this(inputStream, charset, (byte) 0);
    }

    private bst(InputStream inputStream, Charset charset, byte b) {
        if (inputStream == null || charset == null) {
            throw new NullPointerException();
        } else if (charset.equals(bsu.f13252O000000o)) {
            this.O00000Oo = inputStream;
            this.f13250O000000o = charset;
                    ...
                    if (this.O00000o0[i3] == 10) {
                        if (i3 != this.O00000o) {
                            ...
                            if (this.O00000o0[i2] == 13) {
                                String str = new String(this.O00000o0, this.O00000o, i2 - this.O00000o, this.f13250O000000o.name());
                                this.O00000o = i3 + 1;
                                return str;
                            }
                        }
                        i2 = i3;
                        String str2 = new String(this.O00000o0, this.O00000o, i2 - this.O00000o, this.f13250O000000o.name());
                        this.O00000o = i3 + 1;
                        return str2;
                    }
                }
                AnonymousClass1 r1 = new ByteArrayOutputStream((this.O00000oO - this.O00000o) + 80) {
                    /* class _m_j.bst.AnonymousClass1 */

                    public final String toString() {
                        try {
                            return new String(this.buf, 0, (this.count <= 0 || this.buf[this.count + -1] != 13) ? this.count : this.count - 1, bst.this.f13250O000000o.name());
