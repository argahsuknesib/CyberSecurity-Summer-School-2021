...
public class jbo {
    public static final jbo NONE = new jbo() {
        /* class _m_j.jbo.AnonymousClass1 */
    ...
    public jbo timeout(long j, TimeUnit timeUnit) {
        if (j < 0) {
    ...
    public jbo deadlineNanoTime(long j) {
        this.hasDeadline = true;
        this.deadlineNanoTime = j;
        return this;
    }

    public final jbo deadline(long j, TimeUnit timeUnit) {
        if (j <= 0) {
    ...
    public jbo clearTimeout() {
        this.timeoutNanos = 0;
        return this;
    }

    public jbo clearDeadline() {
