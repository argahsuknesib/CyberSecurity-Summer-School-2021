...
final class ink implements inv {

    /* renamed from: O000000o  reason: collision with root package name */
    private ContentResolver f1497O000000o;

    ink(Context context) {
        this.f1497O000000o = context.getContentResolver();
    }
    ...
    public final boolean O000000o() throws Throwable {
        try {
            ...
            return this.f1497O000000o.delete(uri, "_id=?", new String[]{Long.toString(ContentUris.parseId(this.f1497O000000o.insert(uri, contentValues)))}) > 0;
        } catch (Exception e) {
