...
abstract class jhs implements jhh {

    /* renamed from: O000000o  reason: collision with root package name */
    private static boolean f1839O000000o = true;
    ...
    public abstract String O000000o(jhu jhu);

    jhs(int i, String str, Class cls) {
        this.O00000oO = i;
        this.O00000oo = str;
        this.O0000OOo = cls;
    }
    ...
    public final String O00000Oo(jhu jhu) {
        String str;
        if (f1839O000000o) {
            ...
            if (o000000o == null) {
                ...
                str = o000000o.O000000o(jhu.O0000Oo0);
                if (str == null) {
                    str = O000000o(jhu);
                }
                if (f1839O000000o) {
                    this.O0000Oo0.O000000o(jhu.O0000Oo0, str);
                }
                return str;
            }
        }
    ...
    public final Class O00000Oo(int i) {
        return jho.O000000o(O000000o(i), O000000o());
    }
    ...
    public final Class[] O00000o0(int i) {
        ...
        for (int i2 = 0; i2 < countTokens; i2++) {
            clsArr[i2] = jho.O000000o(stringTokenizer.nextToken(), O000000o());
        }
        return clsArr;
    }
    ...
    static final class O00000Oo implements O000000o {
        ...
        /* renamed from: O000000o  reason: collision with root package name */
        private SoftReference f1840O000000o;
        ...
        private String[] O000000o() {
            return (String[]) this.f1840O000000o.get();
        }

        private String[] O00000Oo() {
            String[] strArr = new String[3];
            this.f1840O000000o = new SoftReference(strArr);
            return strArr;
        }
    }
}
