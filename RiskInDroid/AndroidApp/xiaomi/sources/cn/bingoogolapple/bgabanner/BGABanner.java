...
public class BGABanner extends RelativeLayout implements ViewPager.O0000O0o, BGAViewPager.O000000o {
    ...
    public BGAViewPager f3069O000000o;
    ...
    public interface O000000o<V extends View, M> {
        void O000000o(V v, M m);
    }

    public interface O00000o0<V extends View, M> {
        void O000000o(M m, int i);
    }
    ...
    public BGABanner(Context context, AttributeSet attributeSet, int i) {
        ...
        this.O000OO = true;
        this.O000OOo = true;
        this.O000OOoo = new lo() {
            /* class cn.bingoogolapple.bgabanner.BGABanner.AnonymousClass1 */
        ...
        if (Build.VERSION.SDK_INT >= 16) {
            relativeLayout.setBackground(this.O0000oOO);
        } else {
            relativeLayout.setBackgroundDrawable(this.O0000oOO);
        }
        ...
        if (this.O000O0Oo) {
            ...
            relativeLayout.addView(this.O0000Oo0, layoutParams2);
        }
        ...
        relativeLayout.addView(this.O0000Oo, layoutParams3);
    ...
    public void setPageChangeDuration(int i) {
        if (i >= 0 && i <= 2000) {
            this.O0000Ooo = i;
            BGAViewPager bGAViewPager = this.f3069O000000o;
    ...
    public void setAutoPlayAble(boolean z) {
        ...
        if (bGAViewPager != null && bGAViewPager.getAdapter() != null) {
            this.f3069O000000o.getAdapter().notifyDataSetChanged();
        }
    }
    ...
    public int getCurrentItem() {
        if (this.f3069O000000o == null || lm.O000000o(this.O00000o0, new Collection[0])) {
            return -1;
        }
        return this.f3069O000000o.getCurrentItem() % this.O00000o0.size();
    }
    ...
    private void O00000o0() {
        ...
        if (bGAViewPager != null && equals(bGAViewPager.getParent())) {
            removeView(this.f3069O000000o);
            this.f3069O000000o = null;
        }
        this.f3069O000000o = new BGAViewPager(getContext());
        this.f3069O000000o.setOffscreenPageLimit(1);
        this.f3069O000000o.setAdapter(new O00000o(this, (byte) 0));
        this.f3069O000000o.addOnPageChangeListener(this);
        this.f3069O000000o.setOverScrollMode(this.O000O00o);
        this.f3069O000000o.setAllowUserScrollable(this.O000OO);
        this.f3069O000000o.setPageTransformer(true, lr.O000000o(this.O0000ooO));
        setPageChangeDuration(this.O0000Ooo);
        RelativeLayout.LayoutParams layoutParams = new RelativeLayout.LayoutParams(-1, -1);
        layoutParams.setMargins(0, 0, 0, this.O000OO00);
        addView(this.f3069O000000o, 0, layoutParams);
        if (this.O00000o) {
            this.f3069O000000o.setAutoPlayDelegate(this);
            this.f3069O000000o.setCurrentItem(1073741823 - (1073741823 % this.O00000o0.size()));
            O000000o();
            return;
        }
        O000000o(0);
    ...
    public void setCurrentItem(int i) {
        if (this.f3069O000000o != null && this.O00000o0 != null) {
            if (i <= getItemCount() - 1) {
                if (this.O00000o) {
                    int currentItem = this.f3069O000000o.getCurrentItem();
                    int size = i - (currentItem % this.O00000o0.size());
                    if (size < 0) {
                        for (int i2 = -1; i2 >= size; i2--) {
                            this.f3069O000000o.setCurrentItem(currentItem + i2, false);
                        }
                    } else if (size > 0) {
                        for (int i3 = 1; i3 <= size; i3++) {
                            this.f3069O000000o.setCurrentItem(currentItem + i3, false);
                        }
                    }
                    O000000o();
                    return;
                }
                this.f3069O000000o.setCurrentItem(i, false);
            }
        }
    }
    ...
    private void O00000o() {
        O00000oO();
        if (!this.O000OOo && this.O00000o && this.f3069O000000o != null && getItemCount() > 0 && this.O0000oo != 0.0f) {
            BGAViewPager bGAViewPager = this.f3069O000000o;
            bGAViewPager.setCurrentItem(bGAViewPager.getCurrentItem() - 1);
            BGAViewPager bGAViewPager2 = this.f3069O000000o;
    ...
    public void setPageTransformer(ViewPager.O0000OOo o0000OOo) {
        ...
        if (o0000OOo != null && (bGAViewPager = this.f3069O000000o) != null) {
    ...
    public final void O000000o(float f) {
        ...
        if (this.O0000oo0 < bGAViewPager.getCurrentItem()) {
            if (f > 400.0f || (this.O0000oo < 0.7f && f > -400.0f)) {
                this.f3069O000000o.setBannerCurrentItemInternal(this.O0000oo0, true);
            } else {
                this.f3069O000000o.setBannerCurrentItemInternal(this.O0000oo0 + 1, true);
            }
        ...
        public final Object instantiateItem(ViewGroup viewGroup, int i) {
            ...
            if (BGABanner.this.O00000oo != null) {
                view.setOnClickListener(new lo() {
                    /* class cn.bingoogolapple.bgabanner.BGABanner.O00000o.AnonymousClass1 */

                    public final void O000000o() {
                        int currentItem = BGABanner.this.f3069O000000o.getCurrentItem() % BGABanner.this.O00000o0.size();
                        if (lm.O000000o(currentItem, BGABanner.this.O00000oO)) {
                            BGABanner.this.O00000oo.O000000o(BGABanner.this.O00000oO.get(currentItem), currentItem);
                        } else if (lm.O000000o(BGABanner.this.O00000oO, new Collection[0])) {
                            BGABanner.this.O00000oo.O000000o(null, currentItem);
                        }
                    }
                });
            }
            if (BGABanner.this.O0000O0o != null) {
                if (lm.O000000o(size, BGABanner.this.O00000oO)) {
                    BGABanner.this.O0000O0o.O000000o(view, BGABanner.this.O00000oO.get(size));
                } else if (lm.O000000o(BGABanner.this.O00000oO, new Collection[0])) {
                    BGABanner.this.O0000O0o.O000000o(view, null);
                }
            }
    ...
    static class O00000Oo implements Runnable {
        ...
        /* renamed from: O000000o  reason: collision with root package name */
        private final WeakReference<BGABanner> f3071O000000o;
        ...
        private O00000Oo(BGABanner bGABanner) {
            this.f3071O000000o = new WeakReference<>(bGABanner);
        }

        public final void run() {
            BGABanner bGABanner = this.f3071O000000o.get();
            if (bGABanner != null) {
                if (bGABanner.f3069O000000o != null) {
                    bGABanner.f3069O000000o.setCurrentItem(bGABanner.f3069O000000o.getCurrentItem() + 1);
                }
                bGABanner.O000000o();
            }
        }
