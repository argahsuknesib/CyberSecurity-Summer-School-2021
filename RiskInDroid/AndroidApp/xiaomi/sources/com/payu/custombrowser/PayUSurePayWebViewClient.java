...
public class PayUSurePayWebViewClient extends WebViewClient {
    ...
    public PayUSurePayWebViewClient(Bank bank2, String str) {
        this.bank = bank2;
    ...
    public void onReceivedError(WebView webView, int i, String str, String str2) {
        ...
        if (str2 != null && this.bank != null && !str.contentEquals("net::ERR_CONNECTION_RESET") && Build.VERSION.SDK_INT < 23) {
    ...
    public void onReceivedError(WebView webView, WebResourceRequest webResourceRequest, WebResourceError webResourceError) {
        ...
        if (this.bank != null && !webResourceError.getDescription().toString().contentEquals("net::ERR_CONNECTION_RESET")) {
