...
public final class k {
    ...
    private static final Pattern f3139a = Pattern.compile("([0-9]{1,2})[- ]([A-Za-z]{3,9})[- ]([0-9]{2,4})[ ]([0-9]{1,2}:[0-9][0-9]:[0-9][0-9])");
    ...
    public static long a(String str) {
        ...
        int i5;
        int i6;
        Matcher matcher = f3139a.matcher(str);
        if (matcher.find()) {
        ...
        time.set(aVar.c, aVar.b, aVar.f3140a, i6, i5, i4);
