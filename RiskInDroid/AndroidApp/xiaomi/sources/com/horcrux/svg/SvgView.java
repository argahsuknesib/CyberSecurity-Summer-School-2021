...
public class SvgView extends ReactViewGroup implements ReactCompoundView, ReactCompoundViewGroup {
    ...
    private baq mbbHeight;
    private baq mbbWidth;
    ...
    public void setBbWidth(Dynamic dynamic) {
        this.mbbWidth = baq.O000000o(dynamic);
        invalidate();
        clearChildCache();
    }
    ...
    public void setBbHeight(Dynamic dynamic) {
        this.mbbHeight = baq.O000000o(dynamic);
        invalidate();
        clearChildCache();
    }
    ...
    public synchronized void drawChildren(Canvas canvas) {
        ...
        if (this.mAlign != null) {
            ...
            if (z) {
                width = (float) bao.O000000o(this.mbbWidth, (double) width, 0.0d, (double) this.mScale, 12.0d);
                height = (float) bao.O000000o(this.mbbHeight, (double) height, 0.0d, (double) this.mScale, 12.0d);
            }
            RectF rectF = new RectF(0.0f, 0.0f, width, height);
            if (z) {
                canvas.clipRect(rectF);
            }
            Matrix O000000o2 = bar.O000000o(viewBox, rectF, this.mAlign, this.mMeetOrSlice);
            this.mInvertible = O000000o2.invert(this.mInvViewBoxMatrix);
            canvas.concat(O000000o2);
        }
