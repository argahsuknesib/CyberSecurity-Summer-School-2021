...
public class MiConnectVerticalViewPager extends ViewGroup {

    /* renamed from: O000000o  reason: collision with root package name */
    public static final int[] f5636O000000o = {16842931};
    private static final Comparator<O00000Oo> O00000oO = new Comparator<O00000Oo>() {
        /* class com.smarthome.connect.view.MiConnectVerticalViewPager.AnonymousClass1 */
    ...
    private static final Interpolator O00000oo = new Interpolator() {
        /* class com.smarthome.connect.view.MiConnectVerticalViewPager.AnonymousClass2 */
    ...
    private final Runnable O000o000 = new Runnable() {
        /* class com.smarthome.connect.view.MiConnectVerticalViewPager.AnonymousClass3 */

        public final void run() {
            MiConnectVerticalViewPager.this.setScrollState(0);
            MiConnectVerticalViewPager.this.O00000Oo();
        }
    };
    ...
    public MiConnectVerticalViewPager(Context context) {
        super(context);
        O00000o0();
    }

    public MiConnectVerticalViewPager(Context context, AttributeSet attributeSet) {
    ...
    /* JADX DEBUG: Failed to find minimal casts for resolve overloaded methods, cast all args instead
     ...
     arg types: [com.smarthome.connect.view.MiConnectVerticalViewPager, int]
     candidates:
    ...
    /* JADX DEBUG: Failed to find minimal casts for resolve overloaded methods, cast all args instead
     ...
     arg types: [com.smarthome.connect.view.MiConnectVerticalViewPager, int, java.lang.Object]
     candidates:
    ...
    /* JADX DEBUG: Failed to find minimal casts for resolve overloaded methods, cast all args instead
     method: com.smarthome.connect.view.MiConnectVerticalViewPager.O000000o(int, boolean, boolean):void
     arg types: [int, int, int]
     candidates:
      com.smarthome.connect.view.MiConnectVerticalViewPager.O000000o(int, float, int):void
      com.smarthome.connect.view.MiConnectVerticalViewPager.O000000o(com.smarthome.connect.view.MiConnectVerticalViewPager$O00000Oo, int, com.smarthome.connect.view.MiConnectVerticalViewPager$O00000Oo):void
      com.smarthome.connect.view.MiConnectVerticalViewPager.O000000o(int, boolean, boolean):void */
    public void setAdapter(jz jzVar) {
        ...
        if (jzVar2 != null) {
            ...
            for (int i = 0; i < this.O0000O0o.size(); i++) {
                ...
                this.O00000Oo.destroyItem((ViewGroup) this, o00000Oo.O00000Oo, o00000Oo.f5639O000000o);
            }
            this.O00000Oo.finishUpdate((ViewGroup) this);
            this.O0000O0o.clear();
            int i2 = 0;
            while (i2 < getChildCount()) {
                if (!((LayoutParams) getChildAt(i2).getLayoutParams()).f5638O000000o) {
                    removeViewAt(i2);
                    i2--;
                }
                i2++;
    ...
    public void setOffscreenPageLimit(int i) {
        if (i <= 0) {
            gsy.O000000o(5, "ViewPager", "Requested offscreen page limit " + i + " too small; defaulting to 1");
            i = 1;
        }
        if (i != this.O00oOooO) {
            this.O00oOooO = i;
    ...
    private O00000Oo O00000Oo(int i, int i2) {
        ...
        o00000Oo.O00000Oo = i;
        o00000Oo.f5639O000000o = this.O00000Oo.instantiateItem((ViewGroup) this, i);
    ...
    public final void O000000o() {
        ...
        while (i2 < this.O0000O0o.size()) {
            ...
            int itemPosition = this.O00000Oo.getItemPosition(o00000Oo.f5639O000000o);
            if (itemPosition != -1) {
                if (itemPosition == -2) {
    ...
    private void O00000Oo(int i) {
        ...
        if (this.O00000Oo == null) {
            ...
            if (count == this.O00000o) {
                    ...
                    for (int i10 = this.O00000o0 - 1; i10 >= 0; i10--) {
                        if (f3 >= f && i10 < max) {
                            ...
                            if (i10 == o00000Oo4.O00000Oo && !o00000Oo4.O00000o0) {
                                ...
                                this.O00000Oo.destroyItem((ViewGroup) this, i10, o00000Oo4.f5639O000000o);
                                i8--;
                                i9--;
                                if (i8 >= 0) {
                        ...
                        while (true) {
                            ...
                            if (f4 >= f2 && i12 > min) {
                                if (o00000Oo5 == null) {
                                    ...
                                    this.O00000Oo.destroyItem((ViewGroup) this, i12, o00000Oo5.f5639O000000o);
                ...
                this.O00000Oo.setPrimaryItem((ViewGroup) this, this.O00000o0, o00000Oo2 != null ? o00000Oo2.f5639O000000o : null);
                this.O00000Oo.finishUpdate((ViewGroup) this);
                int childCount = getChildCount();
    ...
    public static class SavedState extends View.BaseSavedState {
        public static final Parcelable.Creator<SavedState> CREATOR = aq.O000000o(new ar<SavedState>() {
            /* class com.smarthome.connect.view.MiConnectVerticalViewPager.SavedState.AnonymousClass1 */
        ...
        public void writeToParcel(Parcel parcel, int i) {
            ...
            parcel.writeInt(this.f5642O000000o);
            parcel.writeParcelable(this.O00000Oo, i);
        }

        public String toString() {
            return "FragmentPager.SavedState{" + Integer.toHexString(System.identityHashCode(this)) + " position=" + this.f5642O000000o + "}";
        }

        SavedState(Parcel parcel, ClassLoader classLoader) {
            super(parcel);
            classLoader = classLoader == null ? getClass().getClassLoader() : classLoader;
            this.f5642O000000o = parcel.readInt();
    ...
    public Parcelable onSaveInstanceState() {
        ...
        savedState.f5642O000000o = this.O00000o0;
        jz jzVar = this.O00000Oo;
        if (jzVar != null) {
    ...
    public void onRestoreInstanceState(Parcelable parcelable) {
        ...
        if (jzVar != null) {
            ...
            O000000o(savedState.f5642O000000o, false, true);
            return;
        }
        this.O0000Oo = savedState.f5642O000000o;
    ...
    public void addView(View view, int i, ViewGroup.LayoutParams layoutParams) {
        ...
        layoutParams2.f5638O000000o |= view instanceof O000000o;
        if (!this.O0000oo) {
            super.addView(view, i, layoutParams);
        } else if (layoutParams2 == null || !layoutParams2.f5638O000000o) {
    ...
    private O00000Oo O000000o(View view) {
        for (int i = 0; i < this.O0000O0o.size(); i++) {
            O00000Oo o00000Oo = this.O0000O0o.get(i);
            if (this.O00000Oo.isViewFromObject(view, o00000Oo.f5639O000000o)) {
                return o00000Oo;
            }
        }
        return null;
    ...
    public void onMeasure(int i, int i2) {
        ...
        while (true) {
            ...
            if (!(childAt.getVisibility() == 8 || (layoutParams2 = (LayoutParams) childAt.getLayoutParams()) == null || !layoutParams2.f5638O000000o)) {
        ...
        for (int i12 = 0; i12 < childCount2; i12++) {
            ...
            if (childAt2.getVisibility() != 8 && ((layoutParams = (LayoutParams) childAt2.getLayoutParams()) == null || !layoutParams.f5638O000000o)) {
    ...
    /* JADX DEBUG: Failed to find minimal casts for resolve overloaded methods, cast all args instead
     method: com.smarthome.connect.view.MiConnectVerticalViewPager.O000000o(int, boolean, int, boolean):void
     arg types: [int, int, int, int]
     candidates:
      com.smarthome.connect.view.MiConnectVerticalViewPager.O000000o(int, int, int, int):void
      com.smarthome.connect.view.MiConnectVerticalViewPager.O000000o(int, boolean, boolean, int):void
      com.smarthome.connect.view.MiConnectVerticalViewPager.O000000o(int, boolean, int, boolean):void */
    /* access modifiers changed from: protected */
    public void onLayout(boolean z, int i, int i2, int i3, int i4) {
        ...
        for (int i17 = 0; i17 < childCount; i17++) {
            ...
            if (childAt2.getVisibility() != 8) {
                ...
                if (!layoutParams2.f5638O000000o && (O000000o2 = O000000o(childAt2)) != null) {
                    float f = (float) i16;
    ...
    private void O000000o(int i, float f, int i2) {
        ...
        if (this.O000OoOo != null) {
            ...
            for (int i10 = 0; i10 < childCount2; i10++) {
                ...
                if (!((LayoutParams) childAt2.getLayoutParams()).f5638O000000o) {
    ...
    /* JADX DEBUG: Failed to find minimal casts for resolve overloaded methods, cast all args instead
     ...
     candidates:
      ...
      com.smarthome.connect.view.MiConnectVerticalViewPager.O000000o(int, boolean, int, boolean):void */
    /* JADX DEBUG: Failed to find minimal casts for resolve overloaded methods, cast all args instead
     method: com.smarthome.connect.view.MiConnectVerticalViewPager.O000000o(int, boolean, boolean, int):void
     arg types: [int, int, int, int]
     candidates:
      com.smarthome.connect.view.MiConnectVerticalViewPager.O000000o(int, int, int, int):void
      com.smarthome.connect.view.MiConnectVerticalViewPager.O000000o(int, boolean, int, boolean):void
    ...
    public boolean onTouchEvent(MotionEvent motionEvent) {
        ...
        boolean z = false;
        if ((motionEvent.getAction() == 0 && motionEvent.getEdgeFlags() != 0) || (jzVar = this.O00000Oo) == null || jzVar.getCount() == 0) {
            return false;
        }
        if (this.O000OO0o == null) {
            this.O000OO0o = VelocityTracker.obtain();
        ...
        if (action != 0) {
            if (action != 1) {
                if (action == 2) {
                    if (!this.O00oOooo) {
                        ...
                        if (abs > ((float) this.O00oOoOo) && abs > abs2) {
                            ...
                            this.O000O0o = y - f > 0.0f ? f + ((float) this.O00oOoOo) : f - ((float) this.O00oOoOo);
                            this.O000O0o0 = x;
                            setScrollState(1);
                            setScrollingCacheEnabled(true);
                    ...
                    if (this.O00oOooo) {
                        z = false | O00000Oo(motionEvent.getY(motionEvent.findPointerIndex(this.O000OO00)));
                    }
                } else if (action != 3) {
                    if (action == 5) {
                ...
                float f2 = ((((float) scrollY) / ((float) clientHeight)) - O00000oo2.O00000oO) / O00000oo2.O00000o;
                if (Math.abs((int) (motionEvent.getY(motionEvent.findPointerIndex(this.O000OO00)) - this.O000O0oo)) <= this.O000OOo0 || Math.abs(yVelocity) <= this.O000OO) {
                    i = (int) (((float) i) + f2 + (i >= this.O00000o0 ? 0.4f : 0.6f));
                } else if (yVelocity <= 0) {
                    i++;
                }
                if (this.O0000O0o.size() > 0) {
                    ArrayList<O00000Oo> arrayList = this.O0000O0o;
                    i = Math.max(this.O0000O0o.get(0).O00000Oo, Math.min(i, arrayList.get(arrayList.size() - 1).O00000Oo));
                }
        ...
        if (findFocus != this) {
            if (findFocus != null) {
                ...
                if (!z) {
                    ...
                    gsy.O000000o(6, "ViewPager", "arrowScroll tried to find focus based on non-child current focused view " + sb.toString());
                }
            }
            view = findFocus;
        }
    ...
    class O00000o0 extends bh {
        ...
        public final void onInitializeAccessibilityEvent(View view, AccessibilityEvent accessibilityEvent) {
            ...
            if (accessibilityEvent.getEventType() == 4096 && MiConnectVerticalViewPager.this.O00000Oo != null) {
                O000000o2.O000000o(MiConnectVerticalViewPager.this.O00000Oo.getCount());
                O000000o2.O00000Oo(MiConnectVerticalViewPager.this.O00000o0);
                O000000o2.O00000o0(MiConnectVerticalViewPager.this.O00000o0);
            }
        }
        ...
        public final void onInitializeAccessibilityNodeInfo(View view, cl clVar) {
            ...
            if (MiConnectVerticalViewPager.this.O000000o(1)) {
                clVar.O000000o(4096);
            }
            if (MiConnectVerticalViewPager.this.O000000o(-1)) {
                clVar.O000000o(8192);
        ...
        public final boolean performAccessibilityAction(View view, int i, Bundle bundle) {
            ...
            if (i != 4096) {
                if (i != 8192 || !MiConnectVerticalViewPager.this.O000000o(-1)) {
                    return false;
                }
                MiConnectVerticalViewPager miConnectVerticalViewPager = MiConnectVerticalViewPager.this;
                miConnectVerticalViewPager.setCurrentItem(miConnectVerticalViewPager.O00000o0 - 1);
                return true;
            } else if (!MiConnectVerticalViewPager.this.O000000o(1)) {
                return false;
            } else {
                MiConnectVerticalViewPager miConnectVerticalViewPager2 = MiConnectVerticalViewPager.this;
                miConnectVerticalViewPager2.setCurrentItem(miConnectVerticalViewPager2.O00000o0 + 1);
                return true;
            }
        }

        private boolean O000000o() {
            return MiConnectVerticalViewPager.this.O00000Oo != null && MiConnectVerticalViewPager.this.O00000Oo.getCount() > 1;
        }
    }
    ...
    class O0000O0o extends DataSetObserver {
        ...
        /* synthetic */ O0000O0o(MiConnectVerticalViewPager miConnectVerticalViewPager, byte b) {
            this();
        }

        public final void onChanged() {
            MiConnectVerticalViewPager.this.O000000o();
        }
    ...
    public static class LayoutParams extends ViewGroup.LayoutParams {
        ...
        public LayoutParams(Context context, AttributeSet attributeSet) {
            super(context, attributeSet);
            TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, MiConnectVerticalViewPager.f5636O000000o);
    ...
    static class O0000OOo implements Comparator<View> {
        ...
        public final /* synthetic */ int compare(Object obj, Object obj2) {
            ...
            if (layoutParams.f5638O000000o != layoutParams2.f5638O000000o) {
                return layoutParams.f5638O000000o ? 1 : -1;
            }
