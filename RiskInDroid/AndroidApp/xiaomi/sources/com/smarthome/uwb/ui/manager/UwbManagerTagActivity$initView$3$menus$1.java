...
final class UwbManagerTagActivity$initView$3$menus$1 extends Lambda implements iwb<Boolean> {
    final /* synthetic */ UwbManagerTagActivity this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    UwbManagerTagActivity$initView$3$menus$1(UwbManagerTagActivity uwbManagerTagActivity) {
        super(0);
