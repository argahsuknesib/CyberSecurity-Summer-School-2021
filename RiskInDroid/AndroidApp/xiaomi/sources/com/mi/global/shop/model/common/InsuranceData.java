...
public final class InsuranceData extends Message<InsuranceData, Builder> {
    ...
    public InsuranceData(String str, String str2, String str3, String str4, String str5, String str6, String str7, String str8, Integer num2, String str9, String str10) {
        this(str, str2, str3, str4, str5, str6, str7, str8, num2, str9, str10, ByteString.O00000Oo);
    }

    public InsuranceData(String str, String str2, String str3, String str4, String str5, String str6, String str7, String str8, Integer num2, String str9, String str10, ByteString byteString) {
    ...
    public final String toString() {
        ...
        if (this.insurance_desc != null) {
            sb.append(", insurance_desc=");
            sb.append(this.insurance_desc);
        }
    ...
    public static final class Builder extends Message.Builder<InsuranceData, Builder> {
        ...
        public final Builder insurance_desc(String str) {
    ...
    static final class ProtoAdapter_InsuranceData extends ProtoAdapter<InsuranceData> {
        ...
        public final void encode(ProtoWriter protoWriter, InsuranceData insuranceData) throws IOException {
            ...
            if (insuranceData.insurance_desc != null) {
                ProtoAdapter.STRING.encodeWithTag(protoWriter, 15, insuranceData.insurance_desc);
            }
