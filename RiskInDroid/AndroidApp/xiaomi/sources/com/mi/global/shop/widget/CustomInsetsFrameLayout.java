...
public final class CustomInsetsFrameLayout extends FrameLayout {
    ...
    private int[] f4952O000000o = new int[4];
    ...
    public final int[] getInsets() {
        return this.f4952O000000o;
    }

    /* access modifiers changed from: protected */
    public final boolean fitSystemWindows(Rect rect) {
        if (Build.VERSION.SDK_INT >= 19) {
            this.f4952O000000o[0] = rect.left;
            this.f4952O000000o[1] = rect.top;
            this.f4952O000000o[2] = rect.right;
            rect.left = 0;
            rect.top = 0;
            rect.right = 0;
        }
