...
public final class PaygoBody extends Message<PaygoBody, Builder> {
    ...
    public PaygoBody(Integer num, String str, PaygoData paygoData) {
        this(num, str, paygoData, ByteString.O00000Oo);
    }
    ...
    public final boolean equals(Object obj) {
        ...
        return Internal.equals(unknownFields(), paygoBody.unknownFields()) && Internal.equals(this.Errno, paygoBody.Errno) && Internal.equals(this.Errmsg, paygoBody.Errmsg) && Internal.equals(this.Data, paygoBody.Data);
    }
    ...
    public final int hashCode() {
        ...
        PaygoData paygoData = this.Data;
        if (paygoData != null) {
            i2 = paygoData.hashCode();
        }
        int i3 = hashCode3 + i2;
        this.hashCode = i3;
        return i3;
    ...
    public static final class Builder extends Message.Builder<PaygoBody, Builder> {
        ...
        public final Builder Data(PaygoData paygoData) {
            this.Data = paygoData;
            return this;
        }

        public final PaygoBody build() {
            return new PaygoBody(this.Errno, this.Errmsg, this.Data, buildUnknownFields());
        }
    }

    static final class ProtoAdapter_PaygoBody extends ProtoAdapter<PaygoBody> {
        ProtoAdapter_PaygoBody() {
            super(FieldEncoding.LENGTH_DELIMITED, PaygoBody.class);
        }

        public final int encodedSize(PaygoBody paygoBody) {
            int i = 0;
            ...
            return encodedSizeWithTag + i + paygoBody.unknownFields().O0000OOo();
        }

        public final void encode(ProtoWriter protoWriter, PaygoBody paygoBody) throws IOException {
        ...
        public final PaygoBody decode(ProtoReader protoReader) throws IOException {
            Builder builder = new Builder();
        ...
        public final PaygoBody redact(PaygoBody paygoBody) {
