...
public class CommonButton extends FrameLayout {
    ...
    private TextView f5103O000000o;
    ...
    private void O000000o(AttributeSet attributeSet, int i) {
        int i2;
        setPadding(0, 0, 0, 0);
        View inflate = ((LayoutInflater) getContext().getSystemService("layout_inflater")).inflate((int) R.layout.layout_common_button, (ViewGroup) null, false);
        this.f5103O000000o = (TextView) inflate.findViewById(R.id.common_button_middletext);
        ...
        try {
            if (!TextUtils.isEmpty(obtainStyledAttributes.getString(2))) {
                this.f5103O000000o.setTextColor(obtainStyledAttributes.getColor(2, R.color.mini_text_white));
            }
            if (!TextUtils.isEmpty(obtainStyledAttributes.getString(4))) {
                this.f5103O000000o.setText(obtainStyledAttributes.getString(4));
            }
            if (!TextUtils.isEmpty(obtainStyledAttributes.getString(1))) {
                this.f5103O000000o.setTextSize(0, obtainStyledAttributes.getDimension(1, 14.0f));
            } else {
                this.f5103O000000o.setTextSize(1, 14.0f);
            }
    ...
    public CharSequence getText() {
        return this.f5103O000000o.getText();
    }

    public void setTextColor(int i) {
        this.f5103O000000o.setTextColor(i);
    }

    public void setText(String str) {
        this.f5103O000000o.setText(str);
    }

    public void setText(int i) {
        this.f5103O000000o.setText(i);
    }
}
