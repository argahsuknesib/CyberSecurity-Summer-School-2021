    ...
    public static boolean validateAppSignature(Context context, Signature[] signatureArr, boolean z) {
        ...
        if (!z) {
            ...
            while (i < length) {
                ...
                b.e("MicroMsg.SDK.WXMsgImplComm", "check signature:".concat(String.valueOf(lowerCase)));
        ...
        b.e("MicroMsg.SDK.WXMsgImplComm", str);
        return true;
    }

    public static boolean validateAppSignatureForPackage(Context context, String str, boolean z) {
        if (!z) {
            b.e("MicroMsg.SDK.WXMsgImplComm", "ignore wechat app signature validation");
            return true;
        }
        try {
