...
public final class ModelManager {
    ...
    public static void initialize() {
        shardPreferences = FacebookSdk.getApplicationContext().getSharedPreferences("com.facebook.internal.MODEL_STORE", 0);
        initializeModels();
    }
            ...
            public final void run() {
                try {
                    ...
                    if (fetchFromServer != null) {
                        ModelManager.shardPreferences.edit().putString("models", fetchFromServer.toString()).apply();
                    } else {
                        fetchFromServer = new JSONObject(ModelManager.shardPreferences.getString("models", ""));
                    }
    ...
    public static void enableSuggestedEvents() {
        if (models.containsKey("SUGGEST_EVENT")) {
            ...
            if (resourceLocale == null || resourceLocale.getLanguage().contains("en")) {
                FeatureManager.checkFeature(FeatureManager.Feature.SuggestedEvents, new FeatureManager.Callback() {
                    ...
                    public final void onCompleted(boolean z) {
                        if (z) {
                            ModelManager.models.get("SUGGEST_EVENT").initialize(new Runnable() {
    ...
    public static void enablePIIFiltering() {
        if (models.containsKey("DATA_DETECTION_ADDRESS")) {
            FeatureManager.checkFeature(FeatureManager.Feature.PIIFiltering, new FeatureManager.Callback() {
                ...
                public final void onCompleted(boolean z) {
                    if (z) {
                        ModelManager.models.get("DATA_DETECTION_ADDRESS").initialize(new Runnable() {
