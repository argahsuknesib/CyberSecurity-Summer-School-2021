...
public class ReactDebugOverlayTags {
    ...
    public static final DebugOverlayTag NATIVE_MODULE = new DebugOverlayTag("Native Module", "Native Module init", Color.rgb((int) NotificationCompat.FLAG_HIGH_PRIORITY, 0, (int) NotificationCompat.FLAG_HIGH_PRIORITY));
