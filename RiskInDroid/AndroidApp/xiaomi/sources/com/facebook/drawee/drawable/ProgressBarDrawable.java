...
public class ProgressBarDrawable extends Drawable implements CloneableDrawable {
    ...
    public void draw(Canvas canvas) {
        ...
        if (this.mIsVertical) {
            drawVerticalBar(canvas, C.MSG_CUSTOM_BASE, this.mBackgroundColor);
            drawVerticalBar(canvas, this.mLevel, this.mColor);
            return;
        }
        drawHorizontalBar(canvas, C.MSG_CUSTOM_BASE, this.mBackgroundColor);
    ...
    private void drawHorizontalBar(Canvas canvas, int i, int i2) {
        ...
        int width = ((bounds.width() - (this.mPadding * 2)) * i) / C.MSG_CUSTOM_BASE;
    ...
    private void drawVerticalBar(Canvas canvas, int i, int i2) {
        Rect bounds = getBounds();
        int height = ((bounds.height() - (this.mPadding * 2)) * i) / C.MSG_CUSTOM_BASE;
        int i3 = bounds.left + this.mPadding;
