...
public class NativeDialogParameters {
    ...
    private static Bundle create(ShareLinkContent shareLinkContent, boolean z) {
        ...
        Utility.putNonEmptyString(createBaseParameters, "TITLE", shareLinkContent.getContentTitle());
        Utility.putNonEmptyString(createBaseParameters, "DESCRIPTION", shareLinkContent.getContentDescription());
        Utility.putUri(createBaseParameters, "IMAGE", shareLinkContent.getImageUrl());
    ...
    private static Bundle create(ShareOpenGraphContent shareOpenGraphContent, JSONObject jSONObject, boolean z) {
        ...
        Utility.putNonEmptyString(createBaseParameters, "PREVIEW_PROPERTY_NAME", (String) ShareInternalUtility.getFieldNameAndNamespaceFromFullName(shareOpenGraphContent.getPreviewPropertyName()).second);
        Utility.putNonEmptyString(createBaseParameters, "ACTION_TYPE", shareOpenGraphContent.getAction().getActionType());
        Utility.putNonEmptyString(createBaseParameters, "ACTION", jSONObject.toString());
        return createBaseParameters;
    }
