...
public class NativeModuleRegistry {
    ...
    public <T extends NativeModule> T getModule(Class<T> cls) {
        ...
        if (reactModule != null) {
            ...
            return ((ModuleHolder) Assertions.assertNotNull(moduleHolder, reactModule.name() + " could not be found. Is it defined in " + cls.getName())).getModule();
        }
    ...
    public NativeModule getModule(String str) {
        return ((ModuleHolder) Assertions.assertNotNull(this.mModules.get(str), "Could not find module with name ".concat(String.valueOf(str)))).getModule();
    }
