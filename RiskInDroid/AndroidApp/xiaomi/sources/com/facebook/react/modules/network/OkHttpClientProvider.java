...
public class OkHttpClientProvider {
    ...
    public static OkHttpClient.Builder createClientBuilder() {
        ...
        OkHttpClient.Builder cookieJar = builder.connectTimeout(0, TimeUnit.MILLISECONDS).readTimeout(0, TimeUnit.MILLISECONDS).writeTimeout(0, TimeUnit.MILLISECONDS).cookieJar(new ReactCookieJarContainer());
        try {
