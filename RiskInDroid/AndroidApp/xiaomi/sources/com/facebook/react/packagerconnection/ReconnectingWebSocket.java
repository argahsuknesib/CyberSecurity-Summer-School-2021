...
public final class ReconnectingWebSocket extends WebSocketListener {
    ...
    public final void connect() {
        if (!this.mClosed) {
            ...
            builder.connectTimeout(10, TimeUnit.SECONDS).writeTimeout(10, TimeUnit.SECONDS).readTimeout(0, TimeUnit.MINUTES).build().newWebSocket(new Request.Builder().url(this.mUrl).build(), this);
            return;
        }
    ...
    private void abort(String str, Throwable th) {
        FLog.e(TAG, "Error occurred, shutting down websocket connection: ".concat(String.valueOf(str)), th);
        closeWebSocketQuietly();
    }
