...
public class ARTShapeShadowNode extends ARTVirtualNode {
    ...
    public boolean setupFillPaint(Paint paint, float f) {
        ...
        paint2.setARGB((int) f6, (int) (fArr6[1] * 255.0f), (int) (fArr6[2] * 255.0f), (int) (fArr6[3] * 255.0f));
        return true;
    }
            ...
            if (i5 != 0) {
                ...
                if (i5 == 1) {
                    ...
                    if (i5 == 3) {
                        ...
                        throw new JSApplicationIllegalArgumentException("Unrecognized drawing instruction ".concat(String.valueOf(i5)));
                    }
                    i3 = i2;
                } else {
                    int i16 = i4 + 1;
