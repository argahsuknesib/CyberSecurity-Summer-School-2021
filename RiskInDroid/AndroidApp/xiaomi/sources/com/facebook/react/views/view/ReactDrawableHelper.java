...
public class ReactDrawableHelper {
    ...
    @TargetApi(21)
    public static Drawable createDrawableFromJSDescription(ReactViewGroup reactViewGroup, ReadableMap readableMap) {
        int i;
        Drawable drawable;
        ...
        if ("ThemeAttrAndroid".equals(string)) {
            ...
            throw new JSApplicationIllegalArgumentException("Invalid type for android drawable: ".concat(String.valueOf(string)));
        } else if (Build.VERSION.SDK_INT >= 21) {
            ...
            if (!readableMap.hasKey("borderless") || readableMap.isNull("borderless") || !readableMap.getBoolean("borderless")) {
                drawable = reactViewGroup.getBorderRadiusMask();
            } else {
                drawable = null;
            }
