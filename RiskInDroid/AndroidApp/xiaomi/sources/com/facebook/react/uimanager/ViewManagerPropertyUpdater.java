...
public class ViewManagerPropertyUpdater {
    ...
    public static <T extends ViewManagerDelegate<V>, V extends View> void updateProps(ViewManagerDelegate viewManagerDelegate, View view, ReactStylesDiffMap reactStylesDiffMap) {
        ...
        while (entryIterator.hasNext()) {
            ...
            viewManagerDelegate.setProperty(view, (String) next.getKey(), next.getValue());
        }
    }

    public static <T extends ViewManager, V extends View> void updateProps(ViewManager viewManager, View view, ReactStylesDiffMap reactStylesDiffMap) {
        ViewManagerSetter findManagerSetter = findManagerSetter(viewManager.getClass());
        Iterator<Map.Entry<String, Object>> entryIterator = reactStylesDiffMap.mBackingMap.getEntryIterator();
        while (entryIterator.hasNext()) {
            Map.Entry next = entryIterator.next();
            findManagerSetter.setProperty(viewManager, view, (String) next.getKey(), next.getValue());
        }
    }
