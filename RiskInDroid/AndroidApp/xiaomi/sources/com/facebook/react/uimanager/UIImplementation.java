...
public class UIImplementation {
    ...
    public void updateRootView(int i, int i2, int i3) {
        ...
        if (node == null) {
            FLog.w("ReactNative", "Tried to update non-existent root tag: ".concat(String.valueOf(i)));
        } else {
    ...
    public void updateNodeSize(int i, int i2, int i3) {
        ReactShadowNode node = this.mShadowNodeRegistry.getNode(i);
        if (node == null) {
            FLog.w("ReactNative", "Tried to update size of non-existent tag: ".concat(String.valueOf(i)));
            return;
        }
    ...
    public void setViewLocalData(int i, Object obj) {
        ReactShadowNode node = this.mShadowNodeRegistry.getNode(i);
        if (node == null) {
            FLog.w("ReactNative", "Attempt to set local data for view with unknown tag: ".concat(String.valueOf(i)));
            return;
        }
            ...
            try {
                ...
                if (i3 > 0) {
                    ...
                    for (int i7 = 0; i7 < i3; i7++) {
                        viewAtIndexArr[i2 + i7] = new ViewAtIndex(readableArray8.getInt(i7), readableArray9.getInt(i7));
                    }
                }
                if (i4 > 0) {
                    ...
                    int i8 = 0;
                    while (i8 < i4) {
                        int i9 = readableArray10.getInt(i8);
                        ReactShadowNode reactShadowNode2 = reactShadowNode;
                        int reactTag2 = reactShadowNode2.getChildAt(i9).getReactTag();
                        int i10 = i2 + i8;
                        iArr[i10] = i9;
                        iArr2[i10] = reactTag2;
                        iArr6[i8] = reactTag2;
                ...
                int i12 = 0;
                while (i12 < viewAtIndexArr.length) {
                    ViewAtIndex viewAtIndex = viewAtIndexArr[i12];
                ...
                this.mNativeViewHierarchyOptimizer.handleManageChildren(reactShadowNode3, iArr, iArr2, viewAtIndexArr, iArr6, iArr7);
                int[] iArr8 = iArr6;
                for (int node3 : iArr8) {
    ...
    public int resolveRootTagFromReactTag(int i) {
        ...
        FLog.w("ReactNative", "Warning : attempted to resolve a non-existent react shadow node. reactTag=".concat(String.valueOf(i)));
        return 0;
    }
