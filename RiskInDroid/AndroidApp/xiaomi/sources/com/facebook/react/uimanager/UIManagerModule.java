...
public class UIManagerModule extends ReactContextBaseJavaModule implements LifecycleEventListener, OnBatchCompleteListener, UIManager {
    ...
    private static Map<String, Object> createConstants(ViewManagerResolver viewManagerResolver) {
        ...
        SystraceMessage.beginSection(0, "CreateUIManagerConstants").arg("Lazy", Boolean.TRUE).flush();
        try {
    ...
    private static Map<String, Object> createConstants(List<ViewManager> list, Map<String, Object> map, Map<String, Object> map2) {
        ReactMarker.logMarker(ReactMarkerConstants.CREATE_UI_MANAGER_MODULE_CONSTANTS_START);
        SystraceMessage.beginSection(0, "CreateUIManagerConstants").arg("Lazy", Boolean.FALSE).flush();
        try {
    ...
    public void preComputeConstantsForViewManager(List<String> list) {
        ...
        for (String next : list) {
            ...
            if (computeConstantsForViewManager != null) {
                o0o0ooo0.put(next, computeConstantsForViewManager);
            }
        }
        this.mViewManagerConstantsCacheSize = list.size();
        this.mViewManagerConstantsCache = Collections.unmodifiableMap(o0o0ooo0);
    }
    ...
    private WritableMap computeConstantsForViewManager(String str) {
        ...
        SystraceMessage.beginSection(0, "UIManagerModule.getConstantsForViewManager").arg("ViewManager", resolveViewManager.getName()).arg("Lazy", Boolean.TRUE).flush();
        try {
    ...
    public void invalidateNodeLayout(int i) {
        ...
        if (resolveShadowNode == null) {
            FLog.w("ReactNative", "Warning : attempted to dirty a non-existent react shadow node. reactTag=".concat(String.valueOf(i)));
            return;
        }
