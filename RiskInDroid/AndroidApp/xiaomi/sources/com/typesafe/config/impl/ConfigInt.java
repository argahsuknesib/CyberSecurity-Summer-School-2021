...
public final class ConfigInt extends ConfigNumber implements Serializable {
    ...
    public ConfigInt(dsi dsi, int i, String str) {
        super(dsi, str);
        this.value = i;
    }
    ...
    public final String O0000OoO() {
        ...
        return O0000OoO == null ? Integer.toString(this.value) : O0000OoO;
    }
    ...
    public final /* synthetic */ AbstractConfigValue O000000o(dsi dsi) {
        return new ConfigInt(dsi, this.value, this.originalText);
    }
