...
public class DedaoPatchWallGroup extends GroupAdapter.Group<ItemClickableAdapter.ViewHolder> {
    ...
    public DedaoPatchWallGroup(PatchWall.Block block2) {
        this.block = block2;
    }
    ...
    public void onBindViewHolder(ItemClickableAdapter.ViewHolder viewHolder, int i) {
        if (isHeader(i)) {
            ...
            ((DedaoBlockViewHolder) viewHolder).bindView(this.block);
        }
    }
}
