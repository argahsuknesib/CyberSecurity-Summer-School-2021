...
public class CollectionFragment extends BasePatchWallFragment implements ItemClickableAdapter.OnItemClickListener {
    ...
    public void loadChannelList() {
        ...
        ApiHelper.getQQCollectionsList(new ApiRequest.Listener<List<Music.Channel>>() {
            /* class com.xiaomi.mico.music.patchwall.CollectionFragment.AnonymousClass1 */
    ...
    public void createChannel() {
        MusicHelper.createChannel(getContext()).subscribe(new Action1<Long>() {
            /* class com.xiaomi.mico.music.patchwall.CollectionFragment.AnonymousClass2 */
            ...
            /* class com.xiaomi.mico.music.patchwall.CollectionFragment.AnonymousClass3 */
    ...
    class SettingGroup extends GroupAdapter.Group<ItemClickableAdapter.ViewHolder> {
        ...
        public void onBindViewHolder(ItemClickableAdapter.ViewHolder viewHolder, int i) {
            ...
            viewHolder.itemView.setOnClickListener(new View.OnClickListener() {
                /* class com.xiaomi.mico.music.patchwall.$$Lambda$CollectionFragment$SettingGroup$KxbF59JxJW8Ur2dOAUsqXZcb9zM */
        ...
        public /* synthetic */ void lambda$onBindViewHolder$0$CollectionFragment$SettingGroup(View view) {
            CollectionFragment.this.getContext().startActivity(new Intent(CollectionFragment.this.getContext(), StereoMainActivity.class));
        }
    }
    ...
    static class PersonalViewHolder extends ItemClickableAdapter.ViewHolder {
        ...
        private PersonalViewHolder(View view) {
            ...
            view.findViewById(R.id.music_personal_recent).setOnClickListener(new View.OnClickListener() {
                /* class com.xiaomi.mico.music.patchwall.$$Lambda$CollectionFragment$PersonalViewHolder$fH0w9oZLPmGjPHQdjgulsnT048 */

                public final void onClick(View view) {
                    CollectionFragment.PersonalViewHolder.this.lambda$new$0$CollectionFragment$PersonalViewHolder(view);
                }
            });
            view.findViewById(R.id.music_personal_love).setOnClickListener(new View.OnClickListener() {
                /* class com.xiaomi.mico.music.patchwall.$$Lambda$CollectionFragment$PersonalViewHolder$F03jTDswEtnsPXF5ifYWlOoyr6U */

                public final void onClick(View view) {
                    CollectionFragment.PersonalViewHolder.this.lambda$new$1$CollectionFragment$PersonalViewHolder(view);
                }
            });
            view.findViewById(R.id.music_purchased).setOnClickListener(new View.OnClickListener() {
                /* class com.xiaomi.mico.music.patchwall.$$Lambda$CollectionFragment$PersonalViewHolder$0h4Tna9MfUk0tfe_xW0xKTLaI6M */

                public final void onClick(View view) {
                    CollectionFragment.PersonalViewHolder.this.lambda$new$2$CollectionFragment$PersonalViewHolder(view);
                }
            });
    ...
    class QQmusicPlaylistSwitchViewHolder extends ItemClickableAdapter.ViewHolder {
        ...
        public QQmusicPlaylistSwitchViewHolder(View view) {
            ...
            this.buildPlayList.setOnClickListener(new View.OnClickListener() {
                /* class com.xiaomi.mico.music.patchwall.$$Lambda$CollectionFragment$QQmusicPlaylistSwitchViewHolder$tM7CzHVKFS9XEF5QVblyCPJ908A */

                public final void onClick(View view) {
                    CollectionFragment.QQmusicPlaylistSwitchViewHolder.this.lambda$new$0$CollectionFragment$QQmusicPlaylistSwitchViewHolder(view);
                }
            });
            ...
            this.collectPlayList.setOnClickListener(new View.OnClickListener() {
                /* class com.xiaomi.mico.music.patchwall.$$Lambda$CollectionFragment$QQmusicPlaylistSwitchViewHolder$3ZtC6bfaBt3TCCpq1m4iQ2aCM8 */

                public final void onClick(View view) {
                    CollectionFragment.QQmusicPlaylistSwitchViewHolder.this.lambda$new$1$CollectionFragment$QQmusicPlaylistSwitchViewHolder(view);
                }
            });
            ...
            this.viewBuildNew.setOnClickListener(new View.OnClickListener() {
                /* class com.xiaomi.mico.music.patchwall.$$Lambda$CollectionFragment$QQmusicPlaylistSwitchViewHolder$4kf6KY2VkOJ04mb0s4uanrcX0GM */

                public final void onClick(View view) {
                    CollectionFragment.QQmusicPlaylistSwitchViewHolder.this.lambda$new$2$CollectionFragment$QQmusicPlaylistSwitchViewHolder(view);
                }
            });
