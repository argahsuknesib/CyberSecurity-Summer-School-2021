...
public class CountDownListAdapter extends RecyclerView.O000000o<O000000o> {

    /* renamed from: O000000o  reason: collision with root package name */
    public List<ewr.O000000o> f3898O000000o;
    eum O00000Oo;
    ...
    public /* synthetic */ void onBindViewHolder(RecyclerView.O000OOo0 o000OOo0, final int i) {
        ...
        ewr.O000000o o000000o2 = this.f3898O000000o.get(i);
        o000000o.f3901O000000o.setText(o000000o2.O00000o);
        o000000o.itemView.setOnClickListener(new View.OnClickListener() {
            /* class com.xiaomi.shopviews.adapter.countdown.CountDownListAdapter.AnonymousClass1 */
        ...
        String str2 = "";
        if (!TextUtils.isEmpty(this.f3898O000000o.get(i).O00000oO)) {
            CustomTextView customTextView = o000000o.O00000o0;
            StringBuilder sb = new StringBuilder();
            sb.append(this.f3898O000000o.get(i).O00oOoOo ? str2 : eul.O00000oo());
            sb.append(this.f3898O000000o.get(i).O00000oO);
            customTextView.setText(sb.toString());
        }
        if (!TextUtils.isEmpty(this.f3898O000000o.get(i).O00000oo)) {
            CustomTextView customTextView2 = o000000o.O00000o;
            StringBuilder sb2 = new StringBuilder();
            if (!this.f3898O000000o.get(i).O00oOoOo) {
                str2 = eul.O00000oo();
            }
            sb2.append(str2);
            sb2.append(this.f3898O000000o.get(i).O00000oo);
        ...
        o000000o.itemView.setOnClickListener(new View.OnClickListener() {
            /* class com.xiaomi.shopviews.adapter.countdown.CountDownListAdapter.AnonymousClass2 */

            public final void onClick(View view) {
                CountDownListAdapter countDownListAdapter = CountDownListAdapter.this;
                String str = countDownListAdapter.O00000o0.O00000Oo;
                ewr.O000000o o000000o = CountDownListAdapter.this.f3898O000000o.get(i);
                if (countDownListAdapter.O00000Oo != null) {
                    countDownListAdapter.O00000Oo.O000000o(str, o000000o, "");
                }
                CountDownListAdapter countDownListAdapter2 = CountDownListAdapter.this;
                String format = String.format("place%s_click", Integer.valueOf(i + 1));
                if (countDownListAdapter2.O00000Oo != null) {
                    countDownListAdapter2.O00000Oo.O000000o(format, "flashsale");
                }
            }
        });
        String str3 = this.O00000o0.O00000Oo;
        ewr.O000000o o000000o3 = this.f3898O000000o.get(i);
    ...
    public CountDownListAdapter(Context context, ewr ewr, eum eum) {
        this(context);
        this.O00000o0 = ewr;
        this.O00000Oo = eum;
    }
    ...
    public CountDownListAdapter(Context context) {
        this.f3898O000000o = new ArrayList();
        this.O00000o = context;
    }

    public int getItemCount() {
        return this.f3898O000000o.size();
    }

    static class O000000o extends RecyclerView.O000OOo0 {

        /* renamed from: O000000o  reason: collision with root package name */
        CustomTextView f3901O000000o;
        ImageView O00000Oo;
        ...
        O000000o(View view) {
            ...
            this.f3901O000000o = (CustomTextView) view.findViewById(R.id.product_name);
