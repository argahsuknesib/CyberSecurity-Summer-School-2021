...
public interface ICallback extends IInterface {
    ...
    public static abstract class Stub extends Binder implements ICallback {
        ...
        public Stub() {
            attachInterface(this, "com.xiaomi.miot.service.ICallback");
        }
        ...
        public static ICallback asInterface(IBinder iBinder) {
            ...
            IInterface queryLocalInterface = iBinder.queryLocalInterface("com.xiaomi.miot.service.ICallback");
        ...
        public boolean onTransact(int i, Parcel parcel, Parcel parcel2, int i2) throws RemoteException {
            Bundle bundle = null;
            if (i == 1) {
                parcel.enforceInterface("com.xiaomi.miot.service.ICallback");
                if (parcel.readInt() != 0) {
                ...
                parcel2.writeString("com.xiaomi.miot.service.ICallback");
                return true;
            }
        }
        ...
        static class Proxy implements ICallback {
            ...
            public String getInterfaceDescriptor() {
                return "com.xiaomi.miot.service.ICallback";
            }
            ...
            public void onSuccess(Bundle bundle) throws RemoteException {
                ...
                try {
                    obtain.writeInterfaceToken("com.xiaomi.miot.service.ICallback");
                    if (bundle != null) {
                        obtain.writeInt(1);
