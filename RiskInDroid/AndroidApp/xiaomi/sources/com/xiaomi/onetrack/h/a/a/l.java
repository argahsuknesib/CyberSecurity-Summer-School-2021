...
public class l {
        ...
        if (context.bindService(intent, this.c, 1)) {
            try {
                ...
                try {
                    ...
                    q.a("OnePlusDeviceIDHelper", e3.getMessage());
                }
            } catch (Exception e4) {
                q.a("OnePlusDeviceIDHelper", e4.getMessage());
                context.unbindService(this.c);
            } catch (Throwable th) {
                try {
                    context.unbindService(this.c);
                } catch (Exception e5) {
                    q.a("OnePlusDeviceIDHelper", e5.getMessage());
                }
                throw th;
            }
        }
    ...
    private String a(String str, Context context) {
        ...
        return ((d.a.C0056a) this.f6155a).a(packageName, this.e, str);
    }
