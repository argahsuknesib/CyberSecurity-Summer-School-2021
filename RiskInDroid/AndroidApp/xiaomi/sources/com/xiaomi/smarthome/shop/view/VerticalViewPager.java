...
public class VerticalViewPager extends ViewGroup {
    ...
    public static final int[] f11393O000000o = {16842931};
    private static final Comparator<O00000Oo> O00000oO = new Comparator<O00000Oo>() {
        /* class com.xiaomi.smarthome.shop.view.VerticalViewPager.AnonymousClass1 */
    ...
    private static final Interpolator O00000oo = new Interpolator() {
        /* class com.xiaomi.smarthome.shop.view.VerticalViewPager.AnonymousClass2 */
    ...
    private final Runnable O000o000 = new Runnable() {
        /* class com.xiaomi.smarthome.shop.view.VerticalViewPager.AnonymousClass3 */
    ...
    /* JADX DEBUG: Failed to find minimal casts for resolve overloaded methods, cast all args instead
     ...
     arg types: [com.xiaomi.smarthome.shop.view.VerticalViewPager, int]
     candidates:
    ...
    /* JADX DEBUG: Failed to find minimal casts for resolve overloaded methods, cast all args instead
     ...
     arg types: [com.xiaomi.smarthome.shop.view.VerticalViewPager, int, java.lang.Object]
     candidates:
    ...
    /* JADX DEBUG: Failed to find minimal casts for resolve overloaded methods, cast all args instead
     method: com.xiaomi.smarthome.shop.view.VerticalViewPager.O000000o(int, boolean, boolean):void
     arg types: [int, int, int]
     candidates:
      com.xiaomi.smarthome.shop.view.VerticalViewPager.O000000o(int, float, int):void
      com.xiaomi.smarthome.shop.view.VerticalViewPager.O000000o(com.xiaomi.smarthome.shop.view.VerticalViewPager$O00000Oo, int, com.xiaomi.smarthome.shop.view.VerticalViewPager$O00000Oo):void
      com.xiaomi.smarthome.shop.view.VerticalViewPager.O000000o(int, boolean, boolean):void */
    public void setAdapter(jz jzVar) {
        ...
        if (jzVar2 != null) {
            ...
            for (int i = 0; i < this.O0000O0o.size(); i++) {
                ...
                this.O00000Oo.destroyItem((ViewGroup) this, o00000Oo.O00000Oo, o00000Oo.f11396O000000o);
            }
            this.O00000Oo.finishUpdate((ViewGroup) this);
            this.O0000O0o.clear();
            int i2 = 0;
            while (i2 < getChildCount()) {
                if (!((LayoutParams) getChildAt(i2).getLayoutParams()).f11395O000000o) {
                    removeViewAt(i2);
                    i2--;
                }
                i2++;
    ...
    private O00000Oo O00000Oo(int i, int i2) {
        ...
        o00000Oo.O00000Oo = i;
        o00000Oo.f11396O000000o = this.O00000Oo.instantiateItem((ViewGroup) this, i);
    ...
    public final void O000000o() {
        ...
        while (i2 < this.O0000O0o.size()) {
            ...
            int itemPosition = this.O00000Oo.getItemPosition(o00000Oo.f11396O000000o);
            if (itemPosition != -1) {
                if (itemPosition == -2) {
        ...
        if (z) {
            ...
            for (int i3 = 0; i3 < childCount; i3++) {
                ...
                if (!layoutParams.f11395O000000o) {
    ...
    private void O00000Oo(int i) {
        ...
        if (this.O00000Oo == null) {
            ...
            if (count == this.O00000o) {
                    ...
                    for (int i10 = this.O00000o0 - 1; i10 >= 0; i10--) {
                        if (f3 >= f && i10 < max) {
                            ...
                            if (i10 == o00000Oo4.O00000Oo && !o00000Oo4.O00000o0) {
                                ...
                                this.O00000Oo.destroyItem((ViewGroup) this, i10, o00000Oo4.f11396O000000o);
                                i8--;
                                i9--;
                                if (i8 >= 0) {
                        ...
                        while (true) {
                            ...
                            if (f4 >= f2 && i12 > min) {
                                if (o00000Oo5 == null) {
                                    ...
                                    this.O00000Oo.destroyItem((ViewGroup) this, i12, o00000Oo5.f11396O000000o);
                ...
                this.O00000Oo.setPrimaryItem((ViewGroup) this, this.O00000o0, o00000Oo2 != null ? o00000Oo2.f11396O000000o : null);
                this.O00000Oo.finishUpdate((ViewGroup) this);
                int childCount = getChildCount();
    ...
    public static class SavedState extends View.BaseSavedState {
        public static final Parcelable.Creator<SavedState> CREATOR = aq.O000000o(new ar<SavedState>() {
            /* class com.xiaomi.smarthome.shop.view.VerticalViewPager.SavedState.AnonymousClass1 */
        ...
        public void writeToParcel(Parcel parcel, int i) {
            ...
            parcel.writeInt(this.f11399O000000o);
            parcel.writeParcelable(this.O00000Oo, i);
        }

        public String toString() {
            return "FragmentPager.SavedState{" + Integer.toHexString(System.identityHashCode(this)) + " position=" + this.f11399O000000o + "}";
        }

        SavedState(Parcel parcel, ClassLoader classLoader) {
            super(parcel);
            classLoader = classLoader == null ? getClass().getClassLoader() : classLoader;
            this.f11399O000000o = parcel.readInt();
    ...
    public Parcelable onSaveInstanceState() {
        ...
        savedState.f11399O000000o = this.O00000o0;
        jz jzVar = this.O00000Oo;
        if (jzVar != null) {
    ...
    public void onRestoreInstanceState(Parcelable parcelable) {
        ...
        if (jzVar != null) {
            ...
            O000000o(savedState.f11399O000000o, false, true);
            return;
        }
        this.O0000Oo = savedState.f11399O000000o;
    ...
    public void addView(View view, int i, ViewGroup.LayoutParams layoutParams) {
        ...
        layoutParams2.f11395O000000o |= view instanceof O000000o;
        if (!this.O0000oo) {
            super.addView(view, i, layoutParams);
        } else if (layoutParams2 == null || !layoutParams2.f11395O000000o) {
    ...
    private O00000Oo O000000o(View view) {
        for (int i = 0; i < this.O0000O0o.size(); i++) {
            O00000Oo o00000Oo = this.O0000O0o.get(i);
            if (this.O00000Oo.isViewFromObject(view, o00000Oo.f11396O000000o)) {
                return o00000Oo;
            }
        }
        return null;
    ...
    public void onMeasure(int i, int i2) {
        ...
        while (true) {
            ...
            if (!(childAt.getVisibility() == 8 || (layoutParams2 = (LayoutParams) childAt.getLayoutParams()) == null || !layoutParams2.f11395O000000o)) {
        ...
        for (int i12 = 0; i12 < childCount2; i12++) {
            ...
            if (childAt2.getVisibility() != 8 && ((layoutParams = (LayoutParams) childAt2.getLayoutParams()) == null || !layoutParams.f11395O000000o)) {
    ...
    /* JADX DEBUG: Failed to find minimal casts for resolve overloaded methods, cast all args instead
     method: com.xiaomi.smarthome.shop.view.VerticalViewPager.O000000o(int, boolean, int, boolean):void
     arg types: [int, int, int, int]
     candidates:
      com.xiaomi.smarthome.shop.view.VerticalViewPager.O000000o(int, int, int, int):void
      com.xiaomi.smarthome.shop.view.VerticalViewPager.O000000o(int, boolean, boolean, int):void
      com.xiaomi.smarthome.shop.view.VerticalViewPager.O000000o(int, boolean, int, boolean):void */
    /* access modifiers changed from: protected */
    public void onLayout(boolean z, int i, int i2, int i3, int i4) {
        ...
        for (int i17 = 0; i17 < childCount; i17++) {
            ...
            if (childAt2.getVisibility() != 8) {
                ...
                if (!layoutParams2.f11395O000000o && (O000000o2 = O000000o(childAt2)) != null) {
                    float f = (float) i16;
    ...
    private void O000000o(int i, float f, int i2) {
        ...
        if (this.O000OoOo != null) {
            ...
            for (int i10 = 0; i10 < childCount2; i10++) {
                ...
                if (!((LayoutParams) childAt2.getLayoutParams()).f11395O000000o) {
    ...
    /* JADX DEBUG: Failed to find minimal casts for resolve overloaded methods, cast all args instead
     ...
     candidates:
      ...
      com.xiaomi.smarthome.shop.view.VerticalViewPager.O000000o(int, boolean, int, boolean):void */
    /* JADX DEBUG: Failed to find minimal casts for resolve overloaded methods, cast all args instead
     method: com.xiaomi.smarthome.shop.view.VerticalViewPager.O000000o(int, boolean, boolean, int):void
     arg types: [int, int, int, int]
     candidates:
      com.xiaomi.smarthome.shop.view.VerticalViewPager.O000000o(int, int, int, int):void
      com.xiaomi.smarthome.shop.view.VerticalViewPager.O000000o(int, boolean, int, boolean):void
    ...
    public static class LayoutParams extends ViewGroup.LayoutParams {
        ...
        public LayoutParams(Context context, AttributeSet attributeSet) {
            super(context, attributeSet);
            TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, VerticalViewPager.f11393O000000o);
    ...
    static class O0000OOo implements Comparator<View> {
        ...
        public final /* synthetic */ int compare(Object obj, Object obj2) {
            ...
            if (layoutParams.f11395O000000o != layoutParams2.f11395O000000o) {
                return layoutParams.f11395O000000o ? 1 : -1;
            }
