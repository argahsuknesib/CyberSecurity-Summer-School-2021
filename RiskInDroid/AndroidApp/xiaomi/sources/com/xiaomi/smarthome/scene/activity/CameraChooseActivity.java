...
public class CameraChooseActivity extends CommonChooseActivity {
    public void onCreate(Bundle bundle) {
        ...
        if (this.O00000Oo != null) {
            this.O00000Oo.setText((int) R.string.mi_camera);
        }
        if (this.O00000o0 != null) {
            this.O00000o0.O000000o(getString(R.string.choose_home_yi_camera));
        }
    }
    ...
    public final List<SceneItemChooseFragment.ItemData> O000000o() {
        ...
        for (Map.Entry<String, Device> value : fno.O000000o().O0000O0o().entrySet()) {
            ...
            if (device.isOwner() && DeviceFactory.O0000O0o(device.model, "yunyi.camera.v1")) {
