...
public class BleStandardAuthRegisterConnector$8 implements IBleResponse {
    ...
    public BleStandardAuthRegisterConnector$8(fiw fiw) {
        this.this$0 = fiw;
    }

    public void onResponse(int i, Bundle bundle) throws RemoteException {
        fte.O00000Oo("BleStandardAuthRegisterConnector sendAppPublicKey onResponse: " + gmc.O000000o(i));
        if (i == 0) {
