...
public interface IServerCallback extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IServerCallback {
        ...
        public Stub() {
            attachInterface(this, "com.xiaomi.smarthome.core.server.IServerCallback");
        }
        ...
        public static IServerCallback asInterface(IBinder iBinder) {
            ...
            IInterface queryLocalInterface = iBinder.queryLocalInterface("com.xiaomi.smarthome.core.server.IServerCallback");
        ...
        public boolean onTransact(int i, Parcel parcel, Parcel parcel2, int i2) throws RemoteException {
            Bundle bundle = null;
            if (i == 1) {
                parcel.enforceInterface("com.xiaomi.smarthome.core.server.IServerCallback");
                if (parcel.readInt() != 0) {
                ...
                parcel2.writeString("com.xiaomi.smarthome.core.server.IServerCallback");
                return true;
            }
        }

        static class Proxy implements IServerCallback {
            private IBinder mRemote;

            public String getInterfaceDescriptor() {
                return "com.xiaomi.smarthome.core.server.IServerCallback";
            }
            ...
            public void onSuccess(Bundle bundle) throws RemoteException {
                ...
                try {
                    obtain.writeInterfaceToken("com.xiaomi.smarthome.core.server.IServerCallback");
                    if (bundle != null) {
                        obtain.writeInt(1);
