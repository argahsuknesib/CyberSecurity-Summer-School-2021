...
public class BleStandardAuthLoginConnector$4 implements IBleResponse {
    ...
    public BleStandardAuthLoginConnector$4(fiu fiu) {
        this.this$0 = fiu;
    }

    public void onResponse(int i, Bundle bundle) throws RemoteException {
        fte.O00000Oo("BleStandardAuthLoginConnector sendAppPublicKey onResponse: " + gmc.O000000o(i));
        if (i == 0) {
