...
public class SVBar extends View {
    ...
    private void O000000o(AttributeSet attributeSet, int i) {
        ...
        this.f9294O000000o = obtainStyledAttributes.getDimensionPixelSize(4, resources.getDimensionPixelSize(R.dimen.bar_thickness));
        ...
        this.O00000oo = (this.O00000Oo / 2) + this.O00000oO;
        ...
        this.O0000o0O = 1.0f / (((float) i2) / 2.0f);
        this.O0000o0o = (((float) i2) / 2.0f) / 1.0f;
    }
    ...
    public void onSizeChanged(int i, int i2, int i3, int i4) {
        ...
        if (!isInEditMode()) {
            this.O0000OoO = new LinearGradient((float) this.O00000oO, 0.0f, (float) i6, (float) i5, new int[]{-1, Color.HSVToColor(this.O0000o0), -16777216}, (float[]) null, Shader.TileMode.CLAMP);
        } else {
            this.O0000OoO = new LinearGradient((float) this.O00000oO, 0.0f, (float) i6, (float) i5, new int[]{-1, -8257792, -16777216}, (float[]) null, Shader.TileMode.CLAMP);
            Color.colorToHSV(-8257792, this.O0000o0);
        }
        this.O0000O0o.setShader(this.O0000OoO);
        int i12 = this.O00000Oo;
        this.O0000o0O = 1.0f / (((float) i12) / 2.0f);
        this.O0000o0o = (((float) i12) / 2.0f) / 1.0f;
        float[] fArr = new float[3];
        Color.colorToHSV(this.O0000o00, fArr);
        if (fArr[1] < fArr[2]) {
            this.O00000oo = Math.round((this.O0000o0o * fArr[1]) + ((float) this.O00000oO));
        } else {
            this.O00000oo = Math.round((this.O0000o0o * (1.0f - fArr[2])) + ((float) this.O00000oO) + ((float) (this.O00000Oo / 2)));
        }
        if (isInEditMode()) {
            this.O00000oo = (this.O00000Oo / 2) + this.O00000oO;
        }
    ...
    public boolean onTouchEvent(MotionEvent motionEvent) {
        ...
        if (action == 0) {
            this.O0000Ooo = true;
            int i = this.O00000oO;
            if (f >= ((float) i) && f <= ((float) (i + this.O00000Oo))) {
            ...
            this.O0000Ooo = false;
        } else if (action == 2 && this.O0000Ooo) {
            int i2 = this.O00000oO;
            if (f < ((float) i2) || f > ((float) (i2 + this.O00000Oo))) {
                ...
                if (f < ((float) i3)) {
                    ...
                    if (colorPicker != null) {
                        colorPicker.changeOpacityBarColor(this.O0000o00);
                    }
                    invalidate();
                } else {
                    ...
                    if (f > ((float) (i3 + i4))) {
                        this.O00000oo = i3 + i4;
                        this.O0000o00 = -16777216;
                        this.O0000OOo.setColor(this.O0000o00);
                        ColorPicker colorPicker2 = this.O0000o;
                        if (colorPicker2 != null) {
                            colorPicker2.changeOpacityBarColor(this.O0000o00);
                        }
                        invalidate();
                    }
                }
                ...
                if (colorPicker3 != null) {
                    colorPicker3.changeOpacityBarColor(this.O0000o00);
                }
                invalidate();
            }
        }
    ...
    public void setSaturation(float f) {
        this.O00000oo = Math.round((this.O0000o0o * f) + ((float) this.O00000oO));
    ...
    public void setValue(float f) {
        this.O00000oo = Math.round((this.O0000o0o * (1.0f - f)) + ((float) this.O00000oO) + ((float) (this.O00000Oo / 2)));
        O000000o(this.O00000oo);
        this.O0000OOo.setColor(this.O0000o00);
        ColorPicker colorPicker = this.O0000o;
        if (colorPicker != null) {
    ...
    public void setColor(int i) {
        ...
        if (this.O0000oO0) {
            ...
            i2 = this.f9294O000000o;
        } else {
            i3 = this.f9294O000000o;
            i2 = this.O00000Oo + this.O00000oO;
        }
        Color.colorToHSV(i, this.O0000o0);
        this.O0000OoO = new LinearGradient((float) this.O00000oO, 0.0f, (float) i3, (float) i2, new int[]{-1, i, -16777216}, (float[]) null, Shader.TileMode.CLAMP);
        this.O0000O0o.setShader(this.O0000OoO);
        O000000o(this.O00000oo);
        this.O0000OOo.setColor(this.O0000o00);
        ColorPicker colorPicker = this.O0000o;
        if (colorPicker != null && colorPicker.hasOpacityBar()) {
    ...
    private void O000000o(int i) {
        ...
        int i3 = this.O00000Oo;
        if (i2 > i3 / 2 && i2 < i3) {
            this.O0000o00 = Color.HSVToColor(new float[]{this.O0000o0[0], 1.0f, 1.0f - (this.O0000o0O * ((float) (i2 - (i3 / 2))))});
        } else if (i2 <= 0 || i2 >= this.O00000Oo) {
            int i4 = this.O00000Oo;
            if (i2 == i4 / 2) {
                this.O0000o00 = Color.HSVToColor(new float[]{this.O0000o0[0], 1.0f, 1.0f});
            } else if (i2 <= 0) {
                this.O0000o00 = -1;
            } else if (i2 >= i4) {
                this.O0000o00 = -16777216;
