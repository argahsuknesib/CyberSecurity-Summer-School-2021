...
public class SmMainSencePtrHeader extends FrameLayout implements PtrUIHandler {
    ...
    private void O000000o(AttributeSet attributeSet) {
        ...
        this.f9254O000000o = LayoutInflater.from(getContext()).inflate((int) R.layout.sm_widget_pull_header, (ViewGroup) null);
        this.O00000o0 = (TextView) this.f9254O000000o.findViewById(R.id.pull_header_txt);
        this.O00000o = (LottieAnimationView) this.f9254O000000o.findViewById(R.id.pull_animation);
        addView(this.f9254O000000o);
        O000000o();
    }

    private void O000000o() {
        View view = this.f9254O000000o;
        if (view != null) {
    ...
    public void onUIPositionChange(PtrFrameLayout ptrFrameLayout, boolean z, byte b, PtrIndicator ptrIndicator) {
        ...
        if (currentPosY > 180) {
            this.f9254O000000o.setAlpha(Math.min((((float) currentPosY) - 180.0f) / 75.0f, 1.0f));
        } else {
            this.f9254O000000o.setAlpha(0.0f);
        }
    }
}
