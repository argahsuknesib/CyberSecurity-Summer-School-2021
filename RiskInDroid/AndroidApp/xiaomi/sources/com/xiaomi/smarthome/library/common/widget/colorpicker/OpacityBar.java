...
public class OpacityBar extends View {
    ...
    private float O0000o0o;
    private ColorPicker O0000oO = null;
    ...
    private void O000000o(AttributeSet attributeSet, int i) {
        ...
        this.f9293O000000o = obtainStyledAttributes.getDimensionPixelSize(4, resources.getDimensionPixelSize(R.dimen.bar_thickness));
        ...
        this.O0000o0O = 255.0f / ((float) i2);
        this.O0000o0o = ((float) i2) / 255.0f;
    }
    ...
    public void onSizeChanged(int i, int i2, int i3, int i4) {
        ...
        if (!isInEditMode()) {
            this.O0000OoO = new LinearGradient((float) this.O00000oO, 0.0f, (float) i6, (float) i5, new int[]{Color.HSVToColor(0, this.O0000o0), Color.HSVToColor(255, this.O0000o0)}, (float[]) null, Shader.TileMode.CLAMP);
        } else {
            this.O0000OoO = new LinearGradient((float) this.O00000oO, 0.0f, (float) i6, (float) i5, new int[]{8519424, -8257792}, (float[]) null, Shader.TileMode.CLAMP);
            Color.colorToHSV(-8257792, this.O0000o0);
        }
        this.O0000O0o.setShader(this.O0000OoO);
        int i12 = this.O00000Oo;
        this.O0000o0O = 255.0f / ((float) i12);
        this.O0000o0o = ((float) i12) / 255.0f;
        Color.colorToHSV(this.O0000o00, new float[3]);
        if (!isInEditMode()) {
            this.O00000oo = Math.round((this.O0000o0o * ((float) Color.alpha(this.O0000o00))) + ((float) this.O00000oO));
        } else {
            this.O00000oo = this.O00000Oo + this.O00000oO;
        }
    }
    ...
    public boolean onTouchEvent(MotionEvent motionEvent) {
        ...
        if (action == 0) {
            ...
            if (!(this.O0000o == null || this.O0000oO0 == getOpacity())) {
                getOpacity();
                this.O0000oO0 = getOpacity();
            }
        }
        return true;
    }
    ...
    public void setColor(int i) {
        ...
        if (this.O0000oOO) {
            ...
            i2 = this.f9293O000000o;
        } else {
            i3 = this.f9293O000000o;
            i2 = this.O00000Oo + this.O00000oO;
        }
        Color.colorToHSV(i, this.O0000o0);
        this.O0000OoO = new LinearGradient((float) this.O00000oO, 0.0f, (float) i3, (float) i2, new int[]{Color.HSVToColor(0, this.O0000o0), i}, (float[]) null, Shader.TileMode.CLAMP);
        this.O0000O0o.setShader(this.O0000OoO);
    ...
    public void setOpacity(int i) {
        this.O00000oo = Math.round(this.O0000o0o * ((float) i)) + this.O00000oO;
        O000000o(this.O00000oo);
        this.O0000OOo.setColor(this.O0000o00);
        invalidate();
    }
    ...
    public int getOpacity() {
        int round = Math.round(this.O0000o0O * ((float) (this.O00000oo - this.O00000oO)));
        if (round < 5) {
            return 0;
        }
        if (round > 250) {
    ...
    private void O000000o(int i) {
        ...
        this.O0000o00 = Color.HSVToColor(Math.round(this.O0000o0O * ((float) i2)), this.O0000o0);
        if (Color.alpha(this.O0000o00) > 250) {
            this.O0000o00 = Color.HSVToColor(this.O0000o0);
        } else if (Color.alpha(this.O0000o00) < 5) {
            this.O0000o00 = 0;
        }
    }
