...
public class RecyclerViewRefreshLayout extends ViewGroup {
    ...
    public RecyclerViewRefreshLayout(Context context, AttributeSet attributeSet) {
        ...
        this.mRefreshListener = new Animation.AnimationListener() {
            /* class com.xiaomi.smarthome.miio.camera.cloudstorage.views.RecyclerViewRefreshLayout.AnonymousClass1 */
            ...
            /* JADX DEBUG: Failed to find minimal casts for resolve overloaded methods, cast all args instead
             ...
             arg types: [com.xiaomi.smarthome.miio.camera.cloudstorage.views.RecyclerViewRefreshLayout$CircleProgressView, int]
             candidates:
        ...
        this.mAnimateToCorrectPosition = new Animation() {
            /* class com.xiaomi.smarthome.miio.camera.cloudstorage.views.RecyclerViewRefreshLayout.AnonymousClass8 */
        ...
        this.mAnimateToStartPosition = new Animation() {
            /* class com.xiaomi.smarthome.miio.camera.cloudstorage.views.RecyclerViewRefreshLayout.AnonymousClass9 */
    ...
    private void startScaleUpAnimation(Animation.AnimationListener animationListener) {
        ...
        this.mScaleAnimation = new Animation() {
            /* class com.xiaomi.smarthome.miio.camera.cloudstorage.views.RecyclerViewRefreshLayout.AnonymousClass2 */
    ...
    public void startScaleDownAnimation(Animation.AnimationListener animationListener) {
        this.mScaleDownAnimation = new Animation() {
            /* class com.xiaomi.smarthome.miio.camera.cloudstorage.views.RecyclerViewRefreshLayout.AnonymousClass3 */
    ...
    /* JADX DEBUG: Failed to find minimal casts for resolve overloaded methods, cast all args instead
     ...
     arg types: [com.xiaomi.smarthome.miio.camera.cloudstorage.views.RecyclerViewRefreshLayout$HeadViewContainer, int]
     candidates:
            ...
            if ((motionEvent.getY(motionEvent.findPointerIndex(i3)) - this.mInitialMotionY) * 0.5f > this.mTotalDragDistance) {
                ...
                if (!this.mScale) {
                    r12 = new Animation.AnimationListener() {
                        /* class com.xiaomi.smarthome.miio.camera.cloudstorage.views.RecyclerViewRefreshLayout.AnonymousClass4 */
    ...
    private void animatorFooterToBottom(int i, final int i2) {
        ...
        ofInt.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
            /* class com.xiaomi.smarthome.miio.camera.cloudstorage.views.RecyclerViewRefreshLayout.AnonymousClass5 */
        ...
        ofInt.addListener(new AnimatorListenerAdapter() {
            /* class com.xiaomi.smarthome.miio.camera.cloudstorage.views.RecyclerViewRefreshLayout.AnonymousClass6 */
    ...
    public void resetTargetLayoutDelay(int i) {
        new Handler().postDelayed(new Runnable() {
            /* class com.xiaomi.smarthome.miio.camera.cloudstorage.views.RecyclerViewRefreshLayout.AnonymousClass7 */
    ...
    private void startScaleDownReturnToStartAnimation(int i, Animation.AnimationListener animationListener) {
        ...
        this.mScaleDownToStartAnimation = new Animation() {
            /* class com.xiaomi.smarthome.miio.camera.cloudstorage.views.RecyclerViewRefreshLayout.AnonymousClass10 */
