...
public class AlarmDirectionTimeV2Activity extends CameraBaseActivity implements View.OnClickListener {
    ...
    private void customChoice() {
        ...
        hourNumberPicker.setOnValueChangedListener(new NumberPicker.O0000Oo0() {
            /* class com.xiaomi.smarthome.camera.activity.alarm.AlarmDirectionTimeV2Activity.AnonymousClass1 */
        ...
        hourNumberPicker2.setOnValueChangedListener(new NumberPicker.O0000Oo0() {
            /* class com.xiaomi.smarthome.camera.activity.alarm.AlarmDirectionTimeV2Activity.AnonymousClass2 */
        ...
        button.setOnClickListener(new View.OnClickListener() {
            /* class com.xiaomi.smarthome.camera.activity.alarm.AlarmDirectionTimeV2Activity.AnonymousClass3 */
    ...
    public void onBackPressed() {
        if (!TextUtils.equals(this.startTime, this.startTimeBefore) || !TextUtils.equals(this.endTime, this.endTimeBefore)) {
