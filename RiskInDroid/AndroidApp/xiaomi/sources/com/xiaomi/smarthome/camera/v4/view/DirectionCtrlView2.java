...
public class DirectionCtrlView2 extends DirectionCtrlView {
    public DirectionCtrlView2(Context context) {
        super(context);
        init(null, 0);
    }

    public DirectionCtrlView2(Context context, float f) {
        super(context);
        this.mScale = f;
        init(null, 0);
    }

    public DirectionCtrlView2(Context context, boolean z, float f) {
        super(context);
        this.mScale = f;
    ...
    public DirectionCtrlView2(Context context, AttributeSet attributeSet) {
        super(context, attributeSet);
        init(attributeSet, 0);
    }

    public DirectionCtrlView2(Context context, AttributeSet attributeSet, int i) {
