...
public class AlarmDayAdapterV2 extends RecyclerView.O000000o<BaseViewHolder> {
    ...
    public BaseViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        if (i == this.TYPE_TITLE) {
            return new TitleViewHolder(LayoutInflater.from(viewGroup.getContext()).inflate((int) R.layout.alarm_day_title, viewGroup, false));
        }
        return new DataViewHolder(LayoutInflater.from(viewGroup.getContext()).inflate((int) R.layout.alarm_day_item, viewGroup, false));
    }
    ...
    public void onAttachedToRecyclerView(RecyclerView recyclerView) {
        ...
        if (layoutManager instanceof GridLayoutManager) {
            ...
            gridLayoutManager.setSpanSizeLookup(new GridLayoutManager.O00000Oo() {
                /* class com.xiaomi.smarthome.camera.v4.activity.alarm.AlarmDayAdapterV2.AnonymousClass1 */
    ...
    class DataViewHolder extends BaseViewHolder {
        ...
        DataViewHolder(View view) {
            super(view);
            view.setOnClickListener(new View.OnClickListener(AlarmDayAdapterV2.this) {
                /* class com.xiaomi.smarthome.camera.v4.activity.alarm.AlarmDayAdapterV2.DataViewHolder.AnonymousClass1 */

                public void onClick(View view) {
                    if (AlarmDayAdapterV2.this.mClickCallBak != null) {
                        AlarmDayAdapterV2.this.mClickCallBak.onRecyclerClick(view);
                    }
                }
            });
            view.setOnLongClickListener(new View.OnLongClickListener(AlarmDayAdapterV2.this) {
                /* class com.xiaomi.smarthome.camera.v4.activity.alarm.AlarmDayAdapterV2.DataViewHolder.AnonymousClass2 */

                public boolean onLongClick(View view) {
                    if (AlarmDayAdapterV2.this.mClickCallBak == null) {
                        return true;
                    }
                    AlarmDayAdapterV2.this.mClickCallBak.onRecyclerLongClick(view);
                    return true;
                }
            });
        ...
        public void bindView(int i) {
            ...
            if (i >= 0 && i <= AlarmDayAdapterV2.this.getItemCount()) {
                ...
                if (alarmDayBean.item != null) {
                    ...
                    if (alarmDayBean.item.O0000Ooo) {
                        str = alarmDayBean.item.O0000oO;
                    } else {
                        str = alarmDayBean.item.O000000o();
                    }
                    if (cnx.O000000o().O00000Oo()) {
                        cnx.O000000o().O000000o(str, this.imageView, AlarmDayAdapterV2.this.mOptions);
                    }
