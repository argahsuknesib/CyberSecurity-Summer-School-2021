...
public class SDCardStatusActivity extends CameraBaseActivity implements View.OnClickListener {
    ...
    public void doCreate(Bundle bundle) {
        ...
        setContentView((int) R.layout.activity_sdcard_status);
        initView();
    }
    ...
    public void loadData(boolean z) {
        ...
        this.mCameraDevice.O0000OOo().O000000o(new Callback<SDCardInfo>() {
            /* class com.xiaomi.smarthome.camera.v4.activity.setting.SDCardStatusActivity.AnonymousClass1 */
                ...
                if (!SDCardStatusActivity.this.isFinishing()) {
                    ...
                    if (sDCardInfo.O00000Oo < 100000) {
                        ...
                        SDCardStatusActivity.this.mlAlertDialog.O000000o((int) R.string.sdcard_tip_ok, new DialogInterface.OnClickListener() {
                            /* class com.xiaomi.smarthome.camera.v4.activity.setting.SDCardStatusActivity.AnonymousClass1.AnonymousClass1 */
                ...
                if (!SDCardStatusActivity.this.isFinishing()) {
                    ...
                    if (i == -2003) {
                        ...
                        SDCardStatusActivity.this.mlAlertDialog.O000000o((int) R.string.ok_button, new DialogInterface.OnClickListener() {
                            /* class com.xiaomi.smarthome.camera.v4.activity.setting.SDCardStatusActivity.AnonymousClass1.AnonymousClass2 */
                        ...
                        TextView textView = sDCardStatusActivity.mStatusView;
                        SDCardStatusActivity sDCardStatusActivity2 = SDCardStatusActivity.this;
                        textView.setText(sDCardStatusActivity2.getString(R.string.sdcard_status, new Object[]{Util.getSdCardStatus(sDCardStatusActivity2.getResources(), 3)}));
                    } else if (i == -2005) {
                        SDCardStatusActivity.this.mlAlertDialog.O000000o((int) R.string.sdcard_tip);
                        ...
                        sDCardStatusActivity3.mStatus = 5;
                        TextView textView2 = sDCardStatusActivity3.mStatusView;
                        SDCardStatusActivity sDCardStatusActivity4 = SDCardStatusActivity.this;
                        textView2.setText(sDCardStatusActivity4.getString(R.string.sdcard_status, new Object[]{Util.getSdCardStatus(sDCardStatusActivity4.getResources(), 5)}));
                    } else {
                        if (i == -1) {
                        ...
                        SDCardStatusActivity.this.mlAlertDialog.O000000o((int) R.string.common_retry, new DialogInterface.OnClickListener() {
                            /* class com.xiaomi.smarthome.camera.v4.activity.setting.SDCardStatusActivity.AnonymousClass1.AnonymousClass3 */
    ...
    public void onClick(View view) {
        ...
        if (id == R.id.sdcard_format) {
            ...
            this.mlAlertDialog.O000000o((int) R.string.ok_button, new DialogInterface.OnClickListener() {
                /* class com.xiaomi.smarthome.camera.v4.activity.setting.SDCardStatusActivity.AnonymousClass2 */
                ...
                public void onClick(DialogInterface dialogInterface, int i) {
                    ...
                    if (SDCardStatusActivity.this.mCameraDevice.O00000o()) {
                        SDCardStatusActivity.this.mCameraDevice.O0000Oo0().O00000o(new Callback<Object>() {
                            /* class com.xiaomi.smarthome.camera.v4.activity.setting.SDCardStatusActivity.AnonymousClass2.AnonymousClass1 */
                        ...
                        SDCardStatusActivity.this.mCameraDevice.O0000OOo().O00000o(new Callback<Object>() {
                            /* class com.xiaomi.smarthome.camera.v4.activity.setting.SDCardStatusActivity.AnonymousClass2.AnonymousClass2 */
    ...
    public void parseInfo(SDCardInfo sDCardInfo) {
        ...
        this.mTotalView.setText(getString(R.string.sdcard_size, new Object[]{me.O000000o(sDCardInfo.f5242O000000o)}));
    ...
    /* JADX DEBUG: Failed to find minimal casts for resolve overloaded methods, cast all args instead
     ...
     arg types: [com.xiaomi.smarthome.camera.v4.activity.setting.SDCardStatusActivity$3, int]
     candidates:
    ...
    private void checkFormat() {
        ...
        this.mCameraDevice.O0000OOo().O000000o((Callback<SDCardInfo>) new Callback<SDCardInfo>() {
            /* class com.xiaomi.smarthome.camera.v4.activity.setting.SDCardStatusActivity.AnonymousClass3 */
    ...
    public void doFormat() {
        ...
        this.mlAlertDialog.O000000o((int) R.string.ok_button, new DialogInterface.OnClickListener() {
            /* class com.xiaomi.smarthome.camera.v4.activity.setting.SDCardStatusActivity.AnonymousClass4 */
            ...
            public void onClick(DialogInterface dialogInterface, int i) {
                ...
                if (SDCardStatusActivity.this.mCameraDevice.O00000o()) {
                    SDCardStatusActivity.this.mCameraDevice.O0000Oo0().O00000o0(new Callback<Object>() {
                        /* class com.xiaomi.smarthome.camera.v4.activity.setting.SDCardStatusActivity.AnonymousClass4.AnonymousClass1 */
                    ...
                    SDCardStatusActivity.this.mCameraDevice.O0000OOo().O00000o0(new Callback<Object>() {
                        /* class com.xiaomi.smarthome.camera.v4.activity.setting.SDCardStatusActivity.AnonymousClass4.AnonymousClass2 */
    ...
    public void initProgressDlg() {
        if (this.progressDialog == null) {
            ...
            this.progressDialog.setOnCancelListener(new DialogInterface.OnCancelListener() {
                /* class com.xiaomi.smarthome.camera.v4.activity.setting.SDCardStatusActivity.AnonymousClass5 */
