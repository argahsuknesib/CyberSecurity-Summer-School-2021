...
public abstract class bd {
    ...
    public static String C = "ext_clicked_button";
    public static String D = "ext_notify_type";
    public static String E = "ext_session";
    public static String F = "sig";
    public static String G = "ext_notify_title";
    public static String H = "ext_notify_description";
    public static String I = "ext_messenger";
    public static String J = "title";
    public static String K = "description";
    public static String L = "notifyId";
    public static String M = "dump";

    /* renamed from: a  reason: collision with root package name */
    public static String f6521a = "1";
