...
public class bl {
    ...
    public static String a(String str) {
        ...
        try {
            ...
            instance.init(1, f6527a);
            return Base64.encodeToString(a(instance, 1, str.getBytes("UTF-8"), f6527a.getModulus().bitLength()), 2);
        } catch (Throwable unused) {
            return null;
        }
    }
