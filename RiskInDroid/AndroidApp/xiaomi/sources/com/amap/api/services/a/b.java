...
public class b {
    ...
    private static int f3294a = 4;

    /* JADX DEBUG: Failed to find minimal casts for resolve overloaded methods, cast all args instead
     method: com.amap.api.services.a.b.a(int[], boolean):byte[]
     arg types: [int[], int]
     candidates:
      com.amap.api.services.a.b.a(byte[], byte[]):byte[]
      com.amap.api.services.a.b.a(byte[], boolean):int[]
      com.amap.api.services.a.b.a(int[], int[]):int[]
      com.amap.api.services.a.b.a(int[], boolean):byte[] */
    /* JADX DEBUG: Failed to find minimal casts for resolve overloaded methods, cast all args instead
     method: com.amap.api.services.a.b.a(byte[], boolean):int[]
     arg types: [byte[], int]
     candidates:
      com.amap.api.services.a.b.a(byte[], byte[]):byte[]
      com.amap.api.services.a.b.a(int[], boolean):byte[]
