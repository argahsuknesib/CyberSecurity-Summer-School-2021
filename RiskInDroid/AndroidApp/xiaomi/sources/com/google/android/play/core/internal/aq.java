...
public final class aq {
                    ...
                    if (read2 == -1) {
                        ...
                        switch (read2) {
                            ...
                            case 249:
                                ...
                                if (read2 != -1) {
                                    a(bArr, bvVar, outputStream, readUnsignedShort, read2, j3);
                                    break;
                                } else {
                            ...
                            case 250:
                                ...
                                read2 = dataInputStream.readUnsignedShort();
                                a(bArr, bvVar, outputStream, readUnsignedShort2, read2, j3);
                                break;
                            case 251:
                                long readUnsignedShort3 = (long) dataInputStream.readUnsignedShort();
                                read2 = dataInputStream.readInt();
                                a(bArr, bvVar, outputStream, readUnsignedShort3, read2, j3);
                                break;
                            case 252:
                                long readInt2 = (long) dataInputStream.readInt();
                                read2 = dataInputStream.read();
                                if (read2 != -1) {
                                    a(bArr, bvVar, outputStream, readInt2, read2, j3);
                                    break;
                                } else {
                                    throw new IOException("Unexpected end of patch");
                                }
                            case 253:
                                ...
                                read2 = dataInputStream.readUnsignedShort();
                                a(bArr, bvVar, outputStream, readInt3, read2, j3);
                                break;
                            case 254:
                                long readInt4 = (long) dataInputStream.readInt();
                                read2 = dataInputStream.readInt();
                                a(bArr, bvVar, outputStream, readInt4, read2, j3);
                                break;
                            case 255:
                                long readLong = dataInputStream.readLong();
                                read2 = dataInputStream.readInt();
                                a(bArr, bvVar, outputStream, readLong, read2, j3);
                                break;
                            default:
                                a(bArr, dataInputStream, outputStream, read2, j3);
                                break;
    ...
    private static void a(byte[] bArr, bv bvVar, OutputStream outputStream, long j, int i, long j2) throws IOException {
        InputStream b;
        Throwable th;
        int i2 = i;
        if (i2 < 0) {
