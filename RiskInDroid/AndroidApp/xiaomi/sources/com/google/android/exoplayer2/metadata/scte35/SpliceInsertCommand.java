...
public final class SpliceInsertCommand extends SpliceCommand {
    ...
    static SpliceInsertCommand parseFromSection(ParsableByteArray parsableByteArray, long j, TimestampAdjuster timestampAdjuster) {
        ...
        boolean z6 = (parsableByteArray.readUnsignedByte() & NotificationCompat.FLAG_HIGH_PRIORITY) != 0;
        List emptyList = Collections.emptyList();
        if (!z6) {
            int readUnsignedByte = parsableByteArray.readUnsignedByte();
            boolean z7 = (readUnsignedByte & NotificationCompat.FLAG_HIGH_PRIORITY) != 0;
