...
final class OpusReader extends StreamReader {
    ...
    public final boolean readHeaders(ParsableByteArray parsableByteArray, long j, StreamReader.SetupData setupData) {
        ...
        if (!this.headerRead) {
            ...
            byte b = ((copyOf[11] & 255) << 8) | (copyOf[10] & 255);
            ArrayList arrayList = new ArrayList(3);
            arrayList.add(copyOf);
            putNativeOrderLong(arrayList, b);
            putNativeOrderLong(arrayList, 3840);
            setupData.format = new Format.Builder().setSampleMimeType("audio/opus").setChannelCount(copyOf[9] & 255).setSampleRate(48000).setInitializationData(arrayList).build();
    ...
    private long getPacketDurationUs(byte[] bArr) {
        ...
        int i = b >> 3;
        int i2 = i & 3;
        return ((long) b3) * ((long) (i >= 16 ? 2500 << i2 : i >= 12 ? C.MSG_CUSTOM_BASE << (i2 & 1) : i2 == 3 ? 60000 : C.MSG_CUSTOM_BASE << i2));
    }
}
