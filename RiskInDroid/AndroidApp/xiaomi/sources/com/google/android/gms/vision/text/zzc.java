...
final class zzc {
    ...
    static Point[] zza(zzn zzn) {
        ...
        double d = (double) zzn.left;
        double d2 = (double) zzn.width;
        Double.isNaN(d2);
        Double.isNaN(d);
        double d3 = (double) zzn.top;
        double d4 = (double) zzn.width;
        Double.isNaN(d4);
        Double.isNaN(d3);
        pointArr[1] = new Point((int) (d + (d2 * cos)), (int) (d3 + (d4 * sin)));
        double d5 = (double) pointArr[1].x;
        double d6 = (double) zzn.height;
        Double.isNaN(d6);
        Double.isNaN(d5);
        int i = (int) (d5 - (d6 * sin));
        double d7 = (double) pointArr[1].y;
        double d8 = (double) zzn.height;
        Double.isNaN(d8);
        Double.isNaN(d7);
