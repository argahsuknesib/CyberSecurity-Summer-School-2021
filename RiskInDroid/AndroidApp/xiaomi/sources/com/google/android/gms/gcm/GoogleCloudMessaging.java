...
public class GoogleCloudMessaging {
    ...
    private final Map<String, Handler> zzae = Collections.synchronizedMap(new o0O0OOO0());
    ...
    private final Intent zzd(Bundle bundle, boolean z) throws IOException {
        if (Looper.getMainLooper() == Looper.myLooper()) {
            ...
            try {
                return this.zzag.poll(DashMediaSource.DEFAULT_LIVE_PRESENTATION_DELAY_FIXED_MS, TimeUnit.MILLISECONDS);
