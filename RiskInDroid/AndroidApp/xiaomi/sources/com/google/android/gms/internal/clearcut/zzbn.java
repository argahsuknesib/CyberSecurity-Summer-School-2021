...
public abstract class zzbn extends zzba {
        ...
        public final void zzb(long j) throws IOException {
            if (!zzbn.zzfy || zzag() < 10) {
                ...
                while ((j & -128) != 0) {
                    ...
                    this.position = i3 + 1;
                    zzfd.zza(bArr3, (long) i3, (byte) ((((int) j) & 127) | NotificationCompat.FLAG_HIGH_PRIORITY));
                    j >>>= 7;
                }
        ...
        public final void zzo(int i) throws IOException {
            if (!zzbn.zzfy || zzag() < 10) {
                ...
                while ((i & -128) != 0) {
                    ...
                    int i4 = this.position;
                    this.position = i4 + 1;
                    zzfd.zza(bArr3, (long) i4, (byte) ((i & 127) | NotificationCompat.FLAG_HIGH_PRIORITY));
                    i >>>= 7;
                }
                byte[] bArr4 = this.buffer;
                int i5 = this.position;
    ...
    static final class zzd extends zzbn {
        ...
        public final void zzb(long j) throws IOException {
            while ((-128 & j) != 0) {
                this.zzgd.put((byte) ((((int) j) & 127) | NotificationCompat.FLAG_HIGH_PRIORITY));
                j >>>= 7;
            }
            try {
        ...
        public final void zzo(int i) throws IOException {
            while ((i & -128) != 0) {
                this.zzgd.put((byte) ((i & 127) | NotificationCompat.FLAG_HIGH_PRIORITY));
                i >>>= 7;
            }
            try {
        ...
        public final void zzb(long j) throws IOException {
            ...
            if (this.zzgi <= this.zzgh) {
                while ((j & -128) != 0) {
                    long j3 = this.zzgi;
                    this.zzgi = j3 + 1;
                    zzfd.zza(j3, (byte) ((((int) j) & 127) | NotificationCompat.FLAG_HIGH_PRIORITY));
                    j >>>= 7;
                }
                j2 = this.zzgi;
            } else {
                while (true) {
                    ...
                    if (j2 >= this.zzgg) {
                        ...
                        this.zzgi = j2 + 1;
                        zzfd.zza(j2, (byte) ((((int) j) & 127) | NotificationCompat.FLAG_HIGH_PRIORITY));
                        j >>>= 7;
                    }
                }
            }
        ...
        public final void zzo(int i) throws IOException {
            ...
            if (this.zzgi <= this.zzgh) {
                while ((i & -128) != 0) {
                    long j2 = this.zzgi;
                    this.zzgi = j2 + 1;
                    zzfd.zza(j2, (byte) ((i & 127) | NotificationCompat.FLAG_HIGH_PRIORITY));
                    i >>>= 7;
                }
                j = this.zzgi;
            } else {
                while (true) {
                    ...
                    if (j >= this.zzgg) {
                        ...
                        this.zzgi = j + 1;
                        zzfd.zza(j, (byte) ((i & 127) | NotificationCompat.FLAG_HIGH_PRIORITY));
                        i >>>= 7;
                    }
                }
            }
    ...
    /* JADX DEBUG: Failed to find minimal casts for resolve overloaded methods, cast all args instead
     ...
     arg types: [java.util.logging.Level, java.lang.String, java.lang.String, java.lang.String, com.google.android.gms.internal.clearcut.zzfi]
     candidates:
