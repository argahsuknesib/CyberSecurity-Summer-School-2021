...
public class GoogleSignInOptionsExtensionParcelable extends AbstractSafeParcelable {
    ...
    GoogleSignInOptionsExtensionParcelable(@SafeParcelable.Param(id = 1) int i, @GoogleSignInOptionsExtension.TypeId @SafeParcelable.Param(id = 2) int i2, @SafeParcelable.Param(id = 3) Bundle bundle) {
        this.versionCode = i;
        this.zzac = i2;
        this.mBundle = bundle;
    }
