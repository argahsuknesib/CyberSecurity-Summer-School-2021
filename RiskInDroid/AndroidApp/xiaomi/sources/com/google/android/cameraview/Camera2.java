...
class Camera2 extends CameraViewImpl implements MediaRecorder.OnErrorListener, MediaRecorder.OnInfoListener {
    ...
    private final CameraDevice.StateCallback mCameraDeviceCallback = new CameraDevice.StateCallback() {
        /* class com.google.android.cameraview.Camera2.AnonymousClass1 */
    ...
    PictureCaptureCallback mCaptureCallback = new PictureCaptureCallback() {
        /* class com.google.android.cameraview.Camera2.AnonymousClass3 */
    ...
    private final ImageReader.OnImageAvailableListener mOnImageAvailableListener = new ImageReader.OnImageAvailableListener() {
        /* class com.google.android.cameraview.Camera2.AnonymousClass4 */
        ...
        public void onImageAvailable(ImageReader imageReader) {
            ...
            if (planes.length > 0) {
                ...
                if (acquireNextImage.getFormat() == 256) {
                    Camera2.this.mCallback.onPictureTaken(bArr, 0);
                } else {
    ...
    private final CameraCaptureSession.StateCallback mSessionCallback = new CameraCaptureSession.StateCallback() {
        /* class com.google.android.cameraview.Camera2.AnonymousClass2 */
    ...
    Camera2(CameraViewImpl.Callback callback, PreviewImpl previewImpl, Context context, Handler handler) {
        ...
        this.mCameraManager.registerAvailabilityCallback(new CameraManager.AvailabilityCallback() {
            /* class com.google.android.cameraview.Camera2.AnonymousClass5 */
        ...
        this.mPreview.setCallback(new PreviewImpl.Callback() {
            /* class com.google.android.cameraview.Camera2.AnonymousClass6 */
    ...
    public void setCameraId(String str) {
        if (!jmq.O000000o(this._mCameraId, str)) {
            this._mCameraId = str;
            if (!jmq.O000000o(this._mCameraId, this.mCameraId) && isCameraOpened()) {
                stop();
                start();
            }
        }
    ...
    public void setPreviewTexture(SurfaceTexture surfaceTexture) {
        ...
        new Handler(Looper.getMainLooper()).post(new Runnable() {
            /* class com.google.android.cameraview.Camera2.AnonymousClass7 */
    ...
    public void setFocusArea(float f, float f2) {
        if (this.mCaptureSession != null) {
            AnonymousClass8 r2 = new CameraCaptureSession.CaptureCallback() {
                /* class com.google.android.cameraview.Camera2.AnonymousClass8 */
                ...
                public void onCaptureFailed(CameraCaptureSession cameraCaptureSession, CaptureRequest captureRequest, CaptureFailure captureFailure) {
                    ...
                    Log.e("Camera2", "Manual AF failure: ".concat(String.valueOf(captureFailure)));
                }
            };
            try {
                this.mCaptureSession.stopRepeating();
    ...
    public void captureStillPicture() {
        try {
            ...
            this.mCaptureSession.capture(createCaptureRequest.build(), new CameraCaptureSession.CaptureCallback() {
                /* class com.google.android.cameraview.Camera2.AnonymousClass9 */
