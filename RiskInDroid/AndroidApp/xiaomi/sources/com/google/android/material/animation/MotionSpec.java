...
public class MotionSpec {
    private final o0OO00OO<String, PropertyValuesHolder[]> propertyValues = new o0OO00OO<>();
    private final o0OO00OO<String, MotionTiming> timings = new o0OO00OO<>();
    ...
    public long getTotalDuration() {
        ...
        for (int i = 0; i < size; i++) {
            MotionTiming O00000o0 = this.timings.O00000o0(i);
            j = Math.max(j, O00000o0.getDelay() + O00000o0.getDuration());
        }
        return j;
    }
