    ...
    private void updateImportantForAccessibility(View view, boolean z) {
        ...
        if (parent instanceof CoordinatorLayout) {
            ...
            for (int i = 0; i < childCount; i++) {
                ...
                boolean z2 = (childAt.getLayoutParams() instanceof CoordinatorLayout.O00000o) && (((CoordinatorLayout.O00000o) childAt.getLayoutParams()).f2811O000000o instanceof FabTransformationScrimBehavior);
                if (childAt != view && !z2) {
                    if (!z) {
                        Map<View, Integer> map = this.importantForAccessibilityMap;
                        if (map != null && map.containsKey(childAt)) {
                            cb.O00000oO(childAt, this.importantForAccessibilityMap.get(childAt).intValue());
                        }
                    } else {
