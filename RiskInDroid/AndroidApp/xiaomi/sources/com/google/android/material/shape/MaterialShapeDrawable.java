...
public class MaterialShapeDrawable extends Drawable implements ac, Shapeable {
    ...
    private boolean hasCompatShadow() {
        ...
        if (this.drawableState.shadowCompatMode == 2 || requiresCompatShadow()) {
            return true;
        }
        return false;
    }
    ...
    private boolean updateTintFilter() {
        ...
        if (!bd.O000000o(porterDuffColorFilter, this.tintFilter) || !bd.O000000o(porterDuffColorFilter2, this.strokeTintFilter)) {
            return true;
        }
        return false;
    }
