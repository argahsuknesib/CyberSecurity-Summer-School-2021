...
public final class FadeProvider implements VisibilityAnimatorProvider {
    ...
    private static Animator createFadeAnimator(final View view, float f, float f2, float f3, float f4, final float f5) {
        ...
        ofFloat.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
            /* class com.google.android.material.transition.platform.FadeProvider.AnonymousClass1 */
        ...
        ofFloat.addListener(new AnimatorListenerAdapter() {
            /* class com.google.android.material.transition.platform.FadeProvider.AnonymousClass2 */
