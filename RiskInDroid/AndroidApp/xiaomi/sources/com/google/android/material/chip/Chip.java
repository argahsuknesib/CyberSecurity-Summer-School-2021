...
public class Chip extends AppCompatCheckBox implements ChipDrawable.Delegate, Shapeable {
    ...
    private static final int DEF_STYLE_RES = 2132739122;
    ...
    public Chip(Context context, AttributeSet attributeSet, int i) {
        ...
        createFromAttributes.setElevation(cb.O0000oOO(this));
        TypedArray obtainStyledAttributes = ThemeEnforcement.obtainStyledAttributes(context2, attributeSet, new int[]{16842804, 16842901, 16842904, 16842923, 16843039, 16843087, 16843237, R.attr.checkedIcon, R.attr.checkedIconEnabled, R.attr.checkedIconTint, R.attr.checkedIconVisible, R.attr.chipBackgroundColor, R.attr.chipCornerRadius, R.attr.chipEndPadding, R.attr.chipIcon, R.attr.chipIconEnabled, R.attr.chipIconSize, R.attr.chipIconTint, R.attr.chipIconVisible, R.attr.chipMinHeight, R.attr.chipMinTouchTargetSize, R.attr.chipStartPadding, R.attr.chipStrokeColor, R.attr.chipStrokeWidth, R.attr.chipSurfaceColor, R.attr.closeIcon, R.attr.closeIconEnabled, R.attr.closeIconEndPadding, R.attr.closeIconSize, R.attr.closeIconStartPadding, R.attr.closeIconTint, R.attr.closeIconVisible, R.attr.ensureMinTouchTargetSize, R.attr.hideMotionSpec, R.attr.iconEndPadding, R.attr.iconStartPadding, R.attr.rippleColor, R.attr.shapeAppearance, R.attr.shapeAppearanceOverlay, R.attr.showMotionSpec, R.attr.textEndPadding, R.attr.textStartPadding}, i, DEF_STYLE_RES, new int[0]);
        ...
        this.lastLayoutDirection = cb.O0000Oo0(this);
    }
    ...
    public void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo accessibilityNodeInfo) {
        ...
        if (getParent() instanceof ChipGroup) {
            ...
            cl.O000000o(accessibilityNodeInfo).O00000Oo(cl.O00000o0.O000000o(chipGroup.getRowIndex(this), 1, chipGroup.isSingleLine() ? chipGroup.getIndexOfChip(this) : -1, 1, isChecked()));
        }
    }

    private void updateAccessibilityDelegate() {
        if (!hasCloseIcon() || !isCloseIconVisible() || this.onCloseIconClickListener == null) {
            cb.O000000o(this, (bh) null);
        } else {
            cb.O000000o(this, this.touchHelper);
        }
    }

    private void initMinTouchTarget(Context context, AttributeSet attributeSet, int i) {
        TypedArray obtainStyledAttributes = ThemeEnforcement.obtainStyledAttributes(context, attributeSet, new int[]{16842804, 16842901, 16842904, 16842923, 16843039, 16843087, 16843237, R.attr.checkedIcon, R.attr.checkedIconEnabled, R.attr.checkedIconTint, R.attr.checkedIconVisible, R.attr.chipBackgroundColor, R.attr.chipCornerRadius, R.attr.chipEndPadding, R.attr.chipIcon, R.attr.chipIconEnabled, R.attr.chipIconSize, R.attr.chipIconTint, R.attr.chipIconVisible, R.attr.chipMinHeight, R.attr.chipMinTouchTargetSize, R.attr.chipStartPadding, R.attr.chipStrokeColor, R.attr.chipStrokeWidth, R.attr.chipSurfaceColor, R.attr.closeIcon, R.attr.closeIconEnabled, R.attr.closeIconEndPadding, R.attr.closeIconSize, R.attr.closeIconStartPadding, R.attr.closeIconTint, R.attr.closeIconVisible, R.attr.ensureMinTouchTargetSize, R.attr.hideMotionSpec, R.attr.iconEndPadding, R.attr.iconStartPadding, R.attr.rippleColor, R.attr.shapeAppearance, R.attr.shapeAppearanceOverlay, R.attr.showMotionSpec, R.attr.textEndPadding, R.attr.textStartPadding}, i, DEF_STYLE_RES, new int[0]);
        this.ensureMinTouchTargetSize = obtainStyledAttributes.getBoolean(32, false);
        this.minTouchTargetSize = (int) Math.ceil((double) obtainStyledAttributes.getDimension(20, (float) Math.ceil((double) ViewUtils.dpToPx(getContext(), 48))));
        obtainStyledAttributes.recycle();
    }
    ...
    private void updatePaddingInternal() {
        ...
        if (!TextUtils.isEmpty(getText()) && (chipDrawable2 = this.chipDrawable) != null) {
            ...
            cb.O00000Oo(this, chipStartPadding, getPaddingTop(), chipEndPadding, getPaddingBottom());
        }
    }
    ...
    private void updateBackgroundDrawable() {
        ...
        cb.O000000o(this, getBackgroundDrawable());
        updatePaddingInternal();
    ...
    private boolean handleAccessibilityExit(MotionEvent motionEvent) {
        if (motionEvent.getAction() == 10) {
            try {
                Field declaredField = df.class.getDeclaredField("mHoveredVirtualViewId");
                declaredField.setAccessible(true);
                if (((Integer) declaredField.get(this.touchHelper)).intValue() != Integer.MIN_VALUE) {
                    Method declaredMethod = df.class.getDeclaredMethod("updateHoveredVirtualView", Integer.TYPE);
    ...
    class ChipTouchHelper extends df {
        ...
        public void onPopulateNodeForVirtualView(int i, cl clVar) {
            if (i == 1) {
                ...
                if (closeIconContentDescription != null) {
                    clVar.O00000oO(closeIconContentDescription);
                } else {
                    ...
                    objArr[0] = text;
                    clVar.O00000oO(context.getString(R.string.mtrl_chip_close_icon_content_description, objArr).trim());
                }
                clVar.O00000Oo(Chip.this.getCloseIconTouchBoundsInt());
                clVar.O000000o(cl.O000000o.O00000oO);
                clVar.O0000Oo(Chip.this.isEnabled());
                return;
            }
            clVar.O00000oO("");
            clVar.O00000Oo(Chip.EMPTY_BOUNDS);
        }

        public void onPopulateNodeForHost(cl clVar) {
            clVar.O000000o(Chip.this.isCheckable());
            clVar.O0000OOo(Chip.this.isClickable());
            if (Chip.this.isCheckable() || Chip.this.isClickable()) {
                clVar.O00000Oo((CharSequence) (Chip.this.isCheckable() ? "android.widget.CompoundButton" : "android.widget.Button"));
            } else {
                clVar.O00000Oo((CharSequence) "android.view.View");
            }
            CharSequence text = Chip.this.getText();
            if (Build.VERSION.SDK_INT >= 23) {
                clVar.O00000o0(text);
    ...
    /* JADX DEBUG: Failed to find minimal casts for resolve overloaded methods, cast all args instead
     ...
     arg types: [com.google.android.material.chip.ChipDrawable, int, int, int, int]
     candidates:
