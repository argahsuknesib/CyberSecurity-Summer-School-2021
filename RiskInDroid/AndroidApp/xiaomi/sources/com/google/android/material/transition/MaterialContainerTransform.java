...
public final class MaterialContainerTransform extends Transition {
    ...
    public final void captureStartValues(is isVar) {
        captureValues(isVar, this.startView, this.startViewId, this.startShapeAppearanceModel);
    }

    public final void captureEndValues(is isVar) {
        captureValues(isVar, this.endView, this.endViewId, this.endShapeAppearanceModel);
    }

    private static void captureValues(is isVar, View view, int i, ShapeAppearanceModel shapeAppearanceModel) {
        if (i != -1) {
            isVar.O00000Oo = TransitionUtils.findDescendantOrAncestorById(isVar.O00000Oo, i);
        } else if (view != null) {
            isVar.O00000Oo = view;
        } else if (isVar.O00000Oo.getTag(R.id.mtrl_motion_snapshot_view) instanceof View) {
            isVar.O00000Oo.setTag(R.id.mtrl_motion_snapshot_view, null);
            isVar.O00000Oo = (View) isVar.O00000Oo.getTag(R.id.mtrl_motion_snapshot_view);
        }
        View view2 = isVar.O00000Oo;
        if (cb.O000O0oO(view2) || view2.getWidth() != 0 || view2.getHeight() != 0) {
            ...
            isVar.f1596O000000o.put("materialContainerTransition:bounds", relativeBounds);
            isVar.f1596O000000o.put("materialContainerTransition:shapeAppearance", captureShapeAppearance(view2, relativeBounds, shapeAppearanceModel));
        }
    }
    ...
    public final Animator createAnimator(ViewGroup viewGroup, is isVar, is isVar2) {
        final View view;
        is isVar3 = isVar;
        is isVar4 = isVar2;
        if (!(isVar3 == null || isVar4 == null)) {
            RectF rectF = (RectF) isVar3.f1596O000000o.get("materialContainerTransition:bounds");
            ShapeAppearanceModel shapeAppearanceModel = (ShapeAppearanceModel) isVar3.f1596O000000o.get("materialContainerTransition:shapeAppearance");
            if (rectF == null || shapeAppearanceModel == null) {
                Log.w(TAG, "Skipping due to null start bounds. Ensure start view is laid out and measured.");
            } else {
                RectF rectF2 = (RectF) isVar4.f1596O000000o.get("materialContainerTransition:bounds");
                ShapeAppearanceModel shapeAppearanceModel2 = (ShapeAppearanceModel) isVar4.f1596O000000o.get("materialContainerTransition:shapeAppearance");
                if (rectF2 == null || shapeAppearanceModel2 == null) {
                    Log.w(TAG, "Skipping due to null end bounds. Ensure end view is laid out and measured.");
                    return null;
                }
                final View view2 = isVar3.O00000Oo;
                final View view3 = isVar4.O00000Oo;
