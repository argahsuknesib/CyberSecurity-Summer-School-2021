...
public class MaterialButton extends AppCompatButton implements Checkable, Shapeable {
    ...
    private static final int DEF_STYLE_RES = 2132739108;
    ...
    public void setBackgroundResource(int i) {
        setBackgroundDrawable(i != 0 ? OO0000o.O00000Oo(getContext(), i) : null);
    }
    ...
    private void updateIconPosition(int i, int i2) {
        if (this.icon != null && getLayout() != null) {
            if (isIconStart() || isIconEnd()) {
                ...
                int textWidth = (((((i - getTextWidth()) - cb.O0000Ooo(this)) - i4) - this.iconPadding) - cb.O0000OoO(this)) / 2;
    ...
    public void setIconResource(int i) {
        setIcon(i != 0 ? OO0000o.O00000Oo(getContext(), i) : null);
    }
    ...
    public void setIconTintResource(int i) {
        setIconTint(OO0000o.O000000o(getContext(), i));
    }
    ...
    private void updateIcon(boolean z) {
        ...
        if (drawable != null) {
            this.icon = ab.O00000oo(drawable).mutate();
            ab.O000000o(this.icon, this.iconTint);
            PorterDuff.Mode mode = this.iconTintMode;
            if (mode != null) {
                ab.O000000o(this.icon, mode);
            }
            int i = this.iconSize;
            if (i == 0) {
        ...
        Drawable[] O00000Oo = cy.O00000Oo(this);
        boolean z2 = false;
        Drawable drawable3 = O00000Oo[0];
        Drawable drawable4 = O00000Oo[1];
        Drawable drawable5 = O00000Oo[2];
    ...
    private void resetIconDrawable() {
        if (isIconStart()) {
            cy.O000000o(this, this.icon, null, null, null);
        } else if (isIconEnd()) {
            cy.O000000o(this, null, null, this.icon, null);
        } else if (isIconTop()) {
            cy.O000000o(this, null, this.icon, null, null);
        }
    }
    ...
    public void setRippleColorResource(int i) {
        if (isUsingOriginalBackground()) {
            setRippleColor(OO0000o.O000000o(getContext(), i));
        }
    }
