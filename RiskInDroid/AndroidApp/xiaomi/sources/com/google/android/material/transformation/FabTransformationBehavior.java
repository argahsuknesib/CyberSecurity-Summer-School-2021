...
public abstract class FabTransformationBehavior extends ExpandableTransformationBehavior {
    ...
    private void createElevationAnimation(View view, View view2, boolean z, boolean z2, FabTransformationSpec fabTransformationSpec, List<Animator> list, List<Animator.AnimatorListener> list2) {
        ...
        float O0000oOO = cb.O0000oOO(view2) - cb.O0000oOO(view);
        if (z) {
            if (!z2) {
                view2.setTranslationZ(-O0000oOO);
            }
            objectAnimator = ObjectAnimator.ofFloat(view2, View.TRANSLATION_Z, 0.0f);
        } else {
            objectAnimator = ObjectAnimator.ofFloat(view2, View.TRANSLATION_Z, -O0000oOO);
        }
    ...
    private void createTranslationAnimation(View view, View view2, boolean z, boolean z2, FabTransformationSpec fabTransformationSpec, List<Animator> list, List<Animator.AnimatorListener> list2, RectF rectF) {
        ...
        if (z3) {
            ...
            objectAnimator2 = ObjectAnimator.ofFloat(view4, View.TRANSLATION_X, 0.0f);
            objectAnimator = ObjectAnimator.ofFloat(view4, View.TRANSLATION_Y, 0.0f);
            ...
            objectAnimator2 = ObjectAnimator.ofFloat(view4, View.TRANSLATION_X, -calculateTranslationX);
            objectAnimator = ObjectAnimator.ofFloat(view4, View.TRANSLATION_Y, -calculateTranslationY);
        }
    ...
    private int getBackgroundTint(View view) {
        ColorStateList O000O0OO = cb.O000O0OO(view);
        if (O000O0OO != null) {
            return O000O0OO.getColorForState(view.getDrawableState(), O000O0OO.getDefaultColor());
        }
        return 0;
    }
