...
public final class LinearProgressIndicatorSpec extends BaseProgressIndicatorSpec {
    ...
    public LinearProgressIndicatorSpec(Context context, AttributeSet attributeSet, int i, int i2) {
        ...
        TypedArray obtainStyledAttributes = ThemeEnforcement.obtainStyledAttributes(context, attributeSet, new int[]{R.attr.indeterminateAnimationType, R.attr.indicatorDirectionLinear}, R.attr.linearProgressIndicatorStyle, LinearProgressIndicator.Widget_MaterialComponents_LinearProgressIndicator, new int[0]);
        boolean z = true;
        ...
        validateSpec();
        this.drawHorizontallyInverse = this.indicatorDirection != 1 ? false : z;
    }
