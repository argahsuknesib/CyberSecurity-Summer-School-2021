...
public class SwitchMaterial extends SwitchCompat {
    private static final int DEF_STYLE_RES = 2132739134;
    ...
    public SwitchMaterial(Context context, AttributeSet attributeSet, int i) {
        ...
        TypedArray obtainStyledAttributes = ThemeEnforcement.obtainStyledAttributes(context2, attributeSet2, new int[]{R.attr.useMaterialThemeColors}, i, DEF_STYLE_RES, new int[0]);
