...
public final class ITFReader extends OneDReader {
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:7:?, code lost:
        r0 = findGuardPattern(r7, r0, com.google.zxing.oned.ITFReader.END_PATTERN_REVERSED[1]);
     */
    ...
    private int[] decodeEnd(BitArray bitArray) throws NotFoundException {
        ...
        try {
            ...
            int[] iArr = findGuardPattern(bitArray, skipWhiteSpace, END_PATTERN_REVERSED[0]);
