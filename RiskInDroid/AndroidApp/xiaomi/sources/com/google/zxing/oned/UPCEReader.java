...
public final class UPCEReader extends UPCEANReader {
    ...
    public final int decodeMiddle(BitArray bitArray, int[] iArr, StringBuilder sb) throws NotFoundException {
    ...
    /* access modifiers changed from: protected */
    public final int[] decodeEnd(BitArray bitArray, int i) throws NotFoundException {
        return findGuardPattern(bitArray, i, true, MIDDLE_END_PATTERN);
    }

    /* access modifiers changed from: protected */
    public final boolean checkChecksum(String str) throws FormatException {
