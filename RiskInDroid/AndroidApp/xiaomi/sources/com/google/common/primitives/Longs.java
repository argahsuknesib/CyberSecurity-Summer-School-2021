...
public final class Longs {
    ...
    public static Long tryParse(String str, int i) {
        ...
        if (i2 < 2 || i2 > 36) {
            throw new IllegalArgumentException("radix must be between MIN_RADIX and MAX_RADIX but was ".concat(String.valueOf(i)));
        }
        int i3 = 0;
        if (str2.charAt(0) == '-') {
            i3 = 1;
    ...
    static final class LongConverter extends Converter<String, Long> implements Serializable {
        ...
        public final Long doForward(String str) {
            return Long.decode(str);
        }

        /* access modifiers changed from: protected */
        public final String doBackward(Long l) {
            return l.toString();
        }
