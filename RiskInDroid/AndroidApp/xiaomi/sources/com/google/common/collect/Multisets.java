...
public final class Multisets {
    ...
    public static <E> Multiset<E> unmodifiableMultiset(Multiset multiset) {
    ...
    @Deprecated
    public static <E> Multiset<E> unmodifiableMultiset(ImmutableMultiset immutableMultiset) {
    ...
    /* JADX DEBUG: Failed to find minimal casts for resolve overloaded methods, cast all args instead
     method: com.google.common.collect.Multisets.addAllImpl(com.google.common.collect.Multiset, com.google.common.collect.Multiset):boolean
     arg types: [com.google.common.collect.Multiset<E>, com.google.common.collect.Multiset<T>]
     candidates:
      com.google.common.collect.Multisets.addAllImpl(com.google.common.collect.Multiset, java.util.Collection):boolean
      com.google.common.collect.Multisets.addAllImpl(com.google.common.collect.Multiset, com.google.common.collect.Multiset):boolean */
    static <E> boolean addAllImpl(Multiset<E> multiset, Collection<? extends E> collection) {
        Preconditions.checkNotNull(multiset);
        Preconditions.checkNotNull(collection);
        if (collection instanceof Multiset) {
            return addAllImpl((Multiset) multiset, (Multiset) cast(collection));
        }
    ...
    static <E> Iterator<E> elementIterator(Iterator<Multiset.Entry<E>> it) {
        return new TransformedIterator<Multiset.Entry<E>, E>(it) {
            ...
            /* access modifiers changed from: package-private */
            public final E transform(Multiset.Entry<E> entry) {
