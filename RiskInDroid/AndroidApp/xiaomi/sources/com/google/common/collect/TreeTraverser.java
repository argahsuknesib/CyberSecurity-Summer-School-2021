...
public abstract class TreeTraverser<T> {
    ...
    public final FluentIterable<T> preOrderTraversal(final T t) {
        ...
        return new FluentIterable<T>() {
            ...
            public void forEach(final Consumer<? super T> consumer) {
                ...
                new Consumer<T>() {
                    /* class com.google.common.collect.TreeTraverser.AnonymousClass2.AnonymousClass1 */
    ...
    public final FluentIterable<T> postOrderTraversal(final T t) {
        ...
        return new FluentIterable<T>() {
            ...
            public void forEach(final Consumer<? super T> consumer) {
                Preconditions.checkNotNull(consumer);
                new Consumer<T>() {
                    /* class com.google.common.collect.TreeTraverser.AnonymousClass3.AnonymousClass1 */
    ...
    public final FluentIterable<T> breadthFirstTraversal(final T t) {
        Preconditions.checkNotNull(t);
        return new FluentIterable<T>() {
            /* class com.google.common.collect.TreeTraverser.AnonymousClass4 */
