...
final class CartesianList<E> extends AbstractList<List<E>> implements RandomAccess {
    ...
    public final int getAxisIndexForProductIndex(int i, int i2) {
    ...
    public final ImmutableList<E> get(final int i) {
        ...
        return new ImmutableList<E>() {
            ...
            public E get(int i) {
                Preconditions.checkElementIndex(i, size());
                return CartesianList.this.axes.get(i).get(CartesianList.this.getAxisIndexForProductIndex(i, i));
            }
        };
    }
