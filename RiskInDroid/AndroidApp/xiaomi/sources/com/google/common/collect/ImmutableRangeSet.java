    ...
    final class ComplementRanges extends ImmutableList<Range<C>> {
        ...
        public final Range<C> get(int i) {
            ...
            if (!this.positiveBoundedAbove || i != this.size - 1) {
                cut2 = ImmutableRangeSet.this.ranges.get(i + (this.positiveBoundedBelow ^ true ? 1 : 0)).lowerBound;
            } else {
                cut2 = Cut.aboveAll();
            }
    ...
    private ImmutableList<Range<C>> intersectRanges(final Range<C> range) {
        ...
        return new ImmutableList<Range<C>>() {
            ...
            public Range<C> get(int i) {
                ...
                if (i == 0 || i == i3 - 1) {
                    return ImmutableRangeSet.this.ranges.get(i + i).intersection(range);
                }
                return ImmutableRangeSet.this.ranges.get(i + i);
            }
        };
    }
    ...
    final class AsSet extends ImmutableSortedSet<C> {
        ...
        public final int size() {
            ...
            if (num == null) {
                ...
                while (it.hasNext()) {
                    j += (long) ContiguousSet.create(it.next(), this.domain).size();
                    if (j >= 2147483647L) {
                        break;
                    }
                }
        ...
        /* access modifiers changed from: package-private */
        public final ImmutableSortedSet<C> subSet(Range<C> range) {
        ...
        public final int indexOf(Object obj) {
            ...
            while (it.hasNext()) {
                ...
                if (next.contains(comparable)) {
                    return Ints.saturatedCast(j + ((long) ContiguousSet.create(next, this.domain).indexOf(comparable)));
                }
