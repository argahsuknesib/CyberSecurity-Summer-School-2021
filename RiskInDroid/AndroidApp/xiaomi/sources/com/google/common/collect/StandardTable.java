...
class StandardTable<R, C, V> extends AbstractTable<R, C, V> implements Serializable {
    ...
    class CellIterator implements Iterator<Table.Cell<R, C, V>> {
        ...
        public Table.Cell<R, C, V> next() {
            ...
            Map.Entry next = this.columnIterator.next();
    ...
    public Spliterator<Table.Cell<R, C, V>> cellSpliterator() {
        return CollectSpliterators.flatMap(this.backingMap.entrySet().spliterator(), $$Lambda$StandardTable$PASDwpaSzKLmtoUqymC_thbYuk.INSTANCE, 65, (long) size());
    }
    ...
    class Row extends Maps.IteratorBasedAbstractMap<C, V> {
        ...
        public Iterator<Map.Entry<C, V>> entryIterator() {
            ...
            return new Iterator<Map.Entry<C, V>>() {
                /* class com.google.common.collect.StandardTable.Row.AnonymousClass1 */
        ...
        public Spliterator<Map.Entry<C, V>> entrySpliterator() {
            ...
            return CollectSpliterators.map(backingRowMap2.entrySet().spliterator(), new Function() {
                /* class com.google.common.collect.$$Lambda$lUj_ufHDTuwEW1Fk84opmRFNIo */
        ...
        public Map.Entry<C, V> wrapEntry(final Map.Entry<C, V> entry) {
            return new ForwardingMapEntry<C, V>() {
                /* class com.google.common.collect.StandardTable.Row.AnonymousClass2 */
                ...
                while (this.iterator.hasNext()) {
                    ...
                    if (((Map) next.getValue()).containsKey(Column.this.columnKey)) {
                        return new AbstractMapEntry<R, V>() {
                            /* class com.google.common.collect.StandardTable.Column.EntrySetIterator.AnonymousClass1EntryImpl */
    ...
    class RowMap extends Maps.ViewCachingAbstractMap<R, Map<C, V>> {
        ...
        class EntrySet extends StandardTable<R, C, V>.TableSet<Map.Entry<R, Map<C, V>>> {
            ...
            public Iterator<Map.Entry<R, Map<C, V>>> iterator() {
                return Maps.asMapEntryIterator(StandardTable.this.backingMap.keySet(), new com.google.common.base.Function<R, Map<C, V>>() {
    ...
    class ColumnMap extends Maps.ViewCachingAbstractMap<C, Map<R, V>> {
        ...
        class ColumnMapEntrySet extends StandardTable<R, C, V>.TableSet<Map.Entry<C, Map<R, V>>> {
            ...
            public Iterator<Map.Entry<C, Map<R, V>>> iterator() {
                return Maps.asMapEntryIterator(StandardTable.this.columnKeySet(), new com.google.common.base.Function<C, Map<R, V>>() {
