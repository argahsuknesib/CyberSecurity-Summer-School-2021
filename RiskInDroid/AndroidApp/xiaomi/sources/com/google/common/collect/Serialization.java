...
final class Serialization {
    ...
    static final class FieldSetter<T> {
        ...
        public final void set(ImmutableMultimap immutableMultimap, Object obj) {
            try {
                this.field.set(immutableMultimap, obj);
        ...
        /* access modifiers changed from: package-private */
        public final void set(ImmutableMultimap immutableMultimap, int i) {
            try {
