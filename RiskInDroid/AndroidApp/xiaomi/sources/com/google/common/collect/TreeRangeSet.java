...
public class TreeRangeSet<C extends Comparable<?>> extends AbstractRangeSet<C> implements Serializable {
    ...
    public boolean intersects(Range<C> range) {
        ...
        Map.Entry<K, V> ceilingEntry = this.rangesByLowerBound.ceilingEntry(range.lowerBound);
        if (ceilingEntry != null && ((Range) ceilingEntry.getValue()).isConnected(range) && !((Range) ceilingEntry.getValue()).intersection(range).isEmpty()) {
            return true;
        }
        Map.Entry<K, V> lowerEntry = this.rangesByLowerBound.lowerEntry(range.lowerBound);
    ...
    public boolean encloses(Range<C> range) {
        Preconditions.checkNotNull(range);
        Map.Entry<K, V> floorEntry = this.rangesByLowerBound.floorEntry(range.lowerBound);
    ...
    public void add(Range<C> range) {
        ...
        if (!range.isEmpty()) {
            ...
            if (lowerEntry != null) {
                ...
                if (range2.upperBound.compareTo((Cut) cut) >= 0) {
                    if (range2.upperBound.compareTo((Cut) cut2) >= 0) {
            ...
            if (floorEntry != null) {
                ...
                if (range3.upperBound.compareTo((Cut) cut2) >= 0) {
        ...
        if (!range.isEmpty()) {
            ...
            if (lowerEntry != null) {
                ...
                if (range2.upperBound.compareTo((Cut) range.lowerBound) >= 0) {
                    if (range.hasUpperBound() && range2.upperBound.compareTo((Cut) range.upperBound) >= 0) {
            ...
            Map.Entry<K, V> floorEntry = this.rangesByLowerBound.floorEntry(range.upperBound);
            if (floorEntry != null) {
                Range range3 = (Range) floorEntry.getValue();
                if (range.hasUpperBound() && range3.upperBound.compareTo((Cut) range.upperBound) >= 0) {
    ...
    static final class RangesByUpperBound<C extends Comparable<?>> extends AbstractNavigableMap<Cut<C>, Range<C>> {
        ...
        public final Iterator<Map.Entry<Cut<C>, Range<C>>> entryIterator() {
            ...
            if (!this.upperBoundWindow.hasLowerBound()) {
                ...
                Map.Entry<K, V> lowerEntry = this.rangesByLowerBound.lowerEntry(this.upperBoundWindow.lowerEndpoint());
                if (lowerEntry == null) {
                    it = this.rangesByLowerBound.values().iterator();
        ...
        /* access modifiers changed from: package-private */
        public final Iterator<Map.Entry<Cut<C>, Range<C>>> descendingEntryIterator() {
    ...
    static final class ComplementRangesByLowerBound<C extends Comparable<?>> extends AbstractNavigableMap<Cut<C>, Range<C>> {
        ...
        public final Iterator<Map.Entry<Cut<C>, Range<C>>> descendingEntryIterator() {
            ...
            final PeekingIterator<T> peekingIterator = Iterators.peekingIterator(this.positiveRangesByUpperBound.headMap(cut, this.complementLowerBoundWindow.hasUpperBound() && this.complementLowerBoundWindow.upperBoundType() == BoundType.CLOSED).descendingMap().values().iterator());
            if (peekingIterator.hasNext()) {
        ...
        /* JADX DEBUG: Failed to find minimal casts for resolve overloaded methods, cast all args instead
         method: com.google.common.collect.TreeRangeSet.ComplementRangesByLowerBound.tailMap(com.google.common.collect.Cut, boolean):java.util.NavigableMap<com.google.common.collect.Cut<C>, com.google.common.collect.Range<C>>
         arg types: [com.google.common.collect.Cut, int]
         candidates:
          com.google.common.collect.TreeRangeSet.ComplementRangesByLowerBound.tailMap(java.lang.Object, boolean):java.util.NavigableMap
          ClspMth{java.util.NavigableMap.tailMap(java.lang.Object, boolean):java.util.NavigableMap<K, V>}
          com.google.common.collect.TreeRangeSet.ComplementRangesByLowerBound.tailMap(com.google.common.collect.Cut, boolean):java.util.NavigableMap<com.google.common.collect.Cut<C>, com.google.common.collect.Range<C>> */
        public final Range<C> get(Object obj) {
            if (obj instanceof Cut) {
                try {
                    Cut cut = (Cut) obj;
    ...
    static final class SubRangeSetRangesByLowerBound<C extends Comparable<?>> extends AbstractNavigableMap<Cut<C>, Range<C>> {
        ...
        public final Range<C> get(Object obj) {
            if (obj instanceof Cut) {
                try {
                    Cut cut = (Cut) obj;
                    if (this.lowerBoundWindow.contains(cut) && cut.compareTo((Cut) this.restriction.lowerBound) >= 0) {
                        if (cut.compareTo((Cut) this.restriction.upperBound) < 0) {
        ...
        public final Iterator<Map.Entry<Cut<C>, Range<C>>> entryIterator() {
            ...
            if (this.lowerBoundWindow.lowerBound.isLessThan(this.restriction.lowerBound)) {
                ...
                c = this.restriction.lowerBound;
            } else {
                navigableMap = this.rangesByLowerBound;
                c = this.lowerBoundWindow.lowerBound.endpoint();
                if (this.lowerBoundWindow.lowerBoundType() == BoundType.CLOSED) {
                    ...
                    return new AbstractIterator<Map.Entry<Cut<C>, Range<C>>>() {
                        ...
                        public Map.Entry<Cut<C>, Range<C>> computeNext() {
                            ...
                            Range<C> intersection = range.intersection(SubRangeSetRangesByLowerBound.this.restriction);
            ...
            z = false;
            final Iterator<Range<C>> it2 = navigableMap.tailMap(c, z).values().iterator();
        ...
        public final Iterator<Map.Entry<Cut<C>, Range<C>>> descendingEntryIterator() {
            ...
            final Iterator<Range<C>> it = this.rangesByLowerBound.headMap(cut.endpoint(), cut.typeAsUpperBound() == BoundType.CLOSED).descendingMap().values().iterator();
            return new AbstractIterator<Map.Entry<Cut<C>, Range<C>>>() {
