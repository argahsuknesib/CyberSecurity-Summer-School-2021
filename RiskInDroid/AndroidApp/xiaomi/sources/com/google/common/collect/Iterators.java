...
public final class Iterators {
    ...
    public static <T> Iterator<T> cycle(final Iterable iterable) {
    ...
    @SafeVarargs
    public static <T> Iterator<T> cycle(Object... objArr) {
    ...
    public static <T> Iterator<T> concat(Iterator... itArr) {
        return concatNoDefensiveCopy((Iterator[]) Arrays.copyOf(itArr, itArr.length));
    }

    public static <T> Iterator<T> concat(Iterator it) {
    ...
    @GwtIncompatible
    public static <T> UnmodifiableIterator<T> filter(Iterator<?> it, Class cls) {
