...
public abstract class Invokable<T, R> extends Element implements GenericDeclaration {
    ...
    public final ImmutableList<Parameter> getParameters() {
        ...
        for (int i = 0; i < genericParameterTypes.length; i++) {
            builder.add((Object) new Parameter(this, i, TypeToken.of(genericParameterTypes[i]), parameterAnnotations[i], annotatedParameterTypes[i]));
        }
    ...
    /* JADX WARN: Type inference failed for: r1v0, types: [java.lang.Class<R1>, java.lang.Class] */
    /* JADX WARNING: Unknown variable types count: 1 */
    public final <R1 extends R> Invokable<T, R1> returning(Class<R1> r1) {
        return returning(TypeToken.of((Class) r1));
    }
