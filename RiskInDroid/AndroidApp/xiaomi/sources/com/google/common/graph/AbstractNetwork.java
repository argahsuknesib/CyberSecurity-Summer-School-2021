...
public abstract class AbstractNetwork<N, E> implements Network<N, E> {
    ...
    /* JADX WARN: Type inference failed for: r1v0, types: [com.google.common.graph.Network<N, E>, com.google.common.graph.Network] */
    /* JADX WARNING: Unknown variable types count: 1 */
    private static <N, E> Map<E, EndpointPair<N>> edgeIncidentNodesMap(final Network<N, E> r1) {
        return Maps.asMap(r1.edges(), new Function<E, EndpointPair<N>>() {
            /* class com.google.common.graph.AbstractNetwork.AnonymousClass3 */

            public final EndpointPair<N> apply(E e) {
                return r1.incidentNodes(e);
            }
        });
    }
}
