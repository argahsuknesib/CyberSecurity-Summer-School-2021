...
final class SchemaUtil {
    ...
    static <UT, UB> UB filterUnknownEnumList(int i, List<Integer> list, Internal.EnumLiteMap<?> enumLiteMap, Object obj, UnknownFieldSchema unknownFieldSchema) {
        Object obj2;
        if (enumLiteMap == null) {
            return obj;
        }
        if (!(list instanceof RandomAccess)) {
            ...
            while (true) {
                ...
                while (it.hasNext()) {
                    ...
                    if (enumLiteMap.findValueByNumber(intValue) == null) {
                        obj = storeUnknownEnum(i, intValue, obj2, unknownFieldSchema);
                        it.remove();
                    }
                }
                break loop1;
            ...
            for (int i3 = 0; i3 < size; i3++) {
                ...
                if (enumLiteMap.findValueByNumber(intValue2) != null) {
                    ...
                    obj2 = storeUnknownEnum(i, intValue2, obj2, unknownFieldSchema);
                }
            }
            if (i2 != size) {
    ...
    static <UT, UB> UB filterUnknownEnumList(int i, List<Integer> list, Internal.EnumVerifier enumVerifier, Object obj, UnknownFieldSchema unknownFieldSchema) {
        Object obj2;
