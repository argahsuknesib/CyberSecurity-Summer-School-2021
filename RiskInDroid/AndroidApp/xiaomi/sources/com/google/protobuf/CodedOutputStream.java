...
public abstract class CodedOutputStream extends ByteOutput {
    ...
    /* JADX DEBUG: Failed to find minimal casts for resolve overloaded methods, cast all args instead
     ...
     arg types: [java.util.logging.Level, java.lang.String, com.google.protobuf.Utf8$UnpairedSurrogateException]
     candidates:
        ...
        public final void writeUInt32NoTag(int i) throws IOException {
            if (!CodedOutputStream.HAS_UNSAFE_ARRAY_OPERATIONS || Android.isOnAndroidDevice() || spaceLeft() < 5) {
                while ((i & -128) != 0) {
                    ...
                    this.position = i2 + 1;
                    bArr[i2] = (byte) ((i & 127) | NotificationCompat.FLAG_HIGH_PRIORITY);
                    i >>>= 7;
                }
                try {
                ...
                this.position = i5 + 1;
                UnsafeUtil.putByte(bArr4, (long) i5, (byte) (i | NotificationCompat.FLAG_HIGH_PRIORITY));
                int i6 = i >>> 7;
                if ((i6 & -128) == 0) {
                ...
                this.position = i8 + 1;
                UnsafeUtil.putByte(bArr6, (long) i8, (byte) (i6 | NotificationCompat.FLAG_HIGH_PRIORITY));
                int i9 = i6 >>> 7;
                if ((i9 & -128) == 0) {
                ...
                this.position = i11 + 1;
                UnsafeUtil.putByte(bArr8, (long) i11, (byte) (i9 | NotificationCompat.FLAG_HIGH_PRIORITY));
                int i12 = i9 >>> 7;
                if ((i12 & -128) == 0) {
                ...
                this.position = i14 + 1;
                UnsafeUtil.putByte(bArr10, (long) i14, (byte) (i12 | NotificationCompat.FLAG_HIGH_PRIORITY));
        ...
        public final void writeUInt64NoTag(long j) throws IOException {
            if (!CodedOutputStream.HAS_UNSAFE_ARRAY_OPERATIONS || spaceLeft() < 10) {
                ...
                while ((j & -128) != 0) {
                    ...
                    int i3 = this.position;
                    this.position = i3 + 1;
                    UnsafeUtil.putByte(bArr3, (long) i3, (byte) ((((int) j) & 127) | NotificationCompat.FLAG_HIGH_PRIORITY));
                    j >>>= 7;
                }
                byte[] bArr4 = this.buffer;
                int i4 = this.position;
    ...
    static final class SafeDirectNioEncoder extends CodedOutputStream {
        ...
        public final void writeUInt32NoTag(int i) throws IOException {
            while ((i & -128) != 0) {
                this.buffer.put((byte) ((i & 127) | NotificationCompat.FLAG_HIGH_PRIORITY));
                i >>>= 7;
            }
            try {
        ...
        public final void writeUInt64NoTag(long j) throws IOException {
            while ((-128 & j) != 0) {
                this.buffer.put((byte) ((((int) j) & 127) | NotificationCompat.FLAG_HIGH_PRIORITY));
                j >>>= 7;
            }
            try {
        ...
        public final void writeUInt32NoTag(int i) throws IOException {
            if (this.position <= this.oneVarintLimit) {
                while ((i & -128) != 0) {
                    long j = this.position;
                    this.position = j + 1;
                    UnsafeUtil.putByte(j, (byte) ((i & 127) | NotificationCompat.FLAG_HIGH_PRIORITY));
                    i >>>= 7;
                }
        ...
        public final void writeUInt64NoTag(long j) throws IOException {
            if (this.position <= this.oneVarintLimit) {
                while ((j & -128) != 0) {
                    long j2 = this.position;
                    this.position = j2 + 1;
                    UnsafeUtil.putByte(j2, (byte) ((((int) j) & 127) | NotificationCompat.FLAG_HIGH_PRIORITY));
                    j >>>= 7;
                }
                long j3 = this.position;
                this.position = 1 + j3;
            ...
            while (true) {
                ...
                if (j4 >= this.limit) {
                    ...
                    this.position = j4 + 1;
                    UnsafeUtil.putByte(j4, (byte) ((((int) j) & 127) | NotificationCompat.FLAG_HIGH_PRIORITY));
                    j >>>= 7;
                }
            }
        }
        ...
        public final void bufferUInt32NoTag(int i) {
            if (CodedOutputStream.HAS_UNSAFE_ARRAY_OPERATIONS) {
                ...
                while ((i & -128) != 0) {
                    ...
                    int i2 = this.position;
                    this.position = i2 + 1;
                    UnsafeUtil.putByte(bArr, (long) i2, (byte) ((i & 127) | NotificationCompat.FLAG_HIGH_PRIORITY));
                    i >>>= 7;
                }
                byte[] bArr2 = this.buffer;
                int i3 = this.position;
            ...
            while ((i & -128) != 0) {
                ...
                int i4 = this.position;
                this.position = i4 + 1;
                bArr3[i4] = (byte) ((i & 127) | NotificationCompat.FLAG_HIGH_PRIORITY);
                this.totalBytesWritten++;
                i >>>= 7;
            }
            byte[] bArr4 = this.buffer;
        ...
        public final void bufferUInt64NoTag(long j) {
            if (CodedOutputStream.HAS_UNSAFE_ARRAY_OPERATIONS) {
                ...
                while ((j & -128) != 0) {
                    ...
                    int i = this.position;
                    this.position = i + 1;
                    UnsafeUtil.putByte(bArr, (long) i, (byte) ((((int) j) & 127) | NotificationCompat.FLAG_HIGH_PRIORITY));
                    j >>>= 7;
                }
                byte[] bArr2 = this.buffer;
                int i2 = this.position;
            ...
            while ((j & -128) != 0) {
                ...
                int i3 = this.position;
                this.position = i3 + 1;
                bArr3[i3] = (byte) ((((int) j) & 127) | NotificationCompat.FLAG_HIGH_PRIORITY);
                this.totalBytesWritten++;
                j >>>= 7;
            }
            byte[] bArr4 = this.buffer;
