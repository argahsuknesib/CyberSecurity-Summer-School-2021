...
final class FieldSet<T extends FieldDescriptorLite<T>> {
    ...
    public final void setField(T t, Object obj) {
        ...
        this.fields.put((Comparable) t, obj);
    }
    ...
    public final Object getRepeatedField(T t, int i) {
        if (t.isRepeated()) {
            Object field = getField(t);
            if (field != null) {
    ...
    public final void setRepeatedField(T t, int i, Object obj) {
        if (t.isRepeated()) {
            Object field = getField(t);
            if (field != null) {
                verifyType(t.getLiteType(), obj);
    ...
    /* JADX DEBUG: Failed to find minimal casts for resolve overloaded methods, cast all args instead
     method: com.google.protobuf.SmallSortedMap.put(java.lang.Comparable, java.lang.Object):V
     arg types: [T, java.util.List]
     candidates:
      com.google.protobuf.SmallSortedMap.put(java.lang.Object, java.lang.Object):java.lang.Object
      ClspMth{java.util.AbstractMap.put(com.tencent.mmkv.MMKVRecoverStrategic, java.lang.Integer):V}
      ClspMth{java.util.Map.put(com.tencent.mmkv.MMKVRecoverStrategic, java.lang.Integer):V}
      com.google.protobuf.SmallSortedMap.put(java.lang.Comparable, java.lang.Object):V */
    public final void addRepeatedField(T t, Object obj) {
        List list;
        if (t.isRepeated()) {
            verifyType(t.getLiteType(), obj);
            Object field = getField(t);
            if (field == null) {
                list = new ArrayList();
                this.fields.put((Comparable) t, (Object) list);
            } else {
                list = (List) field;
            }
            list.add(obj);
    ...
    public final void mergeFrom(FieldSet<T> fieldSet) {
    ...
    /* JADX DEBUG: Failed to find minimal casts for resolve overloaded methods, cast all args instead
     method: com.google.protobuf.SmallSortedMap.put(java.lang.Comparable, java.lang.Object):V
     arg types: [com.google.protobuf.FieldSet$FieldDescriptorLite, com.google.protobuf.MessageLite]
     candidates:
      com.google.protobuf.SmallSortedMap.put(java.lang.Object, java.lang.Object):java.lang.Object
      ClspMth{java.util.AbstractMap.put(com.tencent.mmkv.MMKVRecoverStrategic, java.lang.Integer):V}
      ClspMth{java.util.Map.put(com.tencent.mmkv.MMKVRecoverStrategic, java.lang.Integer):V}
    ...
    static final class Builder<T extends FieldDescriptorLite<T>> {
        ...
        public final Map<T, Object> getAllFields() {
            ...
            SmallSortedMap<T, Object> cloneAllFieldsMap = FieldSet.cloneAllFieldsMap(this.fields, false);
            if (this.fields.isImmutable()) {
                cloneAllFieldsMap.makeImmutable();
            } else {
        ...
        /* access modifiers changed from: package-private */
        public final Object getFieldAllowBuilders(T t) {
            Object obj = this.fields.get(t);
            return obj instanceof LazyField ? ((LazyField) obj).getValue() : obj;
        }
        ...
        /* access modifiers changed from: package-private */
        public final Object getRepeatedFieldAllowBuilders(T t, int i) {
            if (t.isRepeated()) {
        ...
        public final boolean isInitialized() {
            ...
            for (Map.Entry<T, Object> isInitialized : this.fields.getOverflowEntries()) {
                if (!FieldSet.isInitialized(isInitialized)) {
                    return false;
                }
            }
            return true;
        ...
        private void mergeFromField(Map.Entry<T, Object> entry) {
            ...
            if (fieldDescriptorLite.isRepeated()) {
                ...
                for (Object cloneIfMutable : (List) value) {
                    ((List) field).add(FieldSet.cloneIfMutable(cloneIfMutable));
                }
                this.fields.put((Comparable) fieldDescriptorLite, field);
            } else if (fieldDescriptorLite.getLiteJavaType() == WireFormat.JavaType.MESSAGE) {
                Object field2 = getField(fieldDescriptorLite);
