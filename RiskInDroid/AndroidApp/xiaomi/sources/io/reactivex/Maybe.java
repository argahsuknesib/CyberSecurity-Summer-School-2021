...
public abstract class Maybe<T> implements MaybeSource<T> {
    ...
    @NonNull
    @SchedulerSupport("none")
    public static <T> Flowable<T> concatDelayError(Iterable<? extends MaybeSource<? extends T>> r1) {
        ObjectHelper.requireNonNull((Object) r1, "sources is null");
        return Flowable.fromIterable(r1).concatMapDelayError(MaybeToPublisher.instance());
    }
    ...
    @BackpressureSupport(BackpressureKind.FULL)
    @SchedulerSupport("none")
    public static <T> Flowable<T> concatDelayError(Publisher<? extends MaybeSource<? extends T>> r1) {
        return Flowable.fromPublisher(r1).concatMapDelayError(MaybeToPublisher.instance());
    }
    ...
    @BackpressureSupport(BackpressureKind.FULL)
    @SchedulerSupport("none")
    public static <T> Flowable<T> concatEager(Iterable<? extends MaybeSource<? extends T>> r1) {
        return Flowable.fromIterable(r1).concatMapEager(MaybeToPublisher.instance());
    }
    ...
    @BackpressureSupport(BackpressureKind.FULL)
    @SchedulerSupport("none")
    public static <T> Flowable<T> concatEager(Publisher<? extends MaybeSource<? extends T>> r1) {
        return Flowable.fromPublisher(r1).concatMapEager(MaybeToPublisher.instance());
    }
    ...
    @BackpressureSupport(BackpressureKind.FULL)
    @SchedulerSupport("none")
    public static <T> Flowable<T> mergeDelayError(Iterable<? extends MaybeSource<? extends T>> r2) {
        return Flowable.fromIterable(r2).flatMap(MaybeToPublisher.instance(), true);
    }
    ...
    @CheckReturnValue
    @SchedulerSupport("none")
    public static <T, D> Maybe<T> using(Callable<? extends D> callable, Function<? super D, ? extends MaybeSource<? extends T>> r2, Consumer<? super D> r3) {
    ...
    public final Maybe<T> doOnError(Consumer<? super Throwable> consumer) {
        ...
        return RxJavaPlugins.onAssembly(new MaybePeek(this, Functions.emptyConsumer(), Functions.emptyConsumer(), (Consumer) ObjectHelper.requireNonNull(consumer, "onError is null"), action, action, Functions.EMPTY_ACTION));
    }
    ...
    public final Maybe<T> doOnSubscribe(Consumer<? super Disposable> consumer) {
        ...
        Consumer emptyConsumer2 = Functions.emptyConsumer();
        Action action = Functions.EMPTY_ACTION;
        return RxJavaPlugins.onAssembly(new MaybePeek(this, (Consumer) ObjectHelper.requireNonNull(consumer, "onSubscribe is null"), emptyConsumer, emptyConsumer2, action, action, Functions.EMPTY_ACTION));
    }
    ...
    public final Maybe<T> doOnSuccess(Consumer<? super T> consumer) {
        Consumer emptyConsumer = Functions.emptyConsumer();
        Action action = Functions.EMPTY_ACTION;
        return RxJavaPlugins.onAssembly(new MaybePeek(this, Functions.emptyConsumer(), (Consumer) ObjectHelper.requireNonNull(consumer, "onSubscribe is null"), emptyConsumer, action, action, Functions.EMPTY_ACTION));
    }
    ...
    @NonNull
    @SchedulerSupport("none")
    public final <U, R> Maybe<R> zipWith(MaybeSource<? extends U> maybeSource, BiFunction<? super T, ? super U, ? extends R> r3) {
        ObjectHelper.requireNonNull(maybeSource, "other is null");
        return zip(this, maybeSource, r3);
    }
