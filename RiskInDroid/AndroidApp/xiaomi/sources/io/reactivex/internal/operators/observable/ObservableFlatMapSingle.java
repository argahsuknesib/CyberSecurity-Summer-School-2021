...
public final class ObservableFlatMapSingle<T, R> extends AbstractObservableWithUpstream<T, R> {
    ...
    static final class FlatMapSingleObserver<T, R> extends AtomicInteger implements Observer<T>, Disposable {
        ...
        public final void innerSuccess(FlatMapSingleObserver<T, R>.InnerObserver innerObserver, R r) {
        ...
        /* access modifiers changed from: package-private */
        public final void innerError(FlatMapSingleObserver<T, R>.InnerObserver innerObserver, Throwable th) {
            this.set.delete(innerObserver);
            if (this.errors.addThrowable(th)) {
                if (!this.delayErrors) {
                    this.upstream.dispose();
