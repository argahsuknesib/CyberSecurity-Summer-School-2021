...
public final class ObservableWithLatestFromMany<T, R> extends AbstractObservableWithUpstream<T, R> {
    ...
    public ObservableWithLatestFromMany(@NonNull ObservableSource observableSource, @NonNull Iterable<? extends ObservableSource<?>> iterable, @NonNull Function function) {
        super(observableSource);
    ...
    static final class WithLatestFromObserver<T, R> extends AtomicInteger implements Observer<T>, Disposable {
        ...
        public final void subscribe(ObservableSource<?>[] observableSourceArr, int i) {
