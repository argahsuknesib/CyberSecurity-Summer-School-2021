...
public final class CompositeDisposable implements Disposable, DisposableContainer {
    ...
    public final boolean add(@NonNull Disposable disposable) {
    ...
    public final boolean addAll(@NonNull Disposable... disposableArr) {
    ...
    public final boolean remove(@NonNull Disposable disposable) {
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:17:0x0021, code lost:
        return false;
     */
    public final boolean delete(@NonNull Disposable disposable) {
        ObjectHelper.requireNonNull(disposable, "Disposable item is null");
        if (this.disposed) {
            return false;
        }
    ...
    public final void dispose(OpenHashSet<Disposable> openHashSet) {
        if (openHashSet != null) {
