...
public abstract class Single<T> implements SingleSource<T> {
    ...
    /* JADX WARN: Type inference failed for: r1v0, types: [org.reactivestreams.Publisher<? extends io.reactivex.SingleSource<? extends T>>, org.reactivestreams.Publisher] */
    /* JADX WARNING: Unknown variable types count: 1 */
    @CheckReturnValue
    @BackpressureSupport(BackpressureKind.FULL)
    @NonNull
    @SchedulerSupport("none")
    public static <T> Flowable<T> concatEager(Publisher<? extends SingleSource<? extends T>> r1) {
        return Flowable.fromPublisher(r1).concatMapEager(SingleInternalHelper.toFlowable());
    }

    /* JADX WARN: Type inference failed for: r1v0, types: [java.lang.Iterable<? extends io.reactivex.SingleSource<? extends T>>, java.lang.Iterable] */
    /* JADX WARNING: Unknown variable types count: 1 */
    @CheckReturnValue
    @BackpressureSupport(BackpressureKind.FULL)
    @NonNull
    @SchedulerSupport("none")
    public static <T> Flowable<T> concatEager(Iterable<? extends SingleSource<? extends T>> r1) {
        return Flowable.fromIterable(r1).concatMapEager(SingleInternalHelper.toFlowable());
    }
    ...
    /* JADX WARN: Type inference failed for: r2v0, types: [io.reactivex.functions.Function, io.reactivex.functions.Function<? super U, ? extends io.reactivex.SingleSource<? extends T>>] */
    /* JADX WARN: Type inference failed for: r3v0, types: [io.reactivex.functions.Consumer<? super U>, io.reactivex.functions.Consumer] */
    /* JADX WARNING: Unknown variable types count: 2 */
    @CheckReturnValue
    @SchedulerSupport("none")
    public static <T, U> Single<T> using(Callable<U> callable, Function<? super U, ? extends SingleSource<? extends T>> r2, Consumer<? super U> r3) {
    ...
    @CheckReturnValue
    @SchedulerSupport("none")
    public final <U, R> Single<R> zipWith(SingleSource<U> singleSource, BiFunction<? super T, ? super U, ? extends R> r2) {
        return zip(this, singleSource, r2);
    }
