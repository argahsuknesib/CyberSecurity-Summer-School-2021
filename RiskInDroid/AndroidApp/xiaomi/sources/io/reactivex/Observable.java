...
public abstract class Observable<T> implements ObservableSource<T> {
    ...
    @CheckReturnValue
    @SchedulerSupport("none")
    public static <T, R> Observable<R> combineLatest(Function function, int i, ObservableSource... observableSourceArr) {
    ...
    @CheckReturnValue
    @SchedulerSupport("none")
    public static <T, R> Observable<R> combineLatest(Iterable<? extends ObservableSource<? extends T>> iterable, Function<? super Object[], ? extends R> r2) {
    ...
    @NonNull
    @SchedulerSupport("none")
    public static <T, R> Observable<R> combineLatest(Iterable iterable, Function function, int i) {
        ObjectHelper.requireNonNull(iterable, "sources is null");
    ...
    @NonNull
    @SchedulerSupport("none")
    public static <T, R> Observable<R> combineLatest(ObservableSource[] observableSourceArr, Function function, int i) {
        ObjectHelper.requireNonNull(observableSourceArr, "sources is null");
    ...
    @NonNull
    @SchedulerSupport("none")
    public static <T1, T2, R> Observable<R> combineLatest(ObservableSource observableSource, ObservableSource observableSource2, BiFunction biFunction) {
    ...
    @CheckReturnValue
    @SchedulerSupport("none")
    public static <T, R> Observable<R> combineLatestDelayError(Iterable<? extends ObservableSource<? extends T>> iterable, Function<? super Object[], ? extends R> r2) {
    ...
    @NonNull
    @SchedulerSupport("none")
    public static <T> Observable<T> concat(Iterable<? extends ObservableSource<? extends T>> r3) {
        ObjectHelper.requireNonNull((Object) r3, "sources is null");
        return fromIterable(r3).concatMapDelayError(Functions.identity(), bufferSize(), false);
    }
    ...
    @CheckReturnValue
    @SchedulerSupport("none")
    public static <T> Observable<T> concatEager(ObservableSource<? extends ObservableSource<? extends T>> r1, int i, int i2) {
        return wrap(r1).concatMapEager(Functions.identity(), i, i2);
    }
    ...
    @CheckReturnValue
    @SchedulerSupport("none")
    public static <T> Observable<T> concatEager(Iterable<? extends ObservableSource<? extends T>> r2, int i, int i2) {
        return fromIterable(r2).concatMapEagerDelayError(Functions.identity(), i, i2, false);
    }
    ...
    @NonNull
    @SchedulerSupport("none")
    public static <T, S> Observable<T> generate(Callable<S> callable, BiConsumer<S, Emitter<T>> biConsumer, Consumer<? super S> r3) {
        ObjectHelper.requireNonNull(biConsumer, "generator  is null");
        return generate(callable, ObservableInternalHelper.simpleBiGenerator(biConsumer), (Consumer) r3);
    }
    ...
    public static Observable<Long> intervalRange(long j, long j2, long j3, long j4, TimeUnit timeUnit, Scheduler scheduler) {
        ...
        if (j2 < 0) {
            ...
            if (j <= 0 || j6 >= 0) {
                ...
                return RxJavaPlugins.onAssembly(new ObservableIntervalRange(j, j6, Math.max(0L, j5), Math.max(0L, j4), timeUnit, scheduler));
            }
    ...
    @CheckReturnValue
    @SchedulerSupport("none")
    public static <T> Observable<T> merge(Iterable<? extends ObservableSource<? extends T>> r2, int i, int i2) {
    ...
    @CheckReturnValue
    @SchedulerSupport("none")
    public static <T> Observable<T> merge(Iterable<? extends ObservableSource<? extends T>> r1) {
    ...
    @CheckReturnValue
    @SchedulerSupport("none")
    public static <T> Observable<T> merge(Iterable<? extends ObservableSource<? extends T>> r1, int i) {
    ...
    @CheckReturnValue
    @SchedulerSupport("none")
    public static <T> Observable<T> mergeDelayError(Iterable<? extends ObservableSource<? extends T>> r2) {
    ...
    @CheckReturnValue
    @SchedulerSupport("none")
    public static <T> Observable<T> mergeDelayError(Iterable<? extends ObservableSource<? extends T>> r2, int i, int i2) {
    ...
    @CheckReturnValue
    @SchedulerSupport("none")
    public static <T> Observable<T> mergeDelayError(Iterable<? extends ObservableSource<? extends T>> r2, int i) {
    ...
    @CheckReturnValue
    @SchedulerSupport("none")
    public static <T, D> Observable<T> using(Callable<? extends D> callable, Function<? super D, ? extends ObservableSource<? extends T>> r2, Consumer<? super D> r3) {
    ...
    @CheckReturnValue
    @SchedulerSupport("none")
    public final <R> Observable<R> concatMap(Function<? super T, ? extends ObservableSource<? extends R>> r3, int i) {
        ObjectHelper.requireNonNull((Object) r3, "mapper is null");
        ObjectHelper.verifyPositive(i, "prefetch");
        if (!(this instanceof ScalarCallable)) {
            return RxJavaPlugins.onAssembly(new ObservableConcatMap(this, r3, i, ErrorMode.IMMEDIATE));
        }
        Object call = ((ScalarCallable) this).call();
        if (call == null) {
            return empty();
        }
        return ObservableScalarXMap.scalarXMap(call, r3);
    }
    ...
    @CheckReturnValue
    @SchedulerSupport("none")
    public final <R> Observable<R> concatMapDelayError(Function<? super T, ? extends ObservableSource<? extends R>> r2, int i, boolean z) {
        ...
        if (this instanceof ScalarCallable) {
            ...
            return ObservableScalarXMap.scalarXMap(call, r2);
        }
        return RxJavaPlugins.onAssembly(new ObservableConcatMap(this, r2, i, z ? ErrorMode.END : ErrorMode.BOUNDARY));
    }
    ...
    @CheckReturnValue
    @SchedulerSupport("none")
    public final Observable<T> concatWith(ObservableSource observableSource) {
        ObjectHelper.requireNonNull(observableSource, "other is null");
    ...
    @CheckReturnValue
    @SchedulerSupport("none")
    public final Observable<T> concatWith(@NonNull SingleSource singleSource) {
    ...
    @CheckReturnValue
    @SchedulerSupport("none")
    public final Observable<T> concatWith(@NonNull MaybeSource maybeSource) {
    ...
    @CheckReturnValue
    @SchedulerSupport("none")
    public final <U, V> Observable<T> delay(ObservableSource<U> r1, Function<? super T, ? extends ObservableSource<V>> function) {
    ...
    @CheckReturnValue
    @SchedulerSupport("none")
    public final <R> Observable<R> flatMap(Function<? super T, ? extends ObservableSource<? extends R>> r8, boolean z, int i, int i2) {
        ObjectHelper.requireNonNull((Object) r8, "mapper is null");
        ObjectHelper.verifyPositive(i, "maxConcurrency");
        ObjectHelper.verifyPositive(i2, "bufferSize");
        if (!(this instanceof ScalarCallable)) {
            return RxJavaPlugins.onAssembly(new ObservableFlatMap(this, r8, z, i, i2));
        }
        Object call = ((ScalarCallable) this).call();
        if (call == null) {
            return empty();
        }
        return ObservableScalarXMap.scalarXMap(call, r8);
    }
    ...
    @CheckReturnValue
    @SchedulerSupport("none")
    public final <K> Observable<GroupedObservable<K, T>> groupBy(Function<? super T, ? extends K> r4) {
    ...
    @CheckReturnValue
    @SchedulerSupport("none")
    public final <K> Observable<GroupedObservable<K, T>> groupBy(Function<? super T, ? extends K> r3, boolean z) {
    ...
    @CheckReturnValue
    @SchedulerSupport("none")
    public final Observable<T> onErrorResumeNext(Function function) {
    ...
    @CheckReturnValue
    @SchedulerSupport("none")
    public final Observable<T> onErrorResumeNext(ObservableSource observableSource) {
    ...
    @CheckReturnValue
    @SchedulerSupport("none")
    public final Observable<T> sorted(Comparator<? super T> r2) {
        ObjectHelper.requireNonNull((Object) r2, "sortFunction is null");
        return toList().toObservable().map(Functions.listSorter(r2)).flatMapIterable(Functions.identity());
    }
    ...
    @CheckReturnValue
    @SchedulerSupport("none")
    public final <R> Observable<R> switchMap(Function<? super T, ? extends ObservableSource<? extends R>> r3, int i) {
        ObjectHelper.requireNonNull((Object) r3, "mapper is null");
        ObjectHelper.verifyPositive(i, "bufferSize");
        if (!(this instanceof ScalarCallable)) {
            return RxJavaPlugins.onAssembly(new ObservableSwitchMap(this, r3, i, false));
        }
        Object call = ((ScalarCallable) this).call();
        if (call == null) {
            return empty();
    ...
    @CheckReturnValue
    @SchedulerSupport("none")
    public final <R> Observable<R> switchMapDelayError(Function<? super T, ? extends ObservableSource<? extends R>> r3, int i) {
        ObjectHelper.requireNonNull((Object) r3, "mapper is null");
        ObjectHelper.verifyPositive(i, "bufferSize");
        if (!(this instanceof ScalarCallable)) {
            return RxJavaPlugins.onAssembly(new ObservableSwitchMap(this, r3, i, true));
        }
        Object call = ((ScalarCallable) this).call();
        if (call == null) {
            return empty();
    ...
    @CheckReturnValue
    @SchedulerSupport("none")
    public final <U, V> Observable<T> timeout(ObservableSource<U> r2, Function<? super T, ? extends ObservableSource<V>> function) {
    ...
    @CheckReturnValue
    @SchedulerSupport("none")
    public final <U, V> Observable<T> timeout(ObservableSource<U> r2, Function<? super T, ? extends ObservableSource<V>> function, ObservableSource<? extends T> observableSource) {
        ObjectHelper.requireNonNull((Object) r2, "firstTimeoutIndicator is null");
        ObjectHelper.requireNonNull(observableSource, "other is null");
        return timeout0(r2, function, observableSource);
    }
    ...
    @CheckReturnValue
    @SchedulerSupport("none")
    public final <B> Observable<Observable<T>> window(ObservableSource<B> r2) {
        return window((ObservableSource) r2, bufferSize());
    }
    ...
    @CheckReturnValue
    @SchedulerSupport("none")
    public final <U, V> Observable<Observable<T>> window(ObservableSource<U> r2, Function<? super U, ? extends ObservableSource<V>> function) {
        return window((ObservableSource) r2, function, bufferSize());
    }
    ...
    @CheckReturnValue
    @SchedulerSupport("none")
    public final <U, R> Observable<R> zipWith(ObservableSource<? extends U> observableSource, BiFunction<? super T, ? super U, ? extends R> r3) {
        ObjectHelper.requireNonNull(observableSource, "other is null");
        return zip(this, observableSource, r3);
    }
    ...
    @CheckReturnValue
    @SchedulerSupport("none")
    public final <U, R> Observable<R> zipWith(ObservableSource<? extends U> observableSource, BiFunction<? super T, ? super U, ? extends R> r2, boolean z) {
        return zip(this, observableSource, (BiFunction) r2, z);
    }
    ...
    @CheckReturnValue
    @SchedulerSupport("none")
    public final <U, R> Observable<R> zipWith(ObservableSource<? extends U> observableSource, BiFunction<? super T, ? super U, ? extends R> r2, boolean z, int i) {
        return zip(this, observableSource, (BiFunction) r2, z, i);
    }
