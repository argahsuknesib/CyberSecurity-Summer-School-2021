...
public abstract class Flowable<T> implements Publisher<T> {
    static final int BUFFER_SIZE = Math.max(1, Integer.getInteger("rx2.buffer-size", (int) NotificationCompat.FLAG_HIGH_PRIORITY).intValue());
    ...
    @BackpressureSupport(BackpressureKind.FULL)
    @SchedulerSupport("none")
    public static <T, R> Flowable<R> combineLatest(Iterable<? extends Publisher<? extends T>> iterable, Function<? super Object[], ? extends R> r2) {
        return combineLatest(iterable, (Function) r2, bufferSize());
    }
    ...
    @BackpressureSupport(BackpressureKind.FULL)
    @SchedulerSupport("none")
    public static <T, R> Flowable<R> combineLatestDelayError(Iterable<? extends Publisher<? extends T>> iterable, Function<? super Object[], ? extends R> r2) {
        return combineLatestDelayError(iterable, (Function) r2, bufferSize());
    }
    ...
    /* JADX WARN: Type inference failed for: r3v0, types: [java.lang.Iterable<? extends org.reactivestreams.Publisher<? extends T>>, java.lang.Object, java.lang.Iterable] */
    /* JADX WARNING: Unknown variable types count: 1 */
    @CheckReturnValue
    @BackpressureSupport(BackpressureKind.FULL)
    @NonNull
    @SchedulerSupport("none")
    public static <T> Flowable<T> concat(Iterable<? extends Publisher<? extends T>> r3) {
        ObjectHelper.requireNonNull((Object) r3, "sources is null");
        return fromIterable(r3).concatMapDelayError(Functions.identity(), 2, false);
    }
    ...
    /* JADX WARN: Type inference failed for: r1v0, types: [org.reactivestreams.Publisher<? extends org.reactivestreams.Publisher<? extends T>>, org.reactivestreams.Publisher] */
    /* JADX WARNING: Unknown variable types count: 1 */
    @CheckReturnValue
    @BackpressureSupport(BackpressureKind.FULL)
    @SchedulerSupport("none")
    public static <T> Flowable<T> concat(Publisher<? extends Publisher<? extends T>> r1, int i) {
        return fromPublisher(r1).concatMap(Functions.identity(), i);
    }
    ...
    /* JADX WARN: Type inference failed for: r1v0, types: [java.lang.Iterable<? extends org.reactivestreams.Publisher<? extends T>>, java.lang.Object, java.lang.Iterable] */
    /* JADX WARNING: Unknown variable types count: 1 */
    @CheckReturnValue
    @BackpressureSupport(BackpressureKind.FULL)
    @NonNull
    @SchedulerSupport("none")
    public static <T> Flowable<T> concatDelayError(Iterable<? extends Publisher<? extends T>> r1) {
        ObjectHelper.requireNonNull((Object) r1, "sources is null");
        return fromIterable(r1).concatMapDelayError(Functions.identity());
    }
    ...
    @BackpressureSupport(BackpressureKind.FULL)
    @SchedulerSupport("none")
    public static <T> Flowable<T> concatDelayError(Publisher<? extends Publisher<? extends T>> r1, int i, boolean z) {
        return fromPublisher(r1).concatMapDelayError(Functions.identity(), i, z);
    }
    ...
    @NonNull
    @SchedulerSupport("none")
    public static <T, S> Flowable<T> generate(Callable<S> callable, BiConsumer<S, Emitter<T>> biConsumer, Consumer<? super S> r3) {
        ObjectHelper.requireNonNull(biConsumer, "generator is null");
        return generate(callable, FlowableInternalHelper.simpleBiGenerator(biConsumer), (Consumer) r3);
    }
    ...
    public static Flowable<Long> intervalRange(long j, long j2, long j3, long j4, TimeUnit timeUnit, Scheduler scheduler) {
        ...
        if (j2 < 0) {
            ...
            return empty().delay(j5, timeUnit2, scheduler2);
        } else {
            long j6 = (j2 - 1) + j;
            if (j <= 0 || j6 >= 0) {
                ObjectHelper.requireNonNull(timeUnit2, "unit is null");
                ObjectHelper.requireNonNull(scheduler2, "scheduler is null");
                return RxJavaPlugins.onAssembly(new FlowableIntervalRange(j, j6, Math.max(0L, j5), Math.max(0L, j4), timeUnit, scheduler));
            }
    ...
    /* JADX WARN: Type inference failed for: r2v0, types: [java.lang.Iterable<? extends org.reactivestreams.Publisher<? extends T>>, java.lang.Iterable] */
    /* JADX DEBUG: Failed to find minimal casts for resolve overloaded methods, cast all args instead
    ...
    @BackpressureSupport(BackpressureKind.FULL)
    @SchedulerSupport("none")
    public static <T> Flowable<T> merge(Iterable<? extends Publisher<? extends T>> r2, int i, int i2) {
        return fromIterable(r2).flatMap(Functions.identity(), false, i, i2);
    }
    ...
    /* JADX WARN: Type inference failed for: r1v0, types: [java.lang.Iterable<? extends org.reactivestreams.Publisher<? extends T>>, java.lang.Iterable] */
    /* JADX WARNING: Unknown variable types count: 1 */
    @CheckReturnValue
    @BackpressureSupport(BackpressureKind.FULL)
    @SchedulerSupport("none")
    public static <T> Flowable<T> merge(Iterable<? extends Publisher<? extends T>> r1) {
        return fromIterable(r1).flatMap(Functions.identity());
    }
    ...
    @BackpressureSupport(BackpressureKind.FULL)
    @SchedulerSupport("none")
    public static <T> Flowable<T> merge(Iterable<? extends Publisher<? extends T>> r1, int i) {
        return fromIterable(r1).flatMap(Functions.identity(), i);
    }
    ...
    @BackpressureSupport(BackpressureKind.FULL)
    @SchedulerSupport("none")
    public static <T> Flowable<T> merge(Publisher<? extends Publisher<? extends T>> r1, int i) {
        return fromPublisher(r1).flatMap(Functions.identity(), i);
    }
    ...
    @BackpressureSupport(BackpressureKind.FULL)
    @SchedulerSupport("none")
    public static <T> Flowable<T> mergeDelayError(Iterable<? extends Publisher<? extends T>> r2) {
        return fromIterable(r2).flatMap(Functions.identity(), true);
    }
    ...
    @BackpressureSupport(BackpressureKind.FULL)
    @SchedulerSupport("none")
    public static <T> Flowable<T> mergeDelayError(Iterable<? extends Publisher<? extends T>> r2, int i, int i2) {
        return fromIterable(r2).flatMap(Functions.identity(), true, i, i2);
    }
    ...
    @BackpressureSupport(BackpressureKind.FULL)
    @SchedulerSupport("none")
    public static <T> Flowable<T> mergeDelayError(Iterable<? extends Publisher<? extends T>> r2, int i) {
        return fromIterable(r2).flatMap(Functions.identity(), true, i);
    }
    ...
    /* JADX WARN: Type inference failed for: r2v0, types: [org.reactivestreams.Publisher<? extends org.reactivestreams.Publisher<? extends T>>, org.reactivestreams.Publisher] */
    /* JADX DEBUG: Failed to find minimal casts for resolve overloaded methods, cast all args instead
     method: io.reactivex.Flowable.flatMap(io.reactivex.functions.Function, boolean, int):io.reactivex.Flowable<R>
     arg types: [io.reactivex.functions.Function, int, int]
     candidates:
    ...
    @BackpressureSupport(BackpressureKind.FULL)
    @SchedulerSupport("none")
    public static <T> Flowable<T> mergeDelayError(Publisher<? extends Publisher<? extends T>> r2, int i) {
        return fromPublisher(r2).flatMap(Functions.identity(), true, i);
    }
    ...
    @BackpressureSupport(BackpressureKind.FULL)
    @SchedulerSupport("none")
    public static <T> Flowable<T> switchOnNext(Publisher<? extends Publisher<? extends T>> r1, int i) {
        return fromPublisher(r1).switchMap(Functions.identity(), i);
    }
    ...
    @BackpressureSupport(BackpressureKind.FULL)
    @SchedulerSupport("none")
    public static <T> Flowable<T> switchOnNext(Publisher<? extends Publisher<? extends T>> r1) {
        return fromPublisher(r1).switchMap(Functions.identity());
    }
    ...
    @BackpressureSupport(BackpressureKind.FULL)
    @SchedulerSupport("none")
    public static <T> Flowable<T> switchOnNextDelayError(Publisher<? extends Publisher<? extends T>> r1, int i) {
        return fromPublisher(r1).switchMapDelayError(Functions.identity(), i);
    }
    ...
    /* JADX WARN: Type inference failed for: r2v0, types: [io.reactivex.functions.Function, io.reactivex.functions.Function<? super D, ? extends org.reactivestreams.Publisher<? extends T>>] */
    ...
    @BackpressureSupport(BackpressureKind.PASS_THROUGH)
    @SchedulerSupport("none")
    public static <T, D> Flowable<T> using(Callable<? extends D> callable, Function<? super D, ? extends Publisher<? extends T>> r2, Consumer<? super D> r3) {
        return using(callable, r2, r3, true);
    }
    ...
    /* JADX WARN: Type inference failed for: r2v0, types: [io.reactivex.functions.Function, io.reactivex.functions.Function<? super java.lang.Object[], ? extends R>, java.lang.Object] */
    /* JADX WARNING: Unknown variable types count: 1 */
    @CheckReturnValue
    @BackpressureSupport(BackpressureKind.FULL)
    @NonNull
    ...
    public static <T, R> Flowable<R> zip(Publisher<? extends Publisher<? extends T>> publisher, Function<? super Object[], ? extends R> r2) {
        ObjectHelper.requireNonNull((Object) r2, "zipper is null");
    ...
    /* JADX WARN: Type inference failed for: r3v0, types: [io.reactivex.functions.Function, io.reactivex.functions.Function<? super T, ? extends org.reactivestreams.Publisher<? extends R>>, java.lang.Object] */
    /* JADX WARNING: Unknown variable types count: 1 */
    @CheckReturnValue
    @BackpressureSupport(BackpressureKind.FULL)
    @NonNull
    @SchedulerSupport("none")
    public final <R> Flowable<R> concatMap(Function<? super T, ? extends Publisher<? extends R>> r3, int i) {
        ObjectHelper.requireNonNull((Object) r3, "mapper is null");
        ObjectHelper.verifyPositive(i, "prefetch");
        if (!(this instanceof ScalarCallable)) {
            return RxJavaPlugins.onAssembly(new FlowableConcatMap(this, r3, i, ErrorMode.IMMEDIATE));
        }
        Object call = ((ScalarCallable) this).call();
        if (call == null) {
            return empty();
        }
        return FlowableScalarXMap.scalarXMap(call, r3);
    }
    ...
    /* JADX WARN: Type inference failed for: r2v0, types: [io.reactivex.functions.Function, io.reactivex.functions.Function<? super T, ? extends org.reactivestreams.Publisher<? extends R>>, java.lang.Object] */
    /* JADX WARNING: Unknown variable types count: 1 */
    @CheckReturnValue
    @BackpressureSupport(BackpressureKind.FULL)
    @NonNull
    @SchedulerSupport("none")
    public final <R> Flowable<R> concatMapDelayError(Function<? super T, ? extends Publisher<? extends R>> r2, int i, boolean z) {
        ObjectHelper.requireNonNull((Object) r2, "mapper is null");
        ObjectHelper.verifyPositive(i, "prefetch");
        if (this instanceof ScalarCallable) {
            Object call = ((ScalarCallable) this).call();
            if (call == null) {
            ...
            return FlowableScalarXMap.scalarXMap(call, r2);
        }
        return RxJavaPlugins.onAssembly(new FlowableConcatMap(this, r2, i, z ? ErrorMode.END : ErrorMode.BOUNDARY));
    }
    ...
    /* JADX WARN: Type inference failed for: r1v0, types: [org.reactivestreams.Publisher<U>, org.reactivestreams.Publisher] */
    /* JADX WARNING: Unknown variable types count: 1 */
    @CheckReturnValue
    @BackpressureSupport(BackpressureKind.FULL)
    @SchedulerSupport("none")
    public final <U, V> Flowable<T> delay(Publisher<U> r1, Function<? super T, ? extends Publisher<V>> function) {
        return delaySubscription(r1).delay(function);
    }
    ...
    /* JADX WARN: Type inference failed for: r8v0, types: [io.reactivex.functions.Function, io.reactivex.functions.Function<? super T, ? extends org.reactivestreams.Publisher<? extends R>>, java.lang.Object] */
    /* JADX WARNING: Unknown variable types count: 1 */
    @CheckReturnValue
    @BackpressureSupport(BackpressureKind.FULL)
    @NonNull
    @SchedulerSupport("none")
    public final <R> Flowable<R> flatMap(Function<? super T, ? extends Publisher<? extends R>> r8, boolean z, int i, int i2) {
        ObjectHelper.requireNonNull((Object) r8, "mapper is null");
        ObjectHelper.verifyPositive(i, "maxConcurrency");
        ObjectHelper.verifyPositive(i2, "bufferSize");
        if (!(this instanceof ScalarCallable)) {
            return RxJavaPlugins.onAssembly(new FlowableFlatMap(this, r8, z, i, i2));
        }
        Object call = ((ScalarCallable) this).call();
        if (call == null) {
            return empty();
        }
        return FlowableScalarXMap.scalarXMap(call, r8);
    }
    ...
    @BackpressureSupport(BackpressureKind.FULL)
    @SchedulerSupport("none")
    public final <K> Flowable<GroupedFlowable<K, T>> groupBy(Function<? super T, ? extends K> r4) {
        return groupBy(r4, Functions.identity(), false, bufferSize());
    }
    ...
    @BackpressureSupport(BackpressureKind.FULL)
    @SchedulerSupport("none")
    public final <K> Flowable<GroupedFlowable<K, T>> groupBy(Function<? super T, ? extends K> r3, boolean z) {
        return groupBy(r3, Functions.identity(), z, bufferSize());
    }
    ...
    @NonNull
    @SchedulerSupport("none")
    public final Flowable<T> sorted(Comparator<? super T> r2) {
        ObjectHelper.requireNonNull((Object) r2, "sortFunction");
        return toList().toFlowable().map(Functions.listSorter(r2)).flatMapIterable(Functions.identity());
    }
    ...
    /* JADX WARNING: Unknown variable types count: 1 */
    public <R> Flowable<R> switchMap0(Function<? super T, ? extends Publisher<? extends R>> r2, int i, boolean z) {
        ObjectHelper.requireNonNull((Object) r2, "mapper is null");
        ObjectHelper.verifyPositive(i, "bufferSize");
        if (!(this instanceof ScalarCallable)) {
            return RxJavaPlugins.onAssembly(new FlowableSwitchMap(this, r2, i, z));
        }
        Object call = ((ScalarCallable) this).call();
        if (call == null) {
            return empty();
    ...
    /* JADX WARN: Type inference failed for: r2v0, types: [org.reactivestreams.Publisher<U>, org.reactivestreams.Publisher, java.lang.Object] */
    /* JADX WARNING: Unknown variable types count: 1 */
    @CheckReturnValue
    @BackpressureSupport(BackpressureKind.PASS_THROUGH)
    @NonNull
    @SchedulerSupport("none")
    public final <U, V> Flowable<T> timeout(Publisher<U> r2, Function<? super T, ? extends Publisher<V>> function) {
        ObjectHelper.requireNonNull((Object) r2, "firstTimeoutIndicator is null");
        return timeout0(r2, function, null);
    }
    ...
    @NonNull
    @SchedulerSupport("none")
    public final <U, V> Flowable<T> timeout(Publisher<U> r2, Function<? super T, ? extends Publisher<V>> function, Publisher<? extends T> publisher) {
        ObjectHelper.requireNonNull((Object) r2, "firstTimeoutSelector is null");
        ObjectHelper.requireNonNull(publisher, "other is null");
        return timeout0(r2, function, publisher);
    }
    ...
    @BackpressureSupport(BackpressureKind.UNBOUNDED_IN)
    @SchedulerSupport("none")
    public final <K> Single<Map<K, Collection<T>>> toMultimap(Function<? super T, ? extends K> r4) {
        return toMultimap(r4, Functions.identity(), HashMapSupplier.asCallable(), ArrayListSupplier.asFunction());
    }
    ...
    @BackpressureSupport(BackpressureKind.UNBOUNDED_IN)
    @SchedulerSupport("none")
    public final <K, V> Single<Map<K, Collection<V>>> toMultimap(Function<? super T, ? extends K> function, Function<? super T, ? extends V> function2, Callable<Map<K, Collection<V>>> r4) {
        return toMultimap(function, function2, r4, ArrayListSupplier.asFunction());
    }
    ...
    /* JADX DEBUG: Failed to find minimal casts for resolve overloaded methods, cast all args instead
     ...
     arg types: [long, java.util.concurrent.TimeUnit, io.reactivex.Scheduler, int, int]
     candidates:
    ...
    /* JADX WARN: Type inference failed for: r2v0, types: [org.reactivestreams.Publisher<B>, org.reactivestreams.Publisher] */
    /* JADX WARNING: Unknown variable types count: 1 */
    @CheckReturnValue
    @BackpressureSupport(BackpressureKind.ERROR)
    @SchedulerSupport("none")
    public final <B> Flowable<Flowable<T>> window(Publisher<B> r2) {
        return window((Publisher) r2, bufferSize());
    }
    ...
    /* JADX WARN: Type inference failed for: r2v0, types: [org.reactivestreams.Publisher<U>, org.reactivestreams.Publisher] */
    /* JADX WARNING: Unknown variable types count: 1 */
    @CheckReturnValue
    @BackpressureSupport(BackpressureKind.ERROR)
    @SchedulerSupport("none")
    public final <U, V> Flowable<Flowable<T>> window(Publisher<U> r2, Function<? super U, ? extends Publisher<V>> function) {
        return window((Publisher) r2, function, bufferSize());
    }
    ...
    @NonNull
    @SchedulerSupport("none")
    public final <U, R> Flowable<R> zipWith(Publisher<? extends U> publisher, BiFunction<? super T, ? super U, ? extends R> r3) {
        ObjectHelper.requireNonNull(publisher, "other is null");
        return zip(this, publisher, r3);
    }
    ...
    @BackpressureSupport(BackpressureKind.FULL)
    @SchedulerSupport("none")
    public final <U, R> Flowable<R> zipWith(Publisher<? extends U> publisher, BiFunction<? super T, ? super U, ? extends R> r2, boolean z) {
        return zip(this, publisher, (BiFunction) r2, z);
    }
    ...
    @BackpressureSupport(BackpressureKind.FULL)
    @SchedulerSupport("none")
    public final <U, R> Flowable<R> zipWith(Publisher<? extends U> publisher, BiFunction<? super T, ? super U, ? extends R> r2, boolean z, int i) {
        return zip(this, publisher, (BiFunction) r2, z, i);
    }
