...
public final class HttpUrl {
    ...
    /* JADX DEBUG: Failed to find minimal casts for resolve overloaded methods, cast all args instead
     method: okhttp3.HttpUrl.percentDecode(java.util.List<java.lang.String>, boolean):java.util.List<java.lang.String>
    ...
    static String canonicalize(String str, int i, int i2, String str2, boolean z, boolean z2, boolean z3, boolean z4, Charset charset) {
        ...
        while (i4 < i3) {
            ...
            jax jax = new jax();
            jax.O000000o(str, i, i4);
            canonicalize(jax, str, i4, i2, str2, z, z2, z3, z4, charset);
            return jax.O0000o();
        }
        return str.substring(i, i2);
    }

    static void canonicalize(jax jax, String str, int i, int i2, String str2, boolean z, boolean z2, boolean z3, boolean z4, Charset charset) {
        jax jax2 = null;
        while (i < i2) {
            int codePointAt = str.codePointAt(i);
            if (!z || !(codePointAt == 9 || codePointAt == 10 || codePointAt == 12 || codePointAt == 13)) {
                if (codePointAt == 43 && z3) {
                    ...
                    if (charset == null || charset.equals(Util.UTF_8)) {
                        ...
                        jax2.O000000o(str, i, Character.charCount(codePointAt) + i, charset);
                    }
                    while (!jax2.O00000o()) {
