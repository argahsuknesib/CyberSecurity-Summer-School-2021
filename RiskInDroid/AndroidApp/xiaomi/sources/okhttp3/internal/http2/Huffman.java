...
class Huffman {
    ...
    public void encode(ByteString byteString, jay jay) throws IOException {
        int i = 0;
        long j = 0;
        int i2 = 0;
        while (i < byteString.O0000OOo()) {
            byte O000000o2 = byteString.O000000o(i) & 255;
            int i3 = CODES[O000000o2];
            byte b = CODE_LENGTHS[O000000o2];
            j = (j << b) | ((long) i3);
            int i4 = i2 + b;
            while (i4 >= 8) {
                long j2 = i4 - 8;
                jay.O0000Oo((int) (j >> j2));
                i4 = j2;
            }
            i++;
            i2 = i4;
        ...
        if (i2 > 0) {
            jay.O0000Oo((int) (((long) (255 >>> i2)) | (j << (8 - i2))));
        }
    }
    ...
    public int encodedLength(ByteString byteString) {
        long j = 0;
        for (int i = 0; i < byteString.O0000OOo(); i++) {
            j += (long) CODE_LENGTHS[byteString.O000000o(i) & 255];
        }
        return (int) ((j + 7) >> 3);
    }
