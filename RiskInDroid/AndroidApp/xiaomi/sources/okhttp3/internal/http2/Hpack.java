...
final class Hpack {
    ...
    static final class Writer {
        ...
        Writer(int i, boolean z, jax jax) {
        ...
        public final void writeHeaders(List<Header> list) throws IOException {
            ...
            for (int i4 = 0; i4 < size; i4++) {
                ...
                ByteString O0000O0o = header.name.O0000O0o();
                ...
                if (i2 == -1) {
                    ...
                    while (true) {
                        ...
                        if (Util.equal(this.dynamicTable[i5].name, O0000O0o)) {
                ...
                if (i2 != -1) {
                    writeInt(i2, 127, NotificationCompat.FLAG_HIGH_PRIORITY);
                } else if (i == -1) {
                    this.out.O0000Oo(64);
                    ...
                    if (!O0000O0o.O000000o(0, byteString2, 0, byteString2.O0000OOo()) || Header.TARGET_AUTHORITY.equals(O0000O0o)) {
                        writeInt(i, 63, 64);
                        writeByteString(byteString);
                        insertIntoDynamicTable(header);
                    } else {
        ...
        public final void writeByteString(ByteString byteString) throws IOException {
            if (!this.useCompression || Huffman.get().encodedLength(byteString) >= byteString.O0000OOo()) {
                writeInt(byteString.O0000OOo(), 127, 0);
                this.out.O00000o0(byteString);
                return;
            }
            jax jax = new jax();
            Huffman.get().encode(byteString, jax);
            ByteString O0000o0o = jax.O0000o0o();
            writeInt(O0000o0o.O0000OOo(), 127, NotificationCompat.FLAG_HIGH_PRIORITY);
            this.out.O00000o0(O0000o0o);
        }
